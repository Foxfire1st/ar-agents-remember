...
| After approval, source and onboarding updates happen in the same pass, newly added source files run the missing-onboarding check before code commit, and small current-checkout edits close through C-09 direct closeout with external-memory ledger sequencing. | L12-L16 | [W-03 SKILL.md](agents-remember-md/runtime/skills/W-03-chat-task-workflow/SKILL.md) |
