...
| Docs reference placeholder text now records no relevant documentation only after live-source checks or a retrieval blocker. | L34-L35   | [inline-onboarding-block-template.md](agents-remember-md/runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/templates/inline-onboarding-block-template.md) |
