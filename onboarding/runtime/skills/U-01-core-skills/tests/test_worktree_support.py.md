...
| Finding                                                                                                                                                                                                                                                                                                                           | Citations            | Source Path                                                                                           |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | ----------------------------------------------------------------------------------------------------- |
| The test module imports the C-10 and C-11 helpers beside the C-09 helper, imports the benchmark runner script through `importlib`, and creates minimal file-level onboarding fixtures for adoption and carryover checks.                                                                                                             | L41-L68; L88-L106    | [test_worktree_support.py](agents-remember-md/runtime/skills/U-01-core-skills/tests/test_worktree_support.py) |
...
| Benchmark runner portability tests cover manifest path containment, non-string path rejection, manifest path component validation, read-only generated tree removal, stale directory symlink removal without deleting the target, Windows `.cmd` shim selection for `codex`, Bash-free copy-mode skill exposure, and auto-mode fallback to copying when the shell installer is unavailable. | L1577-L1666          | [test_worktree_support.py](agents-remember-md/runtime/skills/U-01-core-skills/tests/test_worktree_support.py) |
