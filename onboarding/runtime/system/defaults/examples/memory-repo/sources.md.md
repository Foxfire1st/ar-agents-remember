...
| Domain documentation placeholders name the authoritative live source and retrieval tool/MCP, treat local mirrors as orientation caches, and require live retrieval before recording that no domain docs exist. | L11-L14 | [runtime/system/defaults/examples/memory-repo/sources.md](agents-remember-md/runtime/system/defaults/examples/memory-repo/sources.md) |
