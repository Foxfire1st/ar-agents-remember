...
| Normal sync mode refuses self-sync, replaces each target skill folder, copies canonical skills into place, and then reruns the check. | `sync_targets`, `sync_target`, `replace_tree` | scripts/sync-skills.py:136-139; scripts/sync-skills.py:142-162; scripts/sync-skills.py:195-203; scripts/sync-skills.py:204-212 |
