...
| lastUpdated | 2026-08-01T19:25+02:00 |
| status      | active                 |
...
- 2026-08-01T13:20+02:00 — 260731-EFA-L5 curator. Added the `260731-EFA-L5 Entity Clarifications`
  ...
  **Corrected one stale entry this leaf did not cause.** Supervisor Sweep's Migration Notes carried
  ...
  (`e52edaf5`, L155) and `serving/supervisor.py` calls it once per sweep (L1235, beside
  `expectation_store.compact` at L1242), returning the folded snapshot every `in_cooldown` check
