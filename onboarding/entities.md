...
| Task Document                       | `git-blob-set-v1` | `sha256:a58559577ef891a456f2b693ff7ab81cae63a984bf87e18cd06ce12dc110bff4` | `dashboard/src/data/taskDocuments.ts`; `dashboard/src/data/taskHierarchy.ts`; `dashboard/src/data/taskIdentity.ts`; `dashboard/src/panels/detail-panel/DetailPanel.tsx`; `mcp/src/agents_remember/models/task_document_ref.py`; `mcp/src/agents_remember/observer/projection.py`; `mcp/src/agents_remember/serving/projections/snapshots.py`; `mcp/src/agents_remember/tasks/document_refs.py` |
...
is permitted beside the real document.
