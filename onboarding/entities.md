...
| lastUpdated | 2026-08-12T20:20+02:00 |
...
| Task Document                       | `git-blob-set-v1` | `sha256:2b4d8b0f5aa3efd36ee2a8efa0dc31d3bd89e7bb18bb2f2a3ed7c8b45b622485` | `dashboard/src/data/taskDocuments.ts`; `dashboard/src/data/taskHierarchy.ts`; `dashboard/src/data/taskIdentity.ts`; `dashboard/src/panels/detail-panel/DetailPanel.tsx`; `mcp/src/agents_remember/models/task_document_ref.py`; `mcp/src/agents_remember/observer/projection.py`; `mcp/src/agents_remember/serving/projections/snapshots.py`; `mcp/src/agents_remember/tasks/document_refs.py` |
...
| Key Identifiers | Canonical task document, relation (`super-to-master` / `master-to-leaf`), side (`code` / `memory`), source/descendant branch, and owning contract path. Commit and runtime ids are evidence/runtime details, not addresses an agent supplies. |
...
| Source References | `mcp/src/agents_remember/worktrees/source_lineage.py`; `mcp/src/agents_remember/models/worktree.py`; `mcp/src/agents_remember/serving/terminal_opener.py`; `dashboard/src/panels/engine-room/DiagnosticsPanel.tsx` |
