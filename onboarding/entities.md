...
| Seat Binding Identity               | `git-blob-set-v1` | `sha256:9a2a499127c9376fd08507c9a1650cc881280897f86c296e6b109c65e2a748ab` | `dashboard/src/data/sessions.ts`; `dashboard/src/panels/LeafAttachPicker.tsx`; `mcp/src/agents_remember/controlplane/signal_routing.py`; `mcp/src/agents_remember/serving/seat_binding.py`; `mcp/src/agents_remember/serving/terminal_catalog.py`; `mcp/src/agents_remember/serving/terminal_leaf_assignment.py` |
