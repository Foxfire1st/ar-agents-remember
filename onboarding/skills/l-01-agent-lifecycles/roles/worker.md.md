...
| The worker appends authoritative attempts to the single journal and links them from the mandatory turn report. | `### 6 — The Turn Report (mandatory, your last act)` | skills/l-01-agent-lifecycles/roles/worker.md:194-208 |
| Tool authority excludes lifecycle, gates, task state, and memory writes. | "## Tool Surface (positive statement — this is all of it)" | skills/l-01-agent-lifecycles/roles/worker.md:209-209 |
...
| Checks have their own explicit reportable step. | "### 5 — Checks (green before you report)" | skills/l-01-agent-lifecycles/roles/worker.md:157-157 |
