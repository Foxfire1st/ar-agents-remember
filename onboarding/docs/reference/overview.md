...
| --- | --- | --- |
| The normalized public input has only two commit legs. | n/a | [mcp/src/agents_remember/models/closeout/input.py](mcp/src/agents_remember/models/closeout/input.py) |
