...
| The integration lane row the fail-closed manifest requires. | "mcp/tests/test_leaf_doc_master_link_binding.py" | mcp/tests/test-evidence-lanes.toml:190-190 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The external-memory side of each case is a real second repository created by the fixture, not a mock. | `init_repo`; `initialized_memory_repo` | mcp/tests/test_worktree_support.py:97-117; mcp/tests/test_worktree_support.py:379-407; mcp/tests/test_worktree_support.py:364-392 |
