...
Part of the 260731-EFA-L7 in-place split family for `test_codex_app_server_adapter_reconnect.py`'s source module; covers the behaviours named by its test classes.
