...
| Discovery and running advertise consume the initialization and catalog frames without a model turn. | `test_discover_uses_only_token_free_bootstrap_and_list_models` | mcp/tests/test_harness_control_claude_stream_1.py:30-50 |
