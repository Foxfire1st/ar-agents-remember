...
| --- | --- | --- |
| The emitted population and digest are bound to the exact declared input identity. | `selected-tests`; `selectionDigest` | mcp/tests/fixtures/repository_profiles/node/scripts/select-tests.sh:20-21 |
