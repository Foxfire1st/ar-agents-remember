...
| The leaf-aware queue projection under test. | `closeout_queue_tool` | mcp/src/agents_remember/worktrees/closeout_queue.py:180-248 |
| The leaf-aware graph helpers under test. | `candidate_predecessors`; `ready_sort_key` | mcp/src/agents_remember/worktrees/closeout_queue_graph.py:168-217 |
