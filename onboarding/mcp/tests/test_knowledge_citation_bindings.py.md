...
| The closed vocabulary agreeing with its facts and with every producing surface. | `test_the_closed_vocabulary_agrees_with_its_facts_and_with_every_producing_surface` | mcp/tests/test_knowledge_citation_bindings.py:258-272 |
