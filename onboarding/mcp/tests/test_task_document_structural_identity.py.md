...
| The native-Windows scratch branch remains explicit. | `test_quality_environment_has_a_windows_branch` | mcp/tests/test_task_document_structural_identity.py:492-497 |
