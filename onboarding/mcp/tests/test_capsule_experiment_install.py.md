...
| The two consumer rows this leaf adds to the catalog's consumer proof. | `test_capsule_experiment_install` | mcp/tests/evidence-lifecycle.toml:680-680 |
| The lane manifest registers this module without adding a seventh `D9` row. | `test_capsule_experiment_install` | mcp/tests/test-evidence-lanes.toml:22-22 |
