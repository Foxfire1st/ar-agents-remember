...
full-gate memory caps, atomic replacement of the one enclosure test report, interpreter selection,
...
- A leaf runs the targeted wrapper; a master runs the full memory-capped wrapper.
