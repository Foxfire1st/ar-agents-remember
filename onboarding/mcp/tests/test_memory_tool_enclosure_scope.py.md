...
| Defines the function `_replaced` (lines 328-330) — A copy of the contract with cells overridden, written to disk by the caller.. | `_replaced` | mcp/tests/test_memory_tool_enclosure_scope.py:328-330 |
