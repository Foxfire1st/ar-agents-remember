...
| The unit-regression lane row this module is registered by. | "mcp/tests/test_knowledge_relation_rules.py" | mcp/tests/test-evidence-lanes.toml:104-104 |
|  The fixture contract that names this module as an exact consumer. | "contract:knowledge-identity-branching-fixture" | mcp/tests/evidence-lifecycle.toml:1183-1183  |
