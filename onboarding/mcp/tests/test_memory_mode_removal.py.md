...
| The module's evidence lane is declared under `unit-regression`. | "test_memory_mode_removal.py" | mcp/tests/test-evidence-lanes.toml:124-124 |
| The module is declared in three evidence-lifecycle consumer lists: the shared curator-coherence support artifact's list and two further artifact lists. | "mcp/tests/curator_coherence_test_support.py" | mcp/tests/evidence-lifecycle.toml:380-380 |
