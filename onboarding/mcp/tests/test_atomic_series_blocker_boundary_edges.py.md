...
| The public boundaries under test are structural dispatch, status/tools, start/bootstrap, sync, and terminal lifecycle composition. | `dispatch_agent_tool`; `worktree_status_tool`; "def attach_result("; `_implementation_series_admission_refusal`; "def sync_result(" | mcp/src/agents_remember/application/structural/agent_tools.py:445-534; mcp/src/agents_remember/application/structural/agent_tools.py:627-677; mcp/src/agents_remember/application/worktree_tools.py:299-322; mcp/src/agents_remember/worktrees/modules/start.py:163-163; mcp/src/agents_remember/worktrees/modules/sync.py:29-29 |
