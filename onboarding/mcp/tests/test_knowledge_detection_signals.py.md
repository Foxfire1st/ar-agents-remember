...
| The generation builder this module measures against. | `create_schema_statements` | mcp/src/agents_remember/memory/knowledge/schema_generations.py:173-180 |
| **The registry that now holds five generations, so "the newest supported generation" is generation 5 and generation 4 is the detection rule's own pinned generation rather than the tip.** | `GENERATIONS` | mcp/src/agents_remember/memory/knowledge/schema_generations.py:365-395 |
| **The generation this module's rule is about, and the generation builder/registry it is measured against.** | `REQUIRED_DETECTION_GENERATION`; `create_schema_statements`; `GENERATIONS` | mcp/src/agents_remember/memory/knowledge/detection.py:84-86; mcp/src/agents_remember/memory/knowledge/schema_generations.py:135-180; mcp/src/agents_remember/memory/knowledge/schema_generations.py:264-395 |
