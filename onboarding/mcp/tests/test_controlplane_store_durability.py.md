...
| The in-process axis of the same contract — threads, re-entrancy, the unsafe-filesystem refusal and failed-rewrite cleanup — which this file's `multiprocessing` harness deliberately cannot see. | `InProcessExclusivityTests`; `UnsafeLockFilesystemTests`; `FailedRewriteTests` | mcp/tests/test_durable_store_contract.py:166-363; mcp/tests/test_durable_store_contract.py:366-428; mcp/tests/test_durable_store_contract.py:646-723 |
