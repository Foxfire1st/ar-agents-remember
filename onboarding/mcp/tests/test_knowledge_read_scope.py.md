...
|The support artifact and contract this module is a declared consumer of.|"contract:knowledge-read-scope-cases"| mcp/tests/evidence-lifecycle.toml:1412-1413 |
| The lane row this module occupies. | "mcp/tests/test_knowledge_read_scope.py" | mcp/tests/test-evidence-lanes.toml:102-102 |
| The support artifact and contract this module is a declared consumer of. | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1412-1413 |
