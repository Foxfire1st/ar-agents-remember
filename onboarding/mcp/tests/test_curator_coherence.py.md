...
| Memory readiness and closeout invoke the same canonical validator. | `test_memory_quality_never_reports_combined_closeout_readiness_without_coherence`; `test_closeout_memory_preflight_calls_the_same_validator` | mcp/tests/test_curator_coherence.py:341-403 |
