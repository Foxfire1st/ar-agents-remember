...
| The lifecycle catalog row for this support module, including its four consumers and its replacement contract. | "path = \"mcp/tests/eve_capsule_test_support.py\"" | mcp/tests/evidence-lifecycle.toml:1434-1434 |
