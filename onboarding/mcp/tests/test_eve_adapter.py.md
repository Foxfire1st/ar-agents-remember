...
| The complete, verifiable launch binding the suite's launches now carry, built from a real worktree, commit and carrier rather than hand-written environment values. | `fixture_launch_binding` | mcp/tests/eve_adapter_test_support.py:335-364 |
