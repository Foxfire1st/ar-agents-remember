...
| The live native proof of the same six scenarios. | `_scenario_protocol`; `_scenario_concurrent` | mcp/tests/live_eve_native_fixture.py:572-622; mcp/tests/live_eve_native_fixture.py:892-1010; mcp/tests/live_eve_native_fixture.py:1088-1130 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The protocol being conformed to is the pinned published `eve` package's contract. | `eve` | eve_runtime/package.json:14-20 |
