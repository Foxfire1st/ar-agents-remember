...
| The lane row this module is registered under, and the two catalog consumer rows it added. | "unit-regression = ["; "contract:knowledge-diff-cases" | mcp/tests/evidence-lifecycle.toml:1382-1382; mcp/tests/test-evidence-lanes.toml:5-5 |
