...
| The endpoint-level harness tests (GET detection + the harness opener). | `test_get_harnesses_lists_supported_set_with_detection` | mcp/tests/test_terminal_ws_websocket_2.py:148-158 |
