...
| Packaging ships whatever is under `package_data` recursively, which is how the vendored vocabulary reaches an installed wheel or sdist. | "setuptools globs package-data with recursive=True", "package_data/**/*" | mcp/pyproject.toml:76-76; mcp/pyproject.toml:84-84 |
