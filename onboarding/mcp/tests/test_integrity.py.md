...
| The third test verifies provider status proceeds instead of returning `runnerIntegrityFailed` when only legacy CGC venv files exist. | L50-L64 | [test_integrity.py](agents-remember-md/mcp/tests/test_integrity.py) |
