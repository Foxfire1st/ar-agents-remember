...
| The doctrine guard that owns which clauses each surface owes, whose wording this table quotes. | `OWED_STATEMENTS`; `COMPLETION_TRUTH_ROSTER` | mcp/tests/test_lifecycle_turn_truth_doctrine.py:478-529 |
