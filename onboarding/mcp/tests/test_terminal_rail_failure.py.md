...
| The suite is explicitly integration evidence in the closed lane manifest. | "mcp/tests/test_terminal_rail_failure.py" | mcp/tests/test-evidence-lanes.toml:491-491 |
