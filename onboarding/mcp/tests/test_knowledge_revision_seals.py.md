...
| Finding | Anchor | Source |
| --- | --- | --- |
| Why this module owns the shared seal evidence rather than either single-graph module. | "neither single-graph module owns the shared mechanism" | mcp/tests/test_knowledge_revision_seals.py:4-4 |
...
| The unit-regression lane row this module is registered by. | "mcp/tests/test_knowledge_revision_seals.py" | mcp/tests/test-evidence-lanes.toml:70-70 |
