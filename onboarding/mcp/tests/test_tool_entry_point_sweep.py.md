...
| The swept population is derived and equals the live server's advertisement. | `EntryPointCoverageTests` | mcp/tests/test_tool_entry_point_sweep.py:867-886 |
...
| The lane row that keeps this module in the default selection. | "mcp/tests/test_tool_entry_point_sweep.py" | mcp/tests/test-evidence-lanes.toml:187-187 |
