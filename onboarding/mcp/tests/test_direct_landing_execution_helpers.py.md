...
The cases force candidate identity and every ordered code, memory, ledger, ref, and certification proof stage.
...
| --- | --- | --- |
| No external domain source is required for this repository-owned test contract. | `_value` | mcp/tests/test_direct_landing_execution_helpers.py:1-72 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The selected scenarios and assertions implement this test unit's forcing proof. | `_value` | mcp/tests/test_direct_landing_execution_helpers.py:1-72 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| No meaningful cross-repository reference applies. | `_value` | mcp/tests/test_direct_landing_execution_helpers.py:1-72 |
