...
| --- | --- | --- |
| No diagnostic pass can satisfy or be promoted into the R14 final proof. | `test_pass_never_satisfies_or_promotes_into_r14` | mcp/tests/test_diagnostic_projection.py:514-520 |
