...
|The registered contract, artifact row, evidence node and exact consumer set.|"contract:candidate-batch-case-harness"| mcp/tests/evidence-lifecycle.toml:1110-1110 |
