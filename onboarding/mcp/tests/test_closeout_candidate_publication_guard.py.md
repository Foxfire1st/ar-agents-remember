...
| The production callback reloads and revalidates under authority. | `publication` in `closeout_result` | mcp/src/agents_remember/worktrees/modules/closeout.py:999-1085 |
