...
| The contract whose consumer list this module joined for its read-scope fixture. | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1412-1413 |
