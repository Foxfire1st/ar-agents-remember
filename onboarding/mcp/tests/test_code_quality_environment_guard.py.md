...
The environment-guard suite now targets `testing.dagger_admission`, the sole validator after the
old code-quality owner was removed. Wrapper entry still refuses before argument parsing/planning on
missing or mismatched facts.
