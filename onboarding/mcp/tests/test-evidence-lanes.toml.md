...
| lastVerifiedCommitHash | `c4f59e982d2d682a2bfce19cbd72b0efdecfa865` |
| lastVerifiedCommitDate | 2026-09-15T22:16:46+02:00|
...
| Small actual integration file population | `integration` | mcp/tests/test-evidence-lanes.toml:134-196 |
| Retained structural detector classifications | "architecture-fitness" | mcp/tests/test-evidence-lanes.toml:198-214 |
| Provider contract classifications | "provider-conformance" | mcp/tests/test-evidence-lanes.toml:216-229 |
| Empty former stress/migration populations | "stress-durability"; "migration" | mcp/tests/test-evidence-lanes.toml:231-231; mcp/tests/test-evidence-lanes.toml:233-233 |
