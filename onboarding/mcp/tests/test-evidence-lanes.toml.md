...
L20 added `mcp/tests/test_terminal_rail_failure.py` to the `integration` lane: the standalone CCR-R20
suite publishes its own schema-3.1 rail reports and drives `OperationRuntime.fail` through a real
lifecycle store, so its integration evidence class is deliberate rather than inferred.
...
| Retry selection, child-environment forcing, and coverage composition have explicit unit-regression, integration, and architecture-fitness membership respectively. | "mcp/tests/test_retry_selection.py"; "mcp/tests/test_quality_subprocess_environment.py"; "mcp/tests/test_retry_coverage.py" | mcp/tests/test-evidence-lanes.toml:148-148; mcp/tests/test-evidence-lanes.toml:414-414; mcp/tests/test-evidence-lanes.toml:516-516 |
...
| The L20 standalone terminal rail-failure suite is explicitly integration evidence. | "mcp/tests/test_terminal_rail_failure.py" | mcp/tests/test-evidence-lanes.toml:465-465 |
