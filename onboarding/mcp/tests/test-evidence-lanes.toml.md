...
Classifies 183 retained test-shaped modules into explicit evidence categories. Current file membership is 99 unit-regression, 2 public-contract, 55 integration, 14 architecture-fitness and 13 provider-conformance; stress-durability and migration are empty. File counts are not collected-case counts. The closeout auto-carry change registered one new module, `test_sync_parked_candidate.py`, in the existing `unit-regression` lane; the per-lane counts above are the current source membership.
...
members. The new diagnostic quality and selected-case-budget tests are unit-regression members, as
is `test_sync_parked_candidate.py`. Adding that one row shifted every later lane block, so its
citations were re-derived. The executable case budgets live in pyproject/conftest, not in this list. Coverage percentages are
...
| --- | --- | --- |
| Retained unit-regression membership | "unit-regression" | mcp/tests/test-evidence-lanes.toml:5-105 |
| Small actual integration file population | `integration` | mcp/tests/test-evidence-lanes.toml:110-166 |
| Retained structural detector classifications | "architecture-fitness" | mcp/tests/test-evidence-lanes.toml:167-182 |
| Provider contract classifications | "provider-conformance" | mcp/tests/test-evidence-lanes.toml:183-197 |
| Empty former stress/migration populations | "stress-durability" | mcp/tests/test-evidence-lanes.toml:198-199 |
| L38 registered public activation/admission and route-review transport ownership | `integration` | mcp/tests/test-evidence-lanes.toml:110-111; mcp/tests/test-evidence-lanes.toml:161-161 |
| The new parked-candidate suite is registered in the unit-regression lane. | "unit-regression" | mcp/tests/test-evidence-lanes.toml:93-93 |
| The manifest still has no default classification for an unregistered test file. | "stress-durability" | mcp/tests/test-evidence-lanes.toml:198-199 |
...
- 2026-09-09T12:22:46+00:00: Generated citation repair: "stress-durability" repointed to mcp/tests/test-evidence-lanes.toml:198-199. No content impact: mechanical anchor-range projection bound to citation source snapshot 06f99a0e57ce8b514dd7ed6685874da5285e3ec2e8c4a3f6a5d768b622094451; claim bytes unchanged; generated by ccr-r10@v1.
