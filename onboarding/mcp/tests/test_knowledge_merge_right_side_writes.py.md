...
| The exact-scope consumer registration this module obliged, inside `merge_case_test_support.py`'s own `consumers` list. | "mcp/tests/test_knowledge_merge_right_side_writes.py" | mcp/tests/evidence-lifecycle.toml:1269-1287 |
