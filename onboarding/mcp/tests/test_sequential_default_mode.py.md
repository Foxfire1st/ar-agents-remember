...
| Structural implementation admission selects before spawn. | `_implementation_series_admission_refusal` | mcp/src/agents_remember/application/structural/agent_tools.py:627-677 |
