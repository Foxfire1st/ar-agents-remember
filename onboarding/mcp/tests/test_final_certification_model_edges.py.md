...
| The suite is registered in the integration lane of the evidence manifest. | "mcp/tests/test_final_certification_model_edges.py" | mcp/tests/test-evidence-lanes.toml:408-408 |
