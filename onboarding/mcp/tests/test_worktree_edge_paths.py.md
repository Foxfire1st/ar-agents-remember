...
| `WorkflowKind` limits workflow selection to `chat-task` and `light-task` (declared in models/worktree.py since L9). | "WorkflowKind = Literal[" | mcp/src/agents_remember/models/worktree.py:23-23 |
...
## Update History
- 2026-09-05T06:24:16+00:00: Generated citation repair: "WorkflowKind = Literal[" repointed to mcp/src/agents_remember/models/worktree.py:23-23. No content impact: mechanical anchor-range projection bound to citation source snapshot ad34c1284f637cc2e60117d5a156ddfdd2236402d2c1332758dd691c2cbef881; claim bytes unchanged; generated by ccr-r10@v1.
