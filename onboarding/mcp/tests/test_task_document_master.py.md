...
| Set subtask completed trusts the declared row without grading the child leaf | `test_set_subtask_completed_trusts_the_declared_row` | mcp/tests/test_task_document_master.py:75-92 |
| Replace cannot erase or change unresolved row identity or multiplicity | `test_replace_cannot_erase_or_change_unresolved_row_identity_or_multiplicity` | mcp/tests/test_task_document_master.py:94-145 |
| Master completion does not regrade a pending child leaf | `test_master_completion_does_not_regrade_a_pending_child_leaf` | mcp/tests/test_task_document_master.py:147-182 |
| Remove subtask deletes leaf doc and row | `test_remove_subtask_deletes_leaf_doc_and_row` | mcp/tests/test_task_document_master.py:203-215 |
| Remove subtask refuses unresolved row without touching any file | `test_remove_subtask_refuses_unresolved_row_without_touching_any_file` | mcp/tests/test_task_document_master.py:217-233 |
...
## Update History
- 2026-09-11T23:05:00+00:00: Two rows cited the deleted `test_set_subtask_completed_refuses_unready_or_missing_exact_leaf` and `test_master_completion_revalidates_pending_leaf_behind_completed_row`, which asserted the opposite of the current contract. The behaviour was inverted, not moved: `test_set_subtask_completed_trusts_the_declared_row` and `test_master_completion_does_not_regrade_a_pending_child_leaf` now pin that a master's declared rows are authoritative and the child leaf is not regraded, and the Purpose prose records that inversion.
- 2026-09-11T22:39:01+00:00: Generated citation repair: `test_remove_subtask_deletes_leaf_doc_and_row` repointed to mcp/tests/test_task_document_master.py:203-215. No content impact: mechanical anchor-range projection bound to citation source snapshot b911c7c4c4eb354cf78d2a53e1538fc36a5f9a5e36a3702e5953739b48812830; claim bytes unchanged; generated by ccr-r10@v1.
