...
| Checkpoint publication remains distinct from pause. | `test_the_landing_does_not_pose_as_a_pause`; `CheckpointPausesAnUnfinishedMasterTests` | mcp/tests/test_checkpoint_landing_end_to_end.py:41-479 |
