...
`test_undeclared_package_import_fails` (cit:([`test_undeclared_package_import_fails`], mcp/tests/test_layering.py:155-155)) pin the F-3 fail-closed
...
are excluded; the self/star/present-false tests pin the skip rules.
