...
## Update History
- 2026-09-11T23:05:00+00:00: The claim anchored the containment boundary on the bare symbol `HarnessControlError`, which resolves five times in `terminal_liveness.py` (the import at 15, the snapshot-read guard at 396, the terminal read's `except` at 468, the hysteresis signature at 475, and the module docstring at 546), so neither the historical nor the current resolution was unique. The second anchor is now the unique literal `"except HarnessControlError:"` at 468, inside the unchanged `455-469` extent of `_terminal_evidence`; `_terminal_evidence` still swallows the harness read failure and returns `None` so no cursor advances, and the claim wording is unchanged.
- 2026-09-11T22:39:01+00:00: Generated citation repair: `_terminal_evidence`; `HarnessControlError` repointed to mcp/src/agents_remember/serving/terminal_liveness.py:455-469; mcp/src/agents_remember/serving/terminal_liveness.py:468-468. No content impact: mechanical anchor-range projection bound to citation source snapshot b911c7c4c4eb354cf78d2a53e1538fc36a5f9a5e36a3702e5953739b48812830; claim bytes unchanged; generated by ccr-r10@v1.
