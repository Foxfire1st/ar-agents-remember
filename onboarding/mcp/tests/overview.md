...
**Lane.** `unit-regression` at `mcp/tests/test-evidence-lanes.toml:153` — a `tempfile` world, no
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The one collected case that now pins all three directions of the step rule. | `test_a_leaf_level_sync_position_is_admitted_and_a_silent_one_is_refused` | mcp/tests/test_atomic_series_chain_pair_order.py:298-377 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The one collected case that now runs the public journey, and the entry point it calls. | `test_repository_knowledge_continues_across_baselines_and_tasks`; `_cycle01_public_identities` | mcp/tests/test_knowledge_curator_ingest_list.py:1656-1775; mcp/tests/test_knowledge_curator_ingest_list.py:1780-1815; mcp/tests/test_knowledge_curator_ingest_list.py:1844-1965; mcp/tests/test_knowledge_curator_ingest_list.py:1968-2062 |
| The public journey itself: a private pair, task A's publication, task B's baseline fork, and the measurements read from the databases. | `_cycle01_cli_baseline_journey`; `_cycle01_task_a`; `_cycle01_task_b`; `_cycle01_baseline_consequences` | mcp/tests/test_knowledge_curator_ingest_list.py:2123-2150; mcp/tests/test_knowledge_curator_ingest_list.py:1932-1963; mcp/tests/test_knowledge_curator_ingest_list.py:1966-2012; mcp/tests/test_knowledge_curator_ingest_list.py:2015-2054; mcp/tests/test_knowledge_curator_ingest_list.py:2279-2306; mcp/tests/test_knowledge_curator_ingest_list.py:2152-2183; mcp/tests/test_knowledge_curator_ingest_list.py:2186-2232; mcp/tests/test_knowledge_curator_ingest_list.py:2235-2274 |
| The reused-label identity, asserted as one record for one repository at two baselines. | `_cycle01_reused_label_identity` | mcp/tests/test_knowledge_curator_ingest_list.py:2153-2270; mcp/tests/test_knowledge_curator_ingest_list.py:2309-2426 |
| The write-path identities the journey's first assertion pins. | `_TargetIdentities`; `_target_identities`; `_identity` | mcp/src/agents_remember/application/knowledge_curator_ingest.py:541-555; mcp/src/agents_remember/application/knowledge_curator_ingest.py:623-678; mcp/src/agents_remember/application/knowledge_curator_ingest.py:3143-3179 |
...
| The reused-label identity, asserted as the ruled semantics: a label is not an identity input, and continuity is naming the stored id (re-pointed by L43 — see the section below). | `_cycle01_reused_label_identity` | mcp/tests/test_knowledge_curator_ingest_list.py:2153-2270; mcp/tests/test_knowledge_curator_ingest_list.py:2309-2426 |
| The public selection the next task uses to begin from a prior task's published knowledge. | `add_arguments`; `run` | mcp/src/agents_remember/cli/knowledge_ingest.py:110-170; mcp/src/agents_remember/cli/knowledge_ingest.py:335-374 |
...
| Candidate and protected-ref safety | `test_git_command.py`, `test_integration_branch_authority.py` | Real Git identity, private commits, hooks and race preservation. The former `test_integration_ref_transaction.py` was deleted with the removed mid-crash ref-recovery capability.; mcp/tests/test-evidence-lanes.toml:166-201; mcp/tests/test-evidence-lanes.toml:192-192; mcp/tests/test-evidence-lanes.toml:228-228; mcp/tests/test-evidence-lanes.toml:230-230 |
...
| Candidate and protected-ref safety | `test_git_command.py`, `test_integration_branch_authority.py`, `worktrees/integration/integration_ref_transaction.py` | Real Git identity, private commits, hooks, race preservation and exact recovery.; mcp/tests/test-evidence-lanes.toml:192-192; mcp/tests/test-evidence-lanes.toml:228-228; mcp/tests/test-evidence-lanes.toml:230-230; mcp/src/agents_remember/worktrees/integration/integration_ref_transaction.py:103-103; mcp/tests/test-evidence-lanes.toml:195-195 |
...
`nextArgs`
cit:(["# The next-move triple, declared here so the worktree surface's guidance is part of"], mcp/src/agents_remember/models/worktree.py:400-400), and refuse a `nextTool` outside the roster
...
| The lifecycle catalog registration for the shared support module, with its four derived consumers. | "path = \"mcp/tests/eve_capsule_test_support.py\"" | mcp/tests/evidence-lifecycle.toml:1456-1456 |
| The lifecycle catalog registration for the shared support module, with its four derived consumers. | "path = \"mcp/tests/eve_capsule_test_support.py\"" | mcp/tests/evidence-lifecycle.toml:1456-1456 |
...
| The lane rows that admit both L14 modules to the `unit-regression` lane. | "mcp/tests/test_citation_index_resilience.py"; "mcp/tests/test_fresh_user_harness.py" | mcp/tests/test-evidence-lanes.toml:27-27; mcp/tests/test-evidence-lanes.toml:62-69; mcp/tests/test-evidence-lanes.toml:24-31; mcp/tests/test-evidence-lanes.toml:67-67; mcp/tests/test-evidence-lanes.toml:32-32; mcp/tests/test-evidence-lanes.toml:70-70 |
| The three `scripts/e2e_harness` [[artifact]] rows a leaf under that permanent support root must register. | "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" | mcp/tests/evidence-lifecycle.toml:1572-1572 |
| The three `scripts/e2e_harness` [[artifact]] rows a leaf under that permanent support root must register. | "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" | mcp/tests/evidence-lifecycle.toml:1572-1572 |
| The lane rows that admit both L14 modules to the `unit-regression` lane. | "mcp/tests/test_citation_index_resilience.py"; "mcp/tests/test_fresh_user_harness.py" | mcp/tests/test-evidence-lanes.toml:27-27; mcp/tests/test-evidence-lanes.toml:62-69; mcp/tests/test-evidence-lanes.toml:24-31; mcp/tests/test-evidence-lanes.toml:67-67; mcp/tests/test-evidence-lanes.toml:32-32; mcp/tests/test-evidence-lanes.toml:70-70 |
| The three `scripts/e2e_harness` [[artifact]] rows a leaf under that permanent support root must register. | "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" | mcp/tests/evidence-lifecycle.toml:1572-1572 |
| The three `scripts/e2e_harness` [[artifact]] rows a leaf under that permanent support root must register. | "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" | mcp/tests/evidence-lifecycle.toml:1572-1572 |
...
| The lane row that admits the L3 module: `test_memory_backfill.py` in the `unit-regression` lane. | "mcp/tests/test_memory_backfill.py" | mcp/tests/test-evidence-lanes.toml:118-118 |
...
| The L36 lane registration the fail-closed manifest requires. | "mcp/tests/test_cross_master_concurrency.py" | mcp/tests/test-evidence-lanes.toml:234-234 |
...
| The lane registration the fail-closed manifest requires for that module. | "mcp/tests/test_lifecycle_playthrough_end_to_end.py" | mcp/tests/test-evidence-lanes.toml:247-247 |
| The L4 census module's lane row, which closed the gap the L4 route section recorded. | "mcp/tests/test_memory_attribution_producers.py" | mcp/tests/test-evidence-lanes.toml:117-117 |
| The L5 binding module's lane registration, added by the same change set that created it. | "mcp/tests/test_leaf_doc_master_link_binding.py" | mcp/tests/test-evidence-lanes.toml:244-244 |
...
| The L23 lane registration the fail-closed manifest requires, inserted between two alphabetically adjacent rows so no other entry moved. | "mcp/tests/test_terminal_liveness_registration_order.py" | mcp/tests/test-evidence-lanes.toml:185-185 |
| The L27 pane-authority proof, its fixture import from the sibling sweeper suite, and the lane registration the fail-closed manifest requires. | `PaneDiagnosticAuthorityTests`; `_PANE_AUTHORITY_FIELDS`; `_pane_authority_offenders` | mcp/tests/test_terminal_liveness_pane_authority.py:243-598; mcp/tests/test_terminal_liveness_pane_authority.py:56-69; mcp/tests/test_terminal_liveness_pane_authority.py:233-240; mcp/tests/test-evidence-lanes.toml:190-190 |
...
| **260913-LCA-L8:** the nine exact-consumer rows the new module's change set adds to the evidence registry. | "mcp/tests/test_terminal_blocker_reasons.py" | mcp/tests/evidence-lifecycle.toml:359-364; mcp/tests/evidence-lifecycle.toml:435-435; mcp/tests/evidence-lifecycle.toml:482-482; mcp/tests/evidence-lifecycle.toml:613-613; mcp/tests/evidence-lifecycle.toml:652-652; mcp/tests/evidence-lifecycle.toml:763-763; mcp/tests/evidence-lifecycle.toml:1077-1077; mcp/tests/evidence-lifecycle.toml:1134-1134; mcp/tests/evidence-lifecycle.toml:1160-1160 |
| **260913-LCA-L8:** the declaration that gives the new module ownership of the ambient-role runner for targeted selection. | "mcp/tests/test_terminal_blocker_reasons.py" | mcp/test_support/agents_remember_test_support/code_quality/dependency_ownership.py:62-62; mcp/test_support/agents_remember_test_support/code_quality/dependency_ownership.py:84-84 |
| The removed case's scenario, now refused by design: the guard that makes a task root with no master document unbindable. | `_require_bindable_leaf_authoring` | mcp/src/agents_remember/application/task_docs/task_doc_tools.py:620-650 |
...
| The lane registration the fail-closed manifest requires for that module (row 165 after the KS-L2 and KS-L3 insertions). | "mcp/tests/test_lifecycle_playthrough_end_to_end.py"; "mcp/tests/test_pause_stop_only_end_to_end.py"; "mcp/tests/test_pause_is_not_publication.py" | mcp/tests/test-evidence-lanes.toml:243-253; mcp/tests/test-evidence-lanes.toml:245-253; mcp/tests/test-evidence-lanes.toml:291-294 |
| The architecture-fitness lane registration the fail-closed manifest requires for that proof. | "mcp/tests/test_terminal_liveness_pane_authority.py" | mcp/tests/test-evidence-lanes.toml:272-272 |
...
(`mcp/tests/test-evidence-lanes.toml:245`); the chain-order module registered by `T49` is
...
| Finding | Anchor | Source |
| --- | --- | --- |
| **The two new modules' lane rows, registered by the same change set that created them.** | "mcp/tests/test_knowledge_requirement_reference_contract.py" ; "mcp/tests/test_knowledge_requirement_revisions.py" | mcp/tests/test-evidence-lanes.toml:105-105; mcp/tests/test-evidence-lanes.toml:106-106 |
...
## Update History
- 2026-09-21T00:20+02:00 — 260915-KS-L47 curator (uncommitted change set on `ar/260915-ks-l47-ar`, code base `be325216416326a66950c9e320ff8d08f41e5d66`, memory base `2f415d930d1f8122ae0226bd296add3265600749`): **body update for the route this leaf's change set touches — the two changed test files: the projection suite's two assertions reconciled to the shared response choke point, and the guarded-merge case's equal-payload variant folded inside the existing collected case with its two sides proved identical before the merge runs and no collected case added.** This is a body change and not a metadata-only refresh: the route section carries statements the overview did not make before. `lastVerifiedCommitHash`/`lastVerifiedCommitDate` are retained exactly as recorded, because no commit contains this body and no stamp was measured on it; no stamp was advanced or invented. No commit was made.
- 2026-09-20T17:23:31+00:00: Generated citation repair: "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" repointed to mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:213-213. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T17:23:31+00:00: Generated citation repair: "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" repointed to mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:213-213. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T17:23:31+00:00: Generated citation repair: "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" repointed to mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:213-213. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-20T17:17:10+00:00: Generated citation repair: "path = \"mcp/tests/eve_capsule_test_support.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1456-1456. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T17:17:10+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1572-1572. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T17:17:10+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1572-1572. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T17:17:10+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1572-1572. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T17:17:10+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1572-1572. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-20T17:17:10+00:00: Generated citation repair: "contract:knowledge-read-scope-cases" repointed to mcp/tests/evidence-lifecycle.toml:1418-1418. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T17:17:10+00:00: Generated citation repair: "contract:knowledge-read-scope-cases" repointed to mcp/tests/evidence-lifecycle.toml:1418-1418. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T17:17:10+00:00: Generated citation repair: "replacement_contract = \"contract:knowledge-read-scope-cases\"" repointed to mcp/tests/evidence-lifecycle.toml:1418-1418. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T17:17:10+00:00: Generated citation repair: "replacement_contract = \"contract:knowledge-read-scope-cases\"" repointed to mcp/tests/evidence-lifecycle.toml:1418-1418. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-20T03:57:45+00:00: Generated citation repair: "contract:knowledge-diff-cases" repointed to mcp/tests/evidence-lifecycle.toml:1398-1398. No content impact: mechanical anchor-range projection bound to citation source snapshot ef4a9932e0393a408ecd0f26b5bc2e0e1e335ad90b9e47a16092ffd6f3403af3; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T03:57:45+00:00: Generated citation repair: "contract:knowledge-read-scope-cases" repointed to mcp/tests/evidence-lifecycle.toml:1420-1420. No content impact: mechanical anchor-range projection bound to citation source snapshot ef4a9932e0393a408ecd0f26b5bc2e0e1e335ad90b9e47a16092ffd6f3403af3; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T03:57:45+00:00: Generated citation repair: "replacement_contract = \"contract:knowledge-read-scope-cases\"" repointed to mcp/tests/evidence-lifecycle.toml:1420-1420. No content impact: mechanical anchor-range projection bound to citation source snapshot ef4a9932e0393a408ecd0f26b5bc2e0e1e335ad90b9e47a16092ffd6f3403af3; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-20T02:05:20+00:00: Generated citation repair: "path = \"mcp/tests/eve_capsule_test_support.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1454-1454. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1570-1570. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1570-1570. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "mcp/tests/test_cross_master_concurrency.py" repointed to mcp/tests/test-evidence-lanes.toml:234-234. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "mcp/tests/test_lifecycle_playthrough_end_to_end.py" repointed to mcp/tests/test-evidence-lanes.toml:247-247. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "mcp/tests/test_leaf_doc_master_link_binding.py" repointed to mcp/tests/test-evidence-lanes.toml:244-244. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "mcp/tests/test_terminal_liveness_registration_order.py" repointed to mcp/tests/test-evidence-lanes.toml:185-185. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "mcp/tests/test_terminal_blocker_reasons.py" repointed to mcp/tests/test-evidence-lanes.toml:270-270. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "mcp/tests/test_terminal_liveness_pane_authority.py" repointed to mcp/tests/test-evidence-lanes.toml:272-272. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "mcp/tests/test_candidate_batch_commands.py"; "mcp/tests/test_candidate_batch_transaction.py" repointed to mcp/tests/test-evidence-lanes.toml:18-18; mcp/tests/test-evidence-lanes.toml:19-19. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-20T02:05:20+00:00: Generated citation repair: "contract:common-base-merge-cases" repointed to mcp/tests/evidence-lifecycle.toml:1282-1282. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "mcp/tests/test_knowledge_detection_runs.py" repointed to mcp/tests/test-evidence-lanes.toml:87-87. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "mcp/tests/test_knowledge_detection_signals.py" repointed to mcp/tests/test-evidence-lanes.toml:88-88. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "contract:knowledge-diff-cases" repointed to mcp/tests/evidence-lifecycle.toml:1394-1394. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "contract:knowledge-read-scope-cases" repointed to mcp/tests/evidence-lifecycle.toml:1416-1416. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "contract:common-base-merge-cases" repointed to mcp/tests/evidence-lifecycle.toml:1282-1282. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "contract:knowledge-diff-cases" repointed to mcp/tests/evidence-lifecycle.toml:1394-1394. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "contract:knowledge-read-scope-cases" repointed to mcp/tests/evidence-lifecycle.toml:1416-1416. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "contract:knowledge-read-scope-cases" repointed to mcp/tests/evidence-lifecycle.toml:1416-1416. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "replacement_contract = \"contract:knowledge-read-scope-cases\"" repointed to mcp/tests/evidence-lifecycle.toml:1416-1416. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: `test_knowledge_review_surface`; "mcp/tests/test_knowledge_review_surface.py" repointed to mcp/tests/test-evidence-lanes.toml:104-104; mcp/tests/test-evidence-lanes.toml:104-104. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: `test_knowledge_review_surface`; "mcp/tests/test_knowledge_review_surface.py" repointed to mcp/tests/test-evidence-lanes.toml:104-104; mcp/tests/test-evidence-lanes.toml:104-104. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "mcp/tests/test_next_step_address_binding.py"; "mcp/tests/test_curator_coherence_publication_discoverability.py" repointed to mcp/tests/test-evidence-lanes.toml:196-196; mcp/tests/test-evidence-lanes.toml:200-200. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T02:05:20+00:00: Generated citation repair: "mcp/tests/test_sync_parked_candidate.py"; "LIFECYCLE_CATALOG_SHA256" repointed to mcp/tests/evidence-lifecycle.toml:1290-1290; mcp/tests/test_dependency_ownership_ast_helpers.py:46-46. No content impact: mechanical anchor-range projection bound to citation source snapshot fe7fdbf3f561fa23007ac47565833928a7c74df1b4b028969d78a5b139bb65b8; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-20T00:16:01+00:00: Generated citation repair: "contract:common-base-merge-cases" repointed to mcp/tests/evidence-lifecycle.toml:1284-1284. No content impact: mechanical anchor-range projection bound to citation source snapshot b8fe5b3589f1357e836aaad1587e69ed38bbda0d58221eaa2150e96eb0561e93; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T00:16:01+00:00: Generated citation repair: "contract:knowledge-diff-cases" repointed to mcp/tests/evidence-lifecycle.toml:1396-1396. No content impact: mechanical anchor-range projection bound to citation source snapshot b8fe5b3589f1357e836aaad1587e69ed38bbda0d58221eaa2150e96eb0561e93; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T00:16:01+00:00: Generated citation repair: "contract:knowledge-read-scope-cases" repointed to mcp/tests/evidence-lifecycle.toml:1418-1418. No content impact: mechanical anchor-range projection bound to citation source snapshot b8fe5b3589f1357e836aaad1587e69ed38bbda0d58221eaa2150e96eb0561e93; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T00:16:01+00:00: Generated citation repair: "replacement_contract = \"contract:knowledge-read-scope-cases\"" repointed to mcp/tests/evidence-lifecycle.toml:1418-1418. No content impact: mechanical anchor-range projection bound to citation source snapshot b8fe5b3589f1357e836aaad1587e69ed38bbda0d58221eaa2150e96eb0561e93; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T01:37+02:00 — 260915-KS-L31 curator (uncommitted change set on `ar/260915-ks-l31-ar`, base `7dcec036`): range repair only; every claim's wording and every anchor set kept, no row deleted. Three rows in this route's reference tables were re-derived against the tree this leaf's own line moves left behind. (1) The worktree-surface row's two quoted anchors had drifted: the next-move comment now stands at `mcp/src/agents_remember/models/worktree.py:352` (the row still cited the pre-move `:330`, which the history's own generated entry had already corrected elsewhere) and `_require_registered_public_next_tool` is declared at `:385`, so the row now cites `:352-352` and the validator's own extent `:385-394`. (2) The review-surface consumer pair was cited as `mcp/tests/evidence-lifecycle.toml:1395-1398`/`:1421-1426`; both registrations now stand at `:1402` and `:1431`, each listed at its own line. (3) The L23 consumer-registration row is now one range per named anchor, each at the artifact row whose `consumers` list actually carries it: `test_evidence_catalog_gate_boundaries.py` at `:172-172` (the `_evidence_catalog_fixture.py` row), `test_memory_citation_resolution.py` at `:809-809` and `test_knowledge_merge_right_side_writes.py` at `:1290-1290` (the `test-evidence-lanes.toml` and `merge_case_test_support.py` rows); the row's dead `:194-194`/`:807-808`/`:1288-1288` projection held none of the three anchors, and the two anchors the prose names at `_evidence_catalog_fixture.py`'s list stay covered by `:172-172`. No verification stamp advanced: the candidate is uncommitted and the governed closeout owns the real code and memory commits.
- 2026-09-20T01:28+02:00 — 260915-KS-L30 curator (uncommitted change set on `ar/260915-ks-l30-ar`, base `7dcec036094768c5f50e571fb45e59a27ae78efc`): **cleared the one enforced `citation_source_duplicate` row this document carried, and cleared it by correcting the repetition rather than deleting it.** The row claims *"The two `consumers` registrations the module obliged"* but cited the identical Source `mcp/tests/evidence-lifecycle.toml:1401-1401` twice. Reading the catalogue shows the claim is right and the second range was a copy of the first: `mcp/tests/test_knowledge_review_surface.py` is registered as a consumer of exactly two already-governed artifacts — the `[[artifact]]` at `:1382` (`path = "mcp/tests/diff_scope_test_support.py"`, its `consumers` list carrying the path at `:1401`) and the one at `:1404` (`path = "mcp/tests/read_scope_test_support.py"`, its `consumers` list carrying the same path at `:1430`, verified with `grep -n 'test_knowledge_review_surface' mcp/tests/evidence-lifecycle.toml`). The second Source therefore now reads `:1430-1430`: each registration is cited at its own line, no source text repeats, and both anchors hold inside each cited range (the quoted path at both lines, the bare `test_knowledge_review_surface` as the same path's own token). No Finding text, anchor or other row was changed, and no citation was dropped. Reviewed against the working candidate `ar/260915-ks-l30-ar`; no commit exists for these bytes and the commit stamp is not advanced.
- 2026-09-20T01:20+02:00 — 260918-TSIP-L11 closing seat (memory worktree `84152b9e`, code `79fa817f`): re-read and re-derived 4 claim row(s) on the merged tip. Every row was read against the construct it cites before its range was regenerated: the merged `mcp/tests/test-evidence-lanes.toml` was read at the line that carries each lane anchor, `pyproject.toml` was read at its declaration, and every renamed or consolidated case was re-anchored on the successor whose own docstring records the consolidation. No range was produced by adding a delta to an old number and the product's mechanical fixer was not run, so **no projection bullet is written and no claim is reopened on this edit's account**. Rows: `overview.md:1482` ("mcp/tests/test_terminal_blocker_reasons.py") — re-read the claim against the landed source: the construct moved and the cited range was widened to the line that actually carries it, per the checker's own remedy; `overview.md:4559` (LIFECYCLE_CONTRACT_COUNT = 16, LIFECYCLE_ARTIFACT_COUNT = 66) — re-read the claim against the landed pin: L10's T129 reconciliation moved the population, so the anchor literal the file declares is the new one; `overview.md:4613` (LIFECYCLE_CONTRACT_COUNT = 16, LIFECYCLE_ARTIFACT_COUNT = 66) — re-read the claim against the landed pin: L10's T129 reconciliation moved the population, so the anchor literal the file declares is the new one; `overview.md:4612` (mcp/tests/test_evidence_catalog_gate_boundaries.py, mcp/tests/test_memory_citation_resolution.py) — re-read the claim against both registries: the module's registration is a LANE row, which is why no evidence-lifecycle consumer range held it.
- 2026-09-20T01:07+02:00 — 260915-KS citation residue clearance (uncommitted change set on memory base `66b2ae8adebea11bc2300d2d51822f321a128657`): cleared the 6 enforced citation rows this card carried (citation_anchor_absent_from_range) by hand-reading them, with no edit to this document. All six sit on three table rows the earlier mechanical projection had already repointed, and every range was re-read against the working tree and its manifests: the worktree next-move row's `mcp/src/agents_remember/models/worktree.py:352-352` and `:385-385` (the declared-triple comment and the `def _require_registered_public_next_tool` declaration both land there), the two governed-support consumer-registration rows in `mcp/tests/evidence-lifecycle.toml` (`:1291-1291` for `mcp/tests/test_knowledge_merge_right_side_writes.py`, and `:807-808` plus `:809-809` for `mcp/tests/test_memory_citation_resolution.py`), and the lane row at `mcp/tests/test-evidence-lanes.toml:103-103` for `mcp/tests/test_knowledge_review_surface.py`. No claim, anchor, range or citation was changed by this pass, and no verification stamp was advanced. The document's pre-existing history disorder — four out-of-order entries under the later `## Update History` headings, the earliest dated 2026-07-12 — was left as found rather than reordered.
- 2026-09-19T22:49:08+00:00: Generated citation repair: "path = \"mcp/tests/eve_capsule_test_support.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1454-1454. No content impact: mechanical anchor-range projection bound to citation source snapshot e67b35357c3610162648ff9c1506b2bd840c93c142fe18de408cd68cfbaf5daa; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:49:08+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1570-1570. No content impact: mechanical anchor-range projection bound to citation source snapshot e67b35357c3610162648ff9c1506b2bd840c93c142fe18de408cd68cfbaf5daa; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:49:08+00:00: Generated citation repair: `map_official_memory` repointed to mcp/tests/test_worktree_sync.py:111-123. No content impact: mechanical anchor-range projection bound to citation source snapshot e67b35357c3610162648ff9c1506b2bd840c93c142fe18de408cd68cfbaf5daa; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:49:08+00:00: Generated citation repair: "contract:common-base-merge-cases" repointed to mcp/tests/evidence-lifecycle.toml:1283-1283. No content impact: mechanical anchor-range projection bound to citation source snapshot e67b35357c3610162648ff9c1506b2bd840c93c142fe18de408cd68cfbaf5daa; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:49:08+00:00: Generated citation repair: "contract:knowledge-diff-cases" repointed to mcp/tests/evidence-lifecycle.toml:1395-1395. No content impact: mechanical anchor-range projection bound to citation source snapshot e67b35357c3610162648ff9c1506b2bd840c93c142fe18de408cd68cfbaf5daa; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:49:08+00:00: Generated citation repair: "contract:knowledge-read-scope-cases" repointed to mcp/tests/evidence-lifecycle.toml:1417-1417. No content impact: mechanical anchor-range projection bound to citation source snapshot e67b35357c3610162648ff9c1506b2bd840c93c142fe18de408cd68cfbaf5daa; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:49:08+00:00: Generated citation repair: `test_every_shared_fact_reports_the_identical_shipped_literal`; `test_the_binding_vocabulary_extends_the_shipped_one_only_in_one_direction` repointed to mcp/tests/test_knowledge_citation_bindings.py:219-238; mcp/tests/test_knowledge_citation_bindings.py:241-255. No content impact: mechanical anchor-range projection bound to citation source snapshot e67b35357c3610162648ff9c1506b2bd840c93c142fe18de408cd68cfbaf5daa; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:49:08+00:00: Generated citation repair: "replacement_contract = \"contract:knowledge-read-scope-cases\"" repointed to mcp/tests/evidence-lifecycle.toml:1417-1417. No content impact: mechanical anchor-range projection bound to citation source snapshot e67b35357c3610162648ff9c1506b2bd840c93c142fe18de408cd68cfbaf5daa; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:49:08+00:00: Generated citation repair: "def test_the_route_serves_the_typed_result_and_refuses_by_name_with_no_adapter(" repointed to mcp/tests/test_knowledge_review_surface.py:786-786. No content impact: mechanical anchor-range projection bound to citation source snapshot e67b35357c3610162648ff9c1506b2bd840c93c142fe18de408cd68cfbaf5daa; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:49:08+00:00: Generated citation repair: "# The next-move triple, declared here so the worktree surface's guidance is part of" repointed to mcp/src/agents_remember/models/worktree.py:352-352. No content impact: mechanical anchor-range projection bound to citation source snapshot e67b35357c3610162648ff9c1506b2bd840c93c142fe18de408cd68cfbaf5daa; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:49:08+00:00: Generated citation repair: `_require_registered_public_next_tool` repointed to mcp/src/agents_remember/models/worktree.py:383-394. No content impact: mechanical anchor-range projection bound to citation source snapshot e67b35357c3610162648ff9c1506b2bd840c93c142fe18de408cd68cfbaf5daa; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T00:31+02:00 — 260915-KS-L30 curator (uncommitted change set on `ar/260915-ks-l30-ar`, base `7dcec036094768c5f50e571fb45e59a27ae78efc`): **mechanical citation-range projection** against this leaf's candidate. The checklist reported 6 row(s) whose cited range no longer holds its anchor although the construct is present in the cited file; each range was widened to the lines that carry it — `# The next-move triple, declared here so the worktree surface's guidance is part of`; `def _require_registered_public_next_tool`; `mcp/tests/test_knowledge_merge_right_side_writes.py`; `mcp/tests/test_knowledge_review_surface.py`; `mcp/tests/test_memory_citation_resolution.py`; `test_knowledge_review_surface`. No claim wording, anchor or citation was added, removed or re-worded, and no range was deleted: the new range is the checklist's own resolved extent for that anchor on this candidate. No verification stamp was advanced.
...
- 2026-09-19T22:28:52+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1569-1569. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:28:52+00:00: Generated citation repair: "contract:common-base-merge-cases" repointed to mcp/tests/evidence-lifecycle.toml:1284-1284. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:28:52+00:00: Generated citation repair: "contract:knowledge-diff-cases" repointed to mcp/tests/evidence-lifecycle.toml:1394-1394. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:28:52+00:00: Generated citation repair: "contract:knowledge-read-scope-cases" repointed to mcp/tests/evidence-lifecycle.toml:1416-1416. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-19T22:28:52+00:00: Generated citation repair: "replacement_contract = \"contract:knowledge-read-scope-cases\"" repointed to mcp/tests/evidence-lifecycle.toml:1416-1416. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:28:52+00:00: Generated citation repair: "def test_the_route_serves_the_typed_result_and_refuses_by_name_with_no_adapter(" repointed to mcp/tests/test_knowledge_review_surface.py:786-786. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-20T00:28+02:00 — 260918-TSIP-L11 closing seat (memory worktree `84152b9e`, code `79fa817f`): re-read and re-derived 13 claim row(s) on the merged tip. Every row was read against the construct it cites before its range was regenerated: the merged `mcp/tests/test-evidence-lanes.toml` was read at the line that carries each lane anchor, `pyproject.toml` was read at its declaration, and every renamed or consolidated case was re-anchored on the successor whose own docstring records the consolidation. No range was produced by adding a delta to an old number and the product's mechanical fixer was not run, so **no projection bullet is written and no claim is reopened on this edit's account**. Rows: `overview.md:1469` (mcp/tests/test_pause_stop_only_end_to_end.py, mcp/tests/test_pause_is_not_publication.py) — re-read the row against the merged registry: the anchor is at the line named in the checker's own message, and the cited range was widened to the line that carries it; `overview.md:1487` (mcp/tests/test_lifecycle_playthrough_end_to_end.py, mcp/tests/test_pause_stop_only_end_to_end.py, mcp/tests/test_pause_is_not_publication.py) — re-read the row against the merged registry: the anchor is at the line named in the checker's own message, and the cited range was widened to the line that carries it; `overview.md:2732` (unit-regression, integration) — re-read the row against the merged registry: the anchor is at the line named in the checker's own message, and the cited range was widened to the line that carries it; `overview.md:2787` (integration = [) — re-read the row against the merged registry: the anchor is at the line named in the checker's own message, and the cited range was widened to the line that carries it; `overview.md:2927` (mcp/tests/test_knowledge_diff_scope.py, mcp/tests/test_knowledge_diff_boundaries.py) — re-read the row against the merged registry: the anchor is at the line named in the checker's own message, and the cited range was widened to the line that carries it; `overview.md:2929` (mcp/tests/test_knowledge_diff_scope.py, mcp/tests/test_knowledge_diff_boundaries.py) — re-read the row against the merged registry: the anchor is at the line named in the checker's own message, and the cited range was widened to the line that carries it; `overview.md:3094` (mcp/tests/test_pause_stop_only_end_to_end.py, mcp/tests/test_pause_is_not_publication.py) — re-read the row against the merged registry: the anchor is at the line named in the checker's own message, and the cited range was widened to the line that carries it; `overview.md:3095` (mcp/tests/test_pause_stop_only_end_to_end.py, mcp/tests/test_pause_is_not_publication.py) — re-read the row against the merged registry: the anchor is at the line named in the checker's own message, and the cited range was widened to the line that carries it; `overview.md:3103` (mcp/tests/test_knowledge_diff_scope.py, mcp/tests/test_knowledge_diff_boundaries.py) — re-read the row against the merged registry: the anchor is at the line named in the checker's own message, and the cited range was widened to the line that carries it; `overview.md:2988` (unit_case_budget) — re-read the claim against pyproject.toml, which now declares the pair 3000 / 600 at :263-264; wording corrected, anchor re-pointed at the literal the file declares; `overview.md:4305` (unit_case_budget) — re-read the claim against pyproject.toml, which now declares the pair 3000 / 600 at :263-264; wording corrected, anchor re-pointed at the literal the file declares; `overview.md:4306` (integration_case_budget) — re-read the claim against pyproject.toml, which now declares the pair 3000 / 600 at :263-264; wording corrected, anchor re-pointed at the literal the file declares; `overview.md:4613` (unit_case_budget, integration_case_budget) — re-read the claim against pyproject.toml, which now declares the pair 3000 / 600 at :263-264; wording corrected, anchor re-pointed at the literal the file declares.
- 2026-09-19T22:33+02:00 — 260918-TSIP-L11 curator (memory worktree `fd1a024e`, code `7879f5b2`): cleared the inherited citation debt on 3 claim(s) by RE-READING each claim against the merged tree and RE-DERIVING every cited range from the construct's real extent in the file the claim cites (`extents.anchor_extents`), never by adding a delta to an old number and never through the mechanical projection (no generated citation-repair bullet is written, so no claim is reopened by this edit). Claims re-read: `overview.md:1461` ("# The next-move triple, declared here so the worktree surface's guidance is part of", "def _require_registered_public_next_tool"); `overview.md:3111` ("contract:knowledge-read-scope-cases"); `overview.md:4612` (`unit_case_budget`, `integration_case_budget`, `pytest_collection_finish`).
- 2026-09-19T19:54+02:00 — 260918-TSIP-L6 (uncommitted change set on `ar/260918-tsip-l6-ar`, base `a1351504`): recorded the route's two new modules and one new support module, the measured refusal census (**67 = 32 + 18 + 17**), both pins emptied in the change that repaired them, `T34_REPAIRED_TOOLS` as their single source of truth, and the lane manifest's pure insertion at `:112`/`:155`. Every citation range in this document re-derived from the enumerated population. Verification metadata stays closeout-owned.
- 2026-09-18T20:45:09+02:00 — 260915-KS-L23 post-closeout clearance (change set on `ar/260915-ks-l23`, memory base `ce3028e9`, code `5e4eb651`): **cleared the 10 enforced `citation_anchor_absent_from_range` rows in this document.** The closeout's own code commit appended one `consumers` registration above every construct these cards cite, so each cited range ended exactly one line above the line that now carries the anchor row. Widened to the carrying line: `mcp/tests/evidence-lifecycle.toml:1448-1448` → `mcp/tests/evidence-lifecycle.toml:1448-1449` (row 1292); `mcp/tests/evidence-lifecycle.toml:1564-1564` → `mcp/tests/evidence-lifecycle.toml:1564-1565` (row 1333); `mcp/tests/evidence-lifecycle.toml:1280-1280` → `mcp/tests/evidence-lifecycle.toml:1280-1281` (rows 2591, 2593, 2961); `mcp/tests/evidence-lifecycle.toml:1390-1390` → `mcp/tests/evidence-lifecycle.toml:1390-1391` (rows 2952, 2966); `mcp/tests/evidence-lifecycle.toml:1412-1412` → `mcp/tests/evidence-lifecycle.toml:1412-1413` (rows 2953, 2967, 4439). Every line the author cited stays inside its range; no claim, Anchor cell or other range was dropped or re-worded, and each named anchor now resolves inside the widened range.
- 2026-09-18T17:59:14+00:00: 260915-KS-L23 residue clearance (seat A): cleared the card's 34 enforced
  `citation_anchor_absent_from_range` rows by re-reading each claim against the construct it is about
  and correcting only the cited ranges — no claim, anchor or citation was deleted or reworded, and no
  row outside the seat's table was touched. Repointed: `"# The next-move triple, declared here so the
  worktree surface's guidance is part of"` `models/worktree.py:322-329` -> `:330-330` (the comment's own
  line) and `"def _require_registered_public_next_tool"` `:355-363` -> `:361-372` (the validator's
  definition); the L37/binding-lane anchors `"mcp/tests/test_pause_stop_only_end_to_end.py"`
  `mcp/tests/test-evidence-lanes.toml:213-213`/`:250-250` -> `:246-246` and
  `"mcp/tests/test_pause_is_not_publication.py"` `:207-207`/`:244-244`/`:204-204`/`:209-209`/`:211-211` ->
  `:285-285`, with the pooled spans that were meant to reach them widened (`:205-227`/`:205-233` ->
  `:246-246`/`:240-240`; `:205-272`/`:202-240`/`:202-211`/`:211-248`/`:204-211`/`:209-211`/`:211-211` ->
  `:246-285`); `"mcp/tests/test_knowledge_read_boundaries.py"` `:199-199`/`:200-200` -> `:206-206` and
  `"mcp/tests/test_knowledge_read_paths.py"` `:203-203`/`:202-202` -> `:208-208`, with the stale
  consumer lists they were pooled with repointed to `evidence-lifecycle.toml:1312-1313`/`:1421-1422`;
  `"mcp/tests/test_knowledge_diff_boundaries.py"` `:200-200`/`:201-201`/`:202-202` -> `:207-207` and
  `"mcp/tests/test_knowledge_diff_scope.py"` `:105-105`/`:106-106` -> `:106-106`/`:107-107`;
  `"integration = ["` `:170-170` -> `:201-201`; `"contract:knowledge-read-scope-cases"`
  `evidence-lifecycle.toml:1310-1310`/`:1395-1402`/`:1403-1403`/`:1407-1407`/`:1408-1408` ->
  `:1416-1422`/`:1393-1399`/`:1405-1405`/`:1413-1413`/`:1415-1427`;
  `"mcp/tests/test_knowledge_review_surface.py"` and its `` `test_knowledge_review_surface` `` anchor
  `evidence-lifecycle.toml:1391-1394`/`:1418-1421` -> `:1395-1398`/`:1421-1426`; the three consumer
  registrations of `"mcp/tests/test_knowledge_merge_right_side_writes.py"` and
  `"mcp/tests/test_memory_citation_resolution.py"` `evidence-lifecycle.toml:172-172`/`:806-807`/
  `:1269-1287` -> `:194-194`/`:807-808`/`:1288-1288`; and the four case ranges
  `test_knowledge_detection_runs.py:293-324`/`:493-540`/`:769-799` -> `:296-325`/`:496-541`/`:946-974`,
  `test_knowledge_read_boundaries.py:664-724`/`:893-941` -> `:698-756`/`:944-978`,
  `test_knowledge_portable_boundaries.py:618-650`/`:96-134` -> `:662-694`/`:97-135` and
  `:623-680`/`:686-736` -> `:700-757`/`:763-813`. Each new range was confirmed against the code tree at
  this leaf's tip to hold the construct its claim names. Verification stamp not advanced: the code is
  uncommitted and closeout owns the stamp.
- 2026-09-18T19:48+02:00 — 260918-TSIP-L5 curator (uncommitted change set on `ar/260918-tsip-l5-ar`, base `f05ba167`, `test-evidence-lanes.toml` **269 → 270 lines**, `+1`): this route's governed source changed and a module was added, so a body section was **added rather than annotated** (`## 260918-TSIP-L5 …`) — the new `mcp/tests/test_tool_entry_point_sweep.py` (1274 lines / 14 cases) and its `unit-regression` lane row at `:153` — and every citation into the changed file was re-derived in the same operation: **48 live moved rows repaired across the population of 115**, the six lane-bracket rows re-derived to this candidate's measured brackets, nine stale `row N now` prose figures and a fifth `… Lane Row (Declared)` mention set to their true rows, and one ambiguous literal anchor re-worded to its unique owning key. The baseline `range_resolution` run saw only **31 of the 48**, which is why the population was enumerated rather than read off the finding set. Verification stamps stay the recorded base plus the closeout's advance; the candidate is uncommitted and the governed closeout owns the real code commit.
...
- 2026-09-18T17:30:57+00:00: Generated citation repair: "replacement_contract = \"contract:knowledge-read-scope-cases\"" repointed to mcp/tests/evidence-lifecycle.toml:1412-1412. No content impact: mechanical anchor-range projection bound to citation source snapshot 90ac134ffc3f8e781bc1feb4daa6ea3e6fd982366fb532c5a9c6ca2e3d9aa040; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T17:30:57+00:00: Generated citation repair: "mcp/tests/test_leaf_doc_master_link_binding.py" repointed to mcp/tests/test-evidence-lanes.toml:237-237. No content impact: mechanical anchor-range projection bound to citation source snapshot 90ac134ffc3f8e781bc1feb4daa6ea3e6fd982366fb532c5a9c6ca2e3d9aa040; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T17:30:57+00:00: Generated citation repair: "mcp/tests/test_cross_master_concurrency.py" repointed to mcp/tests/test-evidence-lanes.toml:227-227. No content impact: mechanical anchor-range projection bound to citation source snapshot 90ac134ffc3f8e781bc1feb4daa6ea3e6fd982366fb532c5a9c6ca2e3d9aa040; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T17:30:57+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1564-1564. No content impact: mechanical anchor-range projection bound to citation source snapshot 90ac134ffc3f8e781bc1feb4daa6ea3e6fd982366fb532c5a9c6ca2e3d9aa040; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T16:13:35+00:00: Generated citation repair: "replacement_contract = \"contract:knowledge-read-scope-cases\"" repointed to mcp/tests/evidence-lifecycle.toml:1408-1408. No content impact: mechanical anchor-range projection bound to citation source snapshot e93679ab5a75f0a02b7b5f3d8b80c429fc541ff3ead9181d4e4fbf176c901462; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T16:13:35+00:00: Generated citation repair: "mcp/tests/test_cross_master_concurrency.py" repointed to mcp/tests/test-evidence-lanes.toml:222-222. No content impact: mechanical anchor-range projection bound to citation source snapshot e93679ab5a75f0a02b7b5f3d8b80c429fc541ff3ead9181d4e4fbf176c901462; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T16:13:35+00:00: Generated citation repair: "mcp/tests/test_memory_backfill.py" repointed to mcp/tests/test-evidence-lanes.toml:117-117. No content impact: mechanical anchor-range projection bound to citation source snapshot e93679ab5a75f0a02b7b5f3d8b80c429fc541ff3ead9181d4e4fbf176c901462; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T16:13:35+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1560-1560. No content impact: mechanical anchor-range projection bound to citation source snapshot e93679ab5a75f0a02b7b5f3d8b80c429fc541ff3ead9181d4e4fbf176c901462; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T15:12:32+00:00: Generated citation repair: "integration_case_budget = 400" repointed to pyproject.toml:245-245. No content impact: mechanical anchor-range projection bound to citation source snapshot 418f5ce580b3710b5d8fe417585d48fd22eccd55346c84b05f01fef243a17917; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T15:12:32+00:00: Generated citation repair: "replacement_contract = \"contract:knowledge-read-scope-cases\"" repointed to mcp/tests/evidence-lifecycle.toml:1407-1407. No content impact: mechanical anchor-range projection bound to citation source snapshot 418f5ce580b3710b5d8fe417585d48fd22eccd55346c84b05f01fef243a17917; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T15:12:32+00:00: Generated citation repair: "test_the_shipped_seed_page_is_byte_identical_and_the_facet_page_is_its_own_policy" repointed to mcp/tests/test_knowledge_facets.py:1214-1214. No content impact: mechanical anchor-range projection bound to citation source snapshot 418f5ce580b3710b5d8fe417585d48fd22eccd55346c84b05f01fef243a17917; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T15:12:32+00:00: Generated citation repair: "mcp/tests/test_leaf_doc_master_link_binding.py" repointed to mcp/tests/test-evidence-lanes.toml:231-231. No content impact: mechanical anchor-range projection bound to citation source snapshot 418f5ce580b3710b5d8fe417585d48fd22eccd55346c84b05f01fef243a17917; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T15:12:32+00:00: Generated citation repair: "mcp/tests/test_cross_master_concurrency.py" repointed to mcp/tests/test-evidence-lanes.toml:221-221. No content impact: mechanical anchor-range projection bound to citation source snapshot 418f5ce580b3710b5d8fe417585d48fd22eccd55346c84b05f01fef243a17917; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T15:12:32+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1558-1558. No content impact: mechanical anchor-range projection bound to citation source snapshot 418f5ce580b3710b5d8fe417585d48fd22eccd55346c84b05f01fef243a17917; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_knowledge_family_composition_boundaries.py" repointed to mcp/tests/test-evidence-lanes.toml:93-93. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_knowledge_family_composition.py" repointed to mcp/tests/test-evidence-lanes.toml:92-92. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_knowledge_detection_signals.py" repointed to mcp/tests/test-evidence-lanes.toml:87-87. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_knowledge_detection_runs.py" repointed to mcp/tests/test-evidence-lanes.toml:86-86. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_knowledge_facets.py" repointed to mcp/tests/test-evidence-lanes.toml:90-90. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_knowledge_read_scope.py" repointed to mcp/tests/test-evidence-lanes.toml:102-102. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_knowledge_read_scope.py" repointed to mcp/tests/test-evidence-lanes.toml:102-102. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_candidate_batch_commands.py"; "mcp/tests/test_candidate_batch_transaction.py" repointed to mcp/tests/test-evidence-lanes.toml:19-19; mcp/tests/test-evidence-lanes.toml:20-20. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_knowledge_store.py" repointed to mcp/tests/test-evidence-lanes.toml:110-110. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_memory_attribution_producers.py" repointed to mcp/tests/test-evidence-lanes.toml:115-115. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_cross_master_concurrency.py" repointed to mcp/tests/test-evidence-lanes.toml:220-220. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_memory_backfill.py" repointed to mcp/tests/test-evidence-lanes.toml:116-116. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_terminal_blocker_reasons.py" repointed to mcp/tests/test-evidence-lanes.toml:255-255. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_terminal_blocker_reasons.py" repointed to mcp/tests/test-evidence-lanes.toml:255-255. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_leaf_doc_master_link_binding.py" repointed to mcp/tests/test-evidence-lanes.toml:230-230. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_memory_attribution_producers.py" repointed to mcp/tests/test-evidence-lanes.toml:115-115. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_lifecycle_playthrough_end_to_end.py" repointed to mcp/tests/test-evidence-lanes.toml:233-233. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_cross_master_concurrency.py" repointed to mcp/tests/test-evidence-lanes.toml:220-220. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "mcp/tests/test_memory_backfill.py" repointed to mcp/tests/test-evidence-lanes.toml:116-116. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T13:36:47+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1554-1554. No content impact: mechanical anchor-range projection bound to citation source snapshot 468e47519c1a75ea8349538fbc4903207afc60f299e5295d1631f1f15f11a5ef; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T12:07:24+00:00: Generated citation repair: "replacement_contract = \"contract:knowledge-read-scope-cases\"" repointed to mcp/tests/evidence-lifecycle.toml:1403-1403. No content impact: mechanical anchor-range projection bound to citation source snapshot 5571c165ff8c0fb8964492349c8f2d6be0134e3c91863ce685e4c34bb24aa86b; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T12:07:24+00:00: Generated citation repair: "contract:knowledge-read-scope-cases" repointed to mcp/tests/evidence-lifecycle.toml:1403-1403. No content impact: mechanical anchor-range projection bound to citation source snapshot 5571c165ff8c0fb8964492349c8f2d6be0134e3c91863ce685e4c34bb24aa86b; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T12:07:24+00:00: Generated citation repair: "mcp/tests/test_knowledge_read_scope.py" repointed to mcp/tests/test-evidence-lanes.toml:100-100. No content impact: mechanical anchor-range projection bound to citation source snapshot 5571c165ff8c0fb8964492349c8f2d6be0134e3c91863ce685e4c34bb24aa86b; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T12:07:24+00:00: Generated citation repair: "mcp/tests/test_knowledge_read_scope.py" repointed to mcp/tests/test-evidence-lanes.toml:100-100. No content impact: mechanical anchor-range projection bound to citation source snapshot 5571c165ff8c0fb8964492349c8f2d6be0134e3c91863ce685e4c34bb24aa86b; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-09-18T12:07:24+00:00: Generated citation repair: "mcp/tests/test_cross_master_concurrency.py" repointed to mcp/tests/test-evidence-lanes.toml:218-218. No content impact: mechanical anchor-range projection bound to citation source snapshot 5571c165ff8c0fb8964492349c8f2d6be0134e3c91863ce685e4c34bb24aa86b; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T12:07:24+00:00: Generated citation repair: "mcp/tests/test_memory_backfill.py" repointed to mcp/tests/test-evidence-lanes.toml:114-114. No content impact: mechanical anchor-range projection bound to citation source snapshot 5571c165ff8c0fb8964492349c8f2d6be0134e3c91863ce685e4c34bb24aa86b; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-18T12:07:24+00:00: Generated citation repair: "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" repointed to mcp/tests/evidence-lifecycle.toml:1553-1553. No content impact: mechanical anchor-range projection bound to citation source snapshot 5571c165ff8c0fb8964492349c8f2d6be0134e3c91863ce685e4c34bb24aa86b; claim bytes unchanged; generated by ccr-r10@v1.
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The knowledge suite and its unit-lane placement (row 74 after the KS-L3 insertions). | "mcp/tests/test_knowledge_store.py" | mcp/tests/test-evidence-lanes.toml:112-112 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The four graph modules and their unit-lane rows (rows 69-73 after the KS-L3 insertions). | "mcp/tests/test_knowledge_family_revision.py" ; "mcp/tests/test_knowledge_graph_reads.py" ; "mcp/tests/test_knowledge_relation_rules.py" ; "mcp/tests/test_knowledge_revision_seals.py" | mcp/tests/test-evidence-lanes.toml:79-109; mcp/tests/test-evidence-lanes.toml:87-109; mcp/tests/test-evidence-lanes.toml:95-103; mcp/tests/test-evidence-lanes.toml:97-109; mcp/tests/test-evidence-lanes.toml:108-108 |
| The four graph modules and their unit-lane rows (rows 69-73 after the KS-L3 insertions). | "mcp/tests/test_knowledge_family_revision.py"; "mcp/tests/test_knowledge_graph_reads.py"; "mcp/tests/test_knowledge_relation_rules.py"; "mcp/tests/test_knowledge_revision_seals.py" | mcp/tests/test-evidence-lanes.toml:74-109; mcp/tests/test-evidence-lanes.toml:76-109; mcp/tests/test-evidence-lanes.toml:81-109; mcp/tests/test-evidence-lanes.toml:79-109; mcp/tests/test-evidence-lanes.toml:95-103; mcp/tests/test-evidence-lanes.toml:97-109; mcp/tests/test-evidence-lanes.toml:108-108 |
...
| The label-operations suite's row and the reason it exists as a separate module. | "mcp/tests/test_knowledge_label_operations.py" | mcp/tests/test-evidence-lanes.toml:98-98 |
...
|  The governed-artifact registration and exact two-consumer list this leaf added. | "contract:common-base-merge-cases" | mcp/tests/evidence-lifecycle.toml:1282-1282  |
| The lane rows the two modules were registered in, and the budget statement they sit under. | `unit-regression`; `integration` | mcp/tests/test-evidence-lanes.toml:5-5; mcp/tests/test-evidence-lanes.toml:201-201; mcp/tests/test-evidence-lanes.toml:196-201; mcp/tests/test-evidence-lanes.toml:201-208; mcp/tests/test-evidence-lanes.toml:5-201; mcp/tests/test-evidence-lanes.toml:192-201; mcp/tests/test-evidence-lanes.toml:195-201; mcp/tests/test-evidence-lanes.toml:194-201; mcp/tests/test-evidence-lanes.toml:206-206; mcp/tests/test-evidence-lanes.toml:229-229; mcp/tests/test-evidence-lanes.toml:190-201; mcp/tests/test-evidence-lanes.toml:196-196 |
|  The governed-artifact registration and exact two-consumer list this leaf added. | "contract:common-base-merge-cases" | mcp/tests/evidence-lifecycle.toml:1282-1282  |
| The lane rows the two modules were registered in, and the budget statement they sit under. | `unit-regression`; `integration` | mcp/tests/test-evidence-lanes.toml:5-5; mcp/tests/test-evidence-lanes.toml:201-201; mcp/tests/test-evidence-lanes.toml:196-201; mcp/tests/test-evidence-lanes.toml:201-208; mcp/tests/test-evidence-lanes.toml:5-201; mcp/tests/test-evidence-lanes.toml:192-201; mcp/tests/test-evidence-lanes.toml:195-201; mcp/tests/test-evidence-lanes.toml:194-201; mcp/tests/test-evidence-lanes.toml:206-206; mcp/tests/test-evidence-lanes.toml:229-229; mcp/tests/test-evidence-lanes.toml:190-201; mcp/tests/test-evidence-lanes.toml:196-196 |
...
| **The staged sealed-aggregate read, with every retained revision row tampered.** | "test_an_artifact_whose_sealed_payload_contradicts_its_digest_is_refused" | mcp/tests/test_knowledge_portable_boundaries.py:611-611 |
...
| The two lane rows this leaf registered, and the three consumer lists it extended. | "integration = [" | mcp/tests/test-evidence-lanes.toml:205-207; mcp/tests/test-evidence-lanes.toml:183-207; mcp/tests/test-evidence-lanes.toml:196-207 |
...
| The unit-lane row the read's selection module occupies. | "mcp/tests/test_knowledge_read_scope.py" | mcp/tests/test-evidence-lanes.toml:103-103 |
| The two integration-lane rows the read's boundary and path modules occupy. | "mcp/tests/test_knowledge_read_boundaries.py"; "mcp/tests/test_knowledge_read_paths.py" | mcp/tests/test-evidence-lanes.toml:214-214; mcp/tests/evidence-lifecycle.toml:1312-1312; mcp/tests/evidence-lifecycle.toml:1312-1313; mcp/tests/evidence-lifecycle.toml:1421-1422; mcp/tests/test-evidence-lanes.toml:212-212 |
| The read fixture and its registered contract. | `build_read_scope_fixture`; `knowledge-read-scope-cases` | mcp/tests/read_scope_test_support.py:266-284; mcp/tests/evidence-lifecycle.toml:1203-1207; mcp/tests/evidence-lifecycle.toml:1227-1247; mcp/tests/evidence-lifecycle.toml:65-65 |
| The unit-lane row the read's selection module occupies. | "mcp/tests/test_knowledge_read_scope.py" | mcp/tests/test-evidence-lanes.toml:103-103 |
| The two integration-lane rows the read's boundary and path modules occupy. | "mcp/tests/test_knowledge_read_boundaries.py"; "mcp/tests/test_knowledge_read_paths.py" | mcp/tests/test-evidence-lanes.toml:214-214; mcp/tests/evidence-lifecycle.toml:1313-1313; mcp/tests/evidence-lifecycle.toml:1313-1314; mcp/tests/evidence-lifecycle.toml:1422-1422; mcp/tests/evidence-lifecycle.toml:1421-1422; mcp/tests/test-evidence-lanes.toml:212-212 |
...
| **The two lane rows this leaf registered.** | "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" | mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:213-213 |
| **The fixture and the governed contract it is registered under.** | `build_diff_fixture`; `knowledge-diff-cases` | mcp/tests/diff_scope_test_support.py:189-233; mcp/tests/evidence-lifecycle.toml:1198-1202; mcp/tests/evidence-lifecycle.toml:60-60 |
| **The two lane rows this leaf registered.** | "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" | mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:213-213 |
| **The catalog digest re-pin that a new test module obliges.** | `LIFECYCLE_CATALOG_SHA256` | mcp/tests/test_dependency_ownership_ast_helpers.py:43-65 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| **The byte-identity node: the shipped page and result compared against digests measured before this leaf existed.** | "test_the_shipped_seed_page_is_byte_identical_and_the_facet_page_is_its_own_policy" | mcp/tests/test_knowledge_facets.py:1214-1214 |
| **The exact facet page, the empty-but-real selection, the incompleteness refusal and the damaged-seal refusal.** | "test_a_facet_does_not_join_a_shipped_seed_and_the_facet_page_is_exact" | mcp/tests/test_knowledge_facets.py:1266-1266 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The publish refusal names the one omitted member, for each of the nine. | "test_publish_refusal_names_the_one_missing_publication_member" | mcp/tests/test_curator_coherence_publication_discoverability.py:145-162 |
| The all-nine refusal names every member in declaration order. | "test_publish_refusal_without_any_member_names_all_nine_in_declaration_order" | mcp/tests/test_curator_coherence_publication_discoverability.py:165-175 |
| The positive control binds the declaration to the request model's own field order. | "test_publish_with_every_publication_member_validates" | mcp/tests/test_curator_coherence_publication_discoverability.py:178-201 |
| The prepare text is asserted from the real `_prepare` path. | "test_prepare_states_the_complete_publication_input_set" | mcp/tests/test_curator_coherence_publication_discoverability.py:204-217 |
| A member added to the declaration reaches both messages with neither text edited. | "test_a_member_added_to_the_declaration_reaches_both_messages" | mcp/tests/test_curator_coherence_publication_discoverability.py:220-240 |
| The sibling refusal names the supplied member for each read action. | "test_non_publish_actions_name_the_publication_member_they_received" | mcp/tests/test_curator_coherence_publication_discoverability.py:243-256 |
| The multi-field refusal names every supplied field in model order, `judgments` included. | "test_non_publish_refusal_names_every_supplied_field_in_model_order" | mcp/tests/test_curator_coherence_publication_discoverability.py:259-273 |
| The freeze branch keeps its own named refusal. | "test_freeze_snapshot_keeps_its_own_named_refusal" | mcp/tests/test_curator_coherence_publication_discoverability.py:276-283 |
...
| **The run module's lane row.** | "mcp/tests/test_knowledge_detection_runs.py" | mcp/tests/test-evidence-lanes.toml:87-87 |
| **The signal module's lane row.** | "mcp/tests/test_knowledge_detection_signals.py" | mcp/tests/test-evidence-lanes.toml:88-88 |
|**The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-diff-cases"| mcp/tests/evidence-lifecycle.toml:1396-1396 |
|**The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-diff-cases"| mcp/tests/evidence-lifecycle.toml:1396-1396 |
|**The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-read-scope-cases"| mcp/tests/evidence-lifecycle.toml:1418-1418 |
|**The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-read-scope-cases"| mcp/tests/evidence-lifecycle.toml:1418-1418 |
|**The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-diff-cases"| mcp/tests/evidence-lifecycle.toml:1396-1396 |
|**The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-read-scope-cases"| mcp/tests/evidence-lifecycle.toml:1418-1418 |
...
|  The governed-artifact registration and exact two-consumer list this leaf added. | "contract:common-base-merge-cases" | mcp/tests/evidence-lifecycle.toml:1282-1282  |
| The read fixture and its registered contract. | `build_read_scope_fixture`; `knowledge-read-scope-cases` | mcp/tests/read_scope_test_support.py:266-284; mcp/tests/evidence-lifecycle.toml:1203-1207; mcp/tests/evidence-lifecycle.toml:1227-1247; mcp/tests/evidence-lifecycle.toml:1267-1267; mcp/tests/evidence-lifecycle.toml:65-65 |
| The two integration-lane rows the read's boundary and path modules occupy. | "mcp/tests/test_knowledge_read_boundaries.py"; "mcp/tests/test_knowledge_read_paths.py" | mcp/tests/test-evidence-lanes.toml:214-214; mcp/tests/evidence-lifecycle.toml:1312-1312; mcp/tests/evidence-lifecycle.toml:1313-1313; mcp/tests/evidence-lifecycle.toml:1312-1314; mcp/tests/evidence-lifecycle.toml:1421-1422; mcp/tests/evidence-lifecycle.toml:1422-1423; mcp/tests/test-evidence-lanes.toml:212-212 |
| **The fixture and the governed contract it is registered under.** | `build_diff_fixture`; `knowledge-diff-cases` | mcp/tests/diff_scope_test_support.py:189-233; mcp/tests/evidence-lifecycle.toml:1198-1202; mcp/tests/evidence-lifecycle.toml:1262-1262; mcp/tests/evidence-lifecycle.toml:60-60 |
| **The two lane rows this leaf registered.** | "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" | mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:213-213 |
| **The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).** | "contract:knowledge-diff-cases" | mcp/tests/evidence-lifecycle.toml:1396-1396 |
| **The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).** | "contract:knowledge-diff-cases" | mcp/tests/evidence-lifecycle.toml:1396-1396 |
| **The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).** | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1418-1418 |
...
| **The integration lane row this leaf opened, and the governed contract whose consumer list gained the boundary module.** | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1418-1418 |
...
| **The seam-registry case re-scoped a second time so the union names this leaf's own group constant rather than being trimmed back, and the generation case re-scoped to the structural sequence.** | "test_the_seam_registry_is_exactly_the_eight_declared_subtypes"; "test_the_registered_generation_appends_only_and_the_preceding_ones_are_unchanged" | mcp/tests/test_knowledge_facets.py:183-246; mcp/tests/test_knowledge_facets.py:911-960; mcp/tests/test_knowledge_facets.py:1038-1045; mcp/tests/test_knowledge_facets.py:1065-1065 |

## Update History
- 2026-09-18T19:13+02:00 — 260915-KS-L23 curator (uncommitted change set on `ar/260915-ks-l23`, base `c5a74a85`): **added the L23 section** — the terminal leaf's five new case modules with their lane rows and the property each pins (`D-13`, `D-15`, the right-side merge writes, `D-19`'s two catalog gates, `KS-R24@v1`'s publication discoverability), the second split of `test_final_full_memory_coherence_certification.py` on properties rather than line count (954 + 283 against 1199, the scaffold left where its sibling's import resolves, the empty `diff` of 23 collected node names), the four `consumers` registrations the two governed-support consumers and the item-16 case obliged, the catalogue pin that moved with the counts unchanged at 15 / 65, and the measured **zero integration headroom** (400 / 400 unit 2278 / 2300) that makes `unit-regression` the only safe lane for a new module. Verification metadata is **not** advanced on this route: the five modules are untracked and the split is uncommitted, so no code commit carries the bytes a stamp would claim, and closeout owns that stamp.
- 2026-09-18T18:58+02:00 — 260915-KS-L23 curator (uncommitted change set on `ar/260915-ks-l23`, base `c5a74a85`): **replaced this route's statement of the case-budget rail, which named a pair that no longer exists and a mechanism that never existed.** The `## Development And Certification Policy` paragraph said "The repository declares budgets of 1,100 unit and 300 integration parametrized collected cases". Neither number is the rail (the declared pair is the repository-root `pyproject.toml`'s `unit_case_budget = 2300` / `integration_case_budget = 400`, measured 2026-09-18 at code `c5a74a85`), and after `260915-KS-L23`'s item 12 the mechanism is explicit: `mcp/tests/conftest.py` registers the two ini names with `addini` and **no `default=`**, so there is no second number anywhere for a reader to find; the root file is the `inifile`. The paragraph now states where the pair lives, that it moves, and that the 150/200/250/1000/1100/1250/1500 figures named in this card's history are the dated readings of the leaves that raised them — as-of records, not the rail. This route's own source set changed under it (`mcp/tests/conftest.py` and `mcp/tests/test_suite_budget.py` are both modified in the delivered working tree), so no verification stamp moves: closeout stamps the real code commit, and the card's `reviewedWorkingCandidate` row is left at L22's candidate because this pass re-read the budget paragraph rather than the whole route.
- 2026-09-18T18:10+02:00 — 260915-KS-L22 curator (uncommitted change set on `ar/260915-ks-l22`, base `2dcacb27`): **added the L22 section** — the review-surface case module and the prohibitions its 27 cases pin (the whole-schema forbidden-field walk, the no-record-kind read, the row-count proof that a render stores nothing, the adapter-selects-nothing comparison, the refusal states each rendered as itself, and the worked review journey), the one lane row it inserted mid-list, the two `consumers` registrations it obliged on `diff_scope_test_support.py` and `read_scope_test_support.py`, and the catalogue pin it did not move at 15 contracts / 65 artifacts. Verification metadata is **not** advanced: the code commit does not exist yet and closeout owns that stamp.
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The composition suite's lane row, inserted mid-list under the unit-regression lane. | "mcp/tests/test_knowledge_family_composition.py" | mcp/tests/test-evidence-lanes.toml:93-93 |
| The boundary module's lane row, immediately after it. | "mcp/tests/test_knowledge_family_composition_boundaries.py" | mcp/tests/test-evidence-lanes.toml:94-94 |
...
| **The read-scope contract whose consumer list gained the boundary module.** | "replacement_contract = \"contract:knowledge-read-scope-cases\"" | mcp/tests/evidence-lifecycle.toml:1418-1418 |
| **The read-scope contract whose consumer list gained the boundary module.** | "replacement_contract = \"contract:knowledge-read-scope-cases\"" | mcp/tests/evidence-lifecycle.toml:1418-1418 |
...
`mcp/tests/test-evidence-lanes.toml:92-93`, the integration row is
...
## Update History
- 2026-09-18T15:30+02:00 — 260915-KS-L20 curator (uncommitted change set on `ar/260915-ks-l20`, base `9f88a6de`): **added the L20 section** — the two suites (30 unit cases aimed at failures rather than lines, and 7 integration cases whose centre is the one eight-checkpoint acceptance scenario), the deterministic interruption seam that answers the packet's Open Truth Gap, the two proof obligations that need real records (regeneration and no-second-authority over `PRAGMA table_info`), the registry cost this leaf paid (two lane rows and one `consumers` addition whose drift is inherent, with the counts unchanged at 14 / 64 and the digest re-pinned), and the pre-existing lane-manifest defect it repaired for `test_atomic_series_chain_pair_order.py`. The metadata block above now names this leaf's candidate as what was read; the body was changed substantively and this entry is the history record, not a metadata-only refresh.
...
## Update History
- 2026-09-18T17:00+02:00 — 260915-KS-L21 curator (uncommitted change set on `ar/260915-ks-l21`, base `a7076008`): **added the L21 section** — the two modules `KS-R21@v1` adds and the split between them, the 48 unit cases grouped by the property each family pins (the inventory over the scope, the declared-doc-type authority, the metadata-table boundary, the four parse outcomes, the three reportable resolution states with a fact-only mismatch report, the four-cell accounting and its eligibility rule, both counts, all four slice axes, the unmeasured coverage denominator, generation 9's additive composition, the absent second identity authority, the one write path, and the cutover's prepared-and-not-executed boundary), the fixture's reason for building its dataset through the shipped write path rather than by inserting rows, the registry cost (one contract/artifact pair, one lane row inserted mid-list, the counts moved 14 / 64 → 15 / 65 and the catalogue digest re-pinned to the measured `633b03ee…`), and the three shipped assertions re-scoped rather than deleted. The metadata block above now names this leaf's candidate as what was read and carries **no `lastVerifiedCommitHash`**: the body was re-read against a working candidate no commit contains, so no real commit holds the content a stamp would claim to have verified, and closeout owns the stamp. The body was changed substantively and this entry is the history record, not a metadata-only refresh.
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The new case module and its lane marker. | "pytestmark = pytest.mark.evidence_unit" | mcp/tests/test_knowledge_review_surface.py:93-93 |
| The forbidden-name set the whole payload schema is walked against. | `FORBIDDEN_FIELD_NAMES` | mcp/tests/test_knowledge_review_surface.py:96-119 |
| The row-level proof that a full render stores nothing. | "def test_the_surface_stores_nothing_so_deleting_every_rendering_loses_no_canonical_information(" | mcp/tests/test_knowledge_review_surface.py:440-450 |
| The case that the adapter selects nothing, compared value for value. | "def test_the_adapter_selects_nothing_because_the_shipped_comparison_is_the_comparison_rendered(" | mcp/tests/test_knowledge_review_surface.py:453-499 |
| The transport case: typed result, a 400 and a 503. | "def test_the_route_serves_the_typed_result_and_refuses_by_name_with_no_adapter(" | mcp/tests/test_knowledge_review_surface.py:789-845 |
| **The two cases that were widened rather than added to: the unresolvable context now also proves the entry read refuses with the same code, and the pane-name case measures the entry list against the shipped comparison's own answer.** | `test_the_published_assessment_loader_returns_nothing_for_an_unresolvable_candidate`; `test_the_rendered_pane_types_are_the_three_the_design_names` | mcp/tests/test_knowledge_review_surface.py:848-874; mcp/tests/test_knowledge_review_surface.py:876-946 |
| The lane row this leaf inserted mid-list. | "mcp/tests/test_knowledge_review_surface.py"; `test_knowledge_review_surface` | mcp/tests/test-evidence-lanes.toml:104-104 |
| The lane row this leaf inserted mid-list. | "mcp/tests/test_knowledge_review_surface.py"; `test_knowledge_review_surface` | mcp/tests/test-evidence-lanes.toml:104-104 |
...
| The two `consumers` registrations the module obliged. | "mcp/tests/test_knowledge_review_surface.py"; `test_knowledge_review_surface` | mcp/tests/evidence-lifecycle.toml:1403-1403; mcp/tests/evidence-lifecycle.toml:1433-1433 |
| The catalogue pin the leaf did not move. | "LIFECYCLE_CONTRACT_COUNT = 16"; "LIFECYCLE_ARTIFACT_COUNT = 66" | mcp/tests/test_dependency_ownership_ast_helpers.py:44-44; mcp/tests/test_dependency_ownership_ast_helpers.py:45-45 |
...
(`mcp/tests/test-evidence-lanes.toml:191-195`) rather than inserting them in alphabetical position —
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The five lane rows, appended rather than inserted. | "mcp/tests/test_next_step_address_binding.py"; "mcp/tests/test_curator_coherence_publication_discoverability.py" | mcp/tests/test-evidence-lanes.toml:196-196; mcp/tests/test-evidence-lanes.toml:200-200 |
| **The four consumer registrations the two governed-support consumers and the item-16 case obliged.** | "mcp/tests/test_knowledge_merge_right_side_writes.py"; "mcp/tests/test_evidence_catalog_gate_boundaries.py"; "mcp/tests/test_memory_citation_resolution.py" | mcp/tests/evidence-lifecycle.toml:1289-1289; mcp/tests/evidence-lifecycle.toml:177-177; mcp/tests/test-evidence-lanes.toml:123-123 |
| The catalogue pin's three constants as the landed line leaves them — **16 contracts / 66 artifacts** at `:44-45`, sha256 `ce292758…` at `:46`. A consumer-only change does not move the counts; the `T129` reconciliation that registered two rows did, from 15 / 65. | "LIFECYCLE_CONTRACT_COUNT = 16"; "LIFECYCLE_ARTIFACT_COUNT = 66" | mcp/tests/test_dependency_ownership_ast_helpers.py:44-46 |
...
| The catalogue pin's three constants, whose **counts** a consumer-only change does not move. | "LIFECYCLE_CONTRACT_COUNT = 16"; "LIFECYCLE_ARTIFACT_COUNT = 66" | mcp/tests/test_dependency_ownership_ast_helpers.py:44-44; mcp/tests/test_dependency_ownership_ast_helpers.py:45-45; mcp/tests/test_dependency_ownership_ast_helpers.py:46-46 |
| **The split's two subjects and the scaffold that stayed behind.** | "Split a second time at the same hard limit" | mcp/tests/test_final_full_memory_coherence_certification.py:1-21 |
| The scaffold the sibling imports, still exported from the kept module. | `_pair`; `_coherence`; `_passing_checks` | mcp/tests/test_final_full_memory_coherence_certification.py:802-846 |
| The publication-input cases in their new home, asserting the declaration is the model's own field order. | `test_publish_with_every_publication_member_validates` | mcp/tests/test_curator_coherence_publication_discoverability.py:178-201 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The knowledge-conflict case: the sync completes, both sides survive, and the caller invokes no merge entry point. | `_assert_knowledge_database_conflict_settles` | mcp/tests/test_worktree_sync.py:129-183 |
| The renamed collected case, the three knowledge-conflict scenario helpers this leaf added, and the shipped content scenarios it shares the case with. | `test_memory_merge_settles_content_and_knowledge_conflicts_in_the_transaction`; `_assert_knowledge_conflict_scenarios`; `_assert_memory_content_conflict_scenarios` | mcp/tests/test_worktree_sync.py:624-646; mcp/tests/test_worktree_sync.py:647-679; mcp/tests/test_worktree_sync.py:680-762 |
| The shared harness the direct row declares, and the two names this module takes from it. | `build_case`; `file_digest` | mcp/tests/merge_case_test_support.py:511-573; mcp/tests/merge_case_test_support.py:607-612 |
| The transitive row: a module that never mentions the harness and reaches it through its import of `test_worktree_sync`. | `SyncFixture` | mcp/tests/test_sync_parked_candidate.py:24-24; mcp/tests/test_worktree_sync.py:48-48 |
| The two consumer rows the exact list carries at the tail, and the catalogue's own byte pin. | "mcp/tests/test_sync_parked_candidate.py"; "LIFECYCLE_CATALOG_SHA256" | mcp/tests/evidence-lifecycle.toml:1290-1290; mcp/tests/test_dependency_ownership_ast_helpers.py:46-46 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The re-pointed case: two sibling enclosures, one reused label, distinct stored identities, and continuity by naming the stored id. | `_cycle01_reused_label_identity`; `_cycle01_sibling_contract` | mcp/tests/test_knowledge_curator_ingest_list.py:2153-2270; mcp/tests/test_knowledge_curator_ingest_list.py:2273-2287; mcp/tests/test_knowledge_curator_ingest_list.py:2309-2426; mcp/tests/test_knowledge_curator_ingest_list.py:2429-2443 |
...
| The allocation the case's distinct identities come from. | `_creation`; `_Allocation`; `_with_replays` | mcp/src/agents_remember/application/knowledge_curator_ingest.py:1631-1670; mcp/src/agents_remember/application/knowledge_curator_ingest.py:1753-1760 |
