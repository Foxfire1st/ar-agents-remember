...
|  The governed-artifact registration and exact two-consumer list this leaf added. | "contract:common-base-merge-cases" | mcp/tests/evidence-lifecycle.toml:1280-1281  |
| The lane rows the two modules were registered in, and the budget statement they sit under. | `unit-regression`; `integration` | mcp/tests/test-evidence-lanes.toml:205-205; mcp/tests/test-evidence-lanes.toml:196-205 |
...
| The two lane rows this leaf registered, and the three consumer lists it extended. | "integration = [" | mcp/tests/test-evidence-lanes.toml:205-205; mcp/tests/test-evidence-lanes.toml:183-205; mcp/tests/test-evidence-lanes.toml:196-205 |
...
| **The two lane rows this leaf registered.** | "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" | mcp/tests/test-evidence-lanes.toml:86-107; mcp/tests/test-evidence-lanes.toml:103-107; mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:94-107; mcp/tests/test-evidence-lanes.toml:189-211; mcp/tests/test-evidence-lanes.toml:211-211 |
...
| **The two lane rows this leaf registered.** | "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" | mcp/tests/test-evidence-lanes.toml:81-107; mcp/tests/test-evidence-lanes.toml:165-211; mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:94-107; mcp/tests/test-evidence-lanes.toml:189-211; mcp/tests/test-evidence-lanes.toml:211-211 |
| **The catalog digest re-pin that a new test module obliges.** | `LIFECYCLE_CATALOG_SHA256` | mcp/tests/test_dependency_ownership_ast_helpers.py:43-65 |
...
| **The two lane rows this leaf registered.** | "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" | mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:81-167; mcp/tests/test-evidence-lanes.toml:103-107; mcp/tests/test-evidence-lanes.toml:189-211; mcp/tests/test-evidence-lanes.toml:211-211 |
| **The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).** | "contract:knowledge-diff-cases" | mcp/tests/evidence-lifecycle.toml:1390-1391 |
| **The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).** | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1412-1413 |
