...
| The public journey itself: a private pair, task A's publication, task B's baseline fork, and the measurements read from the databases. | `_cycle01_cli_baseline_journey`; `_cycle01_task_a`; `_cycle01_task_b`; `_cycle01_baseline_consequences` | mcp/tests/test_knowledge_curator_ingest_list.py:2123-2150; mcp/tests/test_knowledge_curator_ingest_list.py:1932-1963; mcp/tests/test_knowledge_curator_ingest_list.py:1966-2012; mcp/tests/test_knowledge_curator_ingest_list.py:2015-2054; mcp/tests/test_knowledge_curator_ingest_list.py:2279-2306; mcp/tests/test_knowledge_curator_ingest_list.py:2088-2119; mcp/tests/test_knowledge_curator_ingest_list.py:2122-2168; mcp/tests/test_knowledge_curator_ingest_list.py:2171-2210 |
...
| The allocation the case's distinct identities come from. | `_creation`; `_Allocation`; `_with_replays` | mcp/src/agents_remember/application/knowledge_curator_ingest.py:1631-1670; mcp/src/agents_remember/application/knowledge_curator_ingest.py:1720-1727 |
