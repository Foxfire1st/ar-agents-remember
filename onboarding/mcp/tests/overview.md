...
| The L34 boundary module: the public checkpoint route end to end, and both surfaces' refusals for each divergent ledger and for a completed master. | `CheckpointPausesAnUnfinishedMasterTests`; `test_an_unfinished_master_checkpoints_its_own_refs_end_to_end`; `test_the_closeout_preview_refuses_what_the_closeout_apply_refuses`; `test_a_hand_edited_master_ledger_is_refused_by_the_preview_and_the_apply` | mcp/tests/test_checkpoint_landing_end_to_end.py:412-1190; mcp/tests/test_checkpoint_landing_end_to_end.py:440-499; mcp/tests/test_checkpoint_landing_end_to_end.py:678-710; mcp/tests/test_checkpoint_landing_end_to_end.py:1101-1132 |
...
| The L37 stop boundary proof: the public pause, the measured world, the eight independently-failing cases and the refusals. | `PauseStopsAnAtomicMasterTests`; `_world`; `test_pausing_a_master_moves_no_ref_and_creates_no_commit`; `test_a_paused_master_hands_the_turn_back_with_no_next_call` | mcp/tests/test_pause_stop_only_end_to_end.py:84-116; mcp/tests/test_pause_stop_only_end_to_end.py:148-166; mcp/tests/test_pause_stop_only_end_to_end.py:201-232; mcp/tests/test_pause_stop_only_end_to_end.py:234-261 |
...
| The L37 lane registrations the fail-closed manifest requires, one per new module. | "mcp/tests/test_pause_stop_only_end_to_end.py"; "mcp/tests/test_pause_is_not_publication.py" | mcp/tests/test-evidence-lanes.toml:158-158; mcp/tests/test-evidence-lanes.toml:190-190 |
