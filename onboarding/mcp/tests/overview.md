...
`nextArgs`
cit:(["# The next-move triple, declared here so the worktree surface's guidance is part of"], mcp/src/agents_remember/models/worktree.py:353-353), and refuse a `nextTool` outside the roster
...
| The lifecycle catalog registration for the shared support module, with its four derived consumers. | "path = \"mcp/tests/eve_capsule_test_support.py\"" | mcp/tests/evidence-lifecycle.toml:1437-1437 |
...
| The lane rows that admit both L14 modules to the `unit-regression` lane. | "mcp/tests/test_citation_index_resilience.py"; "mcp/tests/test_fresh_user_harness.py" | mcp/tests/test-evidence-lanes.toml:31-31; mcp/tests/test-evidence-lanes.toml:69-69 |
| The three `scripts/e2e_harness` [[artifact]] rows a leaf under that permanent support root must register. | "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" | mcp/tests/evidence-lifecycle.toml:1553-1553 |
| The lane rows that admit both L14 modules to the `unit-regression` lane. | "mcp/tests/test_citation_index_resilience.py"; "mcp/tests/test_fresh_user_harness.py" | mcp/tests/test-evidence-lanes.toml:31-31; mcp/tests/test-evidence-lanes.toml:69-69 |
...
| The L36 lane registration the fail-closed manifest requires. | "mcp/tests/test_cross_master_concurrency.py" | mcp/tests/test-evidence-lanes.toml:232-232 |
...
| The lane registration the fail-closed manifest requires for that module. | "mcp/tests/test_lifecycle_playthrough_end_to_end.py" | mcp/tests/test-evidence-lanes.toml:245-245 |
...
| The L5 binding module's lane registration, added by the same change set that created it. | "mcp/tests/test_leaf_doc_master_link_binding.py" | mcp/tests/test-evidence-lanes.toml:242-242 |
...
| The L23 lane registration the fail-closed manifest requires, inserted between two alphabetically adjacent rows so no other entry moved. | "mcp/tests/test_terminal_liveness_registration_order.py" | mcp/tests/test-evidence-lanes.toml:184-184 |
...
| The architecture-fitness lane registration the fail-closed manifest requires for that proof. | "mcp/tests/test_terminal_liveness_pane_authority.py" | mcp/tests/test-evidence-lanes.toml:269-269 |
...
|  The governed-artifact registration and exact two-consumer list this leaf added. | "contract:common-base-merge-cases" | mcp/tests/evidence-lifecycle.toml:1280-1281  |
| The lane rows the two modules were registered in, and the budget statement they sit under. | `unit-regression`; `integration` | mcp/tests/test-evidence-lanes.toml:205-205; mcp/tests/test-evidence-lanes.toml:196-205; mcp/tests/test-evidence-lanes.toml:201-208; mcp/tests/test-evidence-lanes.toml:5-205; mcp/tests/test-evidence-lanes.toml:192-205; mcp/tests/test-evidence-lanes.toml:195-205; mcp/tests/test-evidence-lanes.toml:194-205; mcp/tests/test-evidence-lanes.toml:190-205 |
|  The governed-artifact registration and exact two-consumer list this leaf added. | "contract:common-base-merge-cases" | mcp/tests/evidence-lifecycle.toml:1280-1281  |
| The lane rows the two modules were registered in, and the budget statement they sit under. | `unit-regression`; `integration` | mcp/tests/test-evidence-lanes.toml:205-207; mcp/tests/test-evidence-lanes.toml:196-207 |
...
|**The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-diff-cases"| mcp/tests/evidence-lifecycle.toml:1390-1391 |
|**The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-read-scope-cases"| mcp/tests/evidence-lifecycle.toml:1412-1413 |
...
| **The two lane rows this leaf registered.** | "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" | mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:81-167; mcp/tests/test-evidence-lanes.toml:103-107; mcp/tests/test-evidence-lanes.toml:189-213; mcp/tests/test-evidence-lanes.toml:211-213 |
| **The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).** | "contract:knowledge-diff-cases" | mcp/tests/evidence-lifecycle.toml:1390-1391 |
| **The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).** | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1412-1413 |
...
| **The integration lane row this leaf opened, and the governed contract whose consumer list gained the boundary module.** | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1401-1401 |
...
| **The read-scope contract whose consumer list gained the boundary module.** | "replacement_contract = \"contract:knowledge-read-scope-cases\"" | mcp/tests/evidence-lifecycle.toml:1412-1413 |
...
| The transport case: typed result, a 400 and a 503. | "def test_the_route_serves_the_typed_result_and_refuses_by_name_with_no_adapter(" | mcp/tests/test_knowledge_review_surface.py:791-847 |
...
| The two `consumers` registrations the module obliged. | "mcp/tests/test_knowledge_review_surface.py"; `test_knowledge_review_surface` | mcp/tests/evidence-lifecycle.toml:1395-1398; mcp/tests/evidence-lifecycle.toml:1421-1426 |
...
| **The three consumer registrations the two governed-support consumers obliged, and the lane registration the item-16 case obliged.** | "mcp/tests/test_knowledge_merge_right_side_writes.py"; "mcp/tests/test_evidence_catalog_gate_boundaries.py"; "mcp/tests/test_memory_citation_resolution.py" | mcp/tests/evidence-lifecycle.toml:177-194; mcp/tests/evidence-lifecycle.toml:807-808; mcp/tests/evidence-lifecycle.toml:1288-1288; mcp/tests/test-evidence-lanes.toml:123-123 |
...
| **The budget pair the populations are measured against, and the `UsageError` that makes an over-budget lane execute zero tests.** | `unit_case_budget`; `integration_case_budget`; `pytest_collection_finish` | pyproject.toml:263-264; mcp/tests/conftest.py:148-159 |
