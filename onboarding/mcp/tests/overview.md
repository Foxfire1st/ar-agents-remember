...
cit:([`_require_registered_public_next_tool`], mcp/src/agents_remember/models/worktree.py:377-388)). Before that the envelope was `extra="allow"` and
cit:(["# The next-move triple, declared here so the worktree surface's guidance is part of"], mcp/src/agents_remember/models/worktree.py:352-352), and refuse a `nextTool` outside the roster
...
| The lifecycle catalog registration for the shared support module, with its four derived consumers. | "path = \"mcp/tests/eve_capsule_test_support.py\"" | mcp/tests/evidence-lifecycle.toml:1457-1457 |
| The lifecycle catalog registration for the shared support module, with its four derived consumers. | "path = \"mcp/tests/eve_capsule_test_support.py\"" | mcp/tests/evidence-lifecycle.toml:1454-1454 |
...
| The three `scripts/e2e_harness` [[artifact]] rows a leaf under that permanent support root must register. | "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" | mcp/tests/evidence-lifecycle.toml:1573-1573 |
| The three `scripts/e2e_harness` [[artifact]] rows a leaf under that permanent support root must register. | "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" | mcp/tests/evidence-lifecycle.toml:1570-1570 |
| The lane rows that admit both L14 modules to the `unit-regression` lane. | "mcp/tests/test_citation_index_resilience.py"; "mcp/tests/test_fresh_user_harness.py" | mcp/tests/test-evidence-lanes.toml:27-27; mcp/tests/test-evidence-lanes.toml:62-69; mcp/tests/test-evidence-lanes.toml:24-31; mcp/tests/test-evidence-lanes.toml:67-67; mcp/tests/test-evidence-lanes.toml:32-32; mcp/tests/test-evidence-lanes.toml:70-70 |
| The three `scripts/e2e_harness` [[artifact]] rows a leaf under that permanent support root must register. | "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" | mcp/tests/evidence-lifecycle.toml:1573-1573 |
| The three `scripts/e2e_harness` [[artifact]] rows a leaf under that permanent support root must register. | "path = \"scripts/e2e_harness/fresh_user_fixture.py\"" | mcp/tests/evidence-lifecycle.toml:1570-1570 |
...
| The two integration-lane rows the read's boundary and path modules occupy. | "mcp/tests/test_knowledge_read_boundaries.py"; "mcp/tests/test_knowledge_read_paths.py" | mcp/tests/test-evidence-lanes.toml:206-212; mcp/tests/test-evidence-lanes.toml:208-212; mcp/tests/test-evidence-lanes.toml:207-212; mcp/tests/evidence-lifecycle.toml:1312-1312; mcp/tests/evidence-lifecycle.toml:1312-1313; mcp/tests/evidence-lifecycle.toml:1421-1422 |
...
| The unit-lane row the read's selection module occupies. | "mcp/tests/test_knowledge_read_scope.py" | mcp/tests/test-evidence-lanes.toml:103-103 |
| The two integration-lane rows the read's boundary and path modules occupy. | "mcp/tests/test_knowledge_read_boundaries.py"; "mcp/tests/test_knowledge_read_paths.py" | mcp/tests/test-evidence-lanes.toml:206-212; mcp/tests/test-evidence-lanes.toml:208-212; mcp/tests/test-evidence-lanes.toml:207-212; mcp/tests/evidence-lifecycle.toml:1313-1313; mcp/tests/evidence-lifecycle.toml:1313-1314; mcp/tests/evidence-lifecycle.toml:1422-1422; mcp/tests/evidence-lifecycle.toml:1421-1422 |
...
| **The two lane rows this leaf registered.** | "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" | mcp/tests/test-evidence-lanes.toml:86-107; mcp/tests/test-evidence-lanes.toml:103-107; mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:94-107; mcp/tests/test-evidence-lanes.toml:189-213; mcp/tests/test-evidence-lanes.toml:211-213 |
...
| **The two lane rows this leaf registered.** | "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" | mcp/tests/test-evidence-lanes.toml:81-107; mcp/tests/test-evidence-lanes.toml:165-213; mcp/tests/test-evidence-lanes.toml:107-107; mcp/tests/test-evidence-lanes.toml:94-107; mcp/tests/test-evidence-lanes.toml:189-213; mcp/tests/test-evidence-lanes.toml:211-213 |
| **The catalog digest re-pin that a new test module obliges.** | `LIFECYCLE_CATALOG_SHA256` | mcp/tests/test_dependency_ownership_ast_helpers.py:43-65 |
...
|**The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-diff-cases"| mcp/tests/evidence-lifecycle.toml:1398-1398 |
|**The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-diff-cases"| mcp/tests/evidence-lifecycle.toml:1394-1394 |
|**The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-read-scope-cases"| mcp/tests/evidence-lifecycle.toml:1420-1420 |
|**The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-read-scope-cases"| mcp/tests/evidence-lifecycle.toml:1416-1416 |
|**The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-diff-cases"| mcp/tests/evidence-lifecycle.toml:1398-1398 |
|**The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).**|"contract:knowledge-read-scope-cases"| mcp/tests/evidence-lifecycle.toml:1420-1420 |
...
| The two integration-lane rows the read's boundary and path modules occupy. | "mcp/tests/test_knowledge_read_boundaries.py"; "mcp/tests/test_knowledge_read_paths.py" | mcp/tests/test-evidence-lanes.toml:206-212; mcp/tests/test-evidence-lanes.toml:208-212; mcp/tests/test-evidence-lanes.toml:207-212; mcp/tests/evidence-lifecycle.toml:1312-1312; mcp/tests/evidence-lifecycle.toml:1313-1313; mcp/tests/evidence-lifecycle.toml:1312-1314; mcp/tests/evidence-lifecycle.toml:1421-1422; mcp/tests/evidence-lifecycle.toml:1422-1423 |
...
| **The two lane rows this leaf registered.** | "mcp/tests/test_knowledge_diff_scope.py"; "mcp/tests/test_knowledge_diff_boundaries.py" | mcp/tests/test-evidence-lanes.toml:106-106; mcp/tests/test-evidence-lanes.toml:81-167; mcp/tests/test-evidence-lanes.toml:103-106; mcp/tests/test-evidence-lanes.toml:189-196; mcp/tests/test-evidence-lanes.toml:198-198; mcp/tests/test-evidence-lanes.toml:103-103; mcp/tests/test-evidence-lanes.toml:207-207; mcp/tests/test-evidence-lanes.toml:201-201; mcp/tests/test-evidence-lanes.toml:107-107 |
| **The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).** | "contract:knowledge-diff-cases" | mcp/tests/evidence-lifecycle.toml:1398-1398 |
| **The diff-comparison contract whose consumer list gained the run module (the consumer row is the third entry of that block).** | "contract:knowledge-diff-cases" | mcp/tests/evidence-lifecycle.toml:1394-1394 |
| **The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).** | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1420-1420 |
| **The read-scope contract whose consumer list gained the run module (the consumer row is the third entry of that block).** | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1416-1416 |
...
| **The integration lane row this leaf opened, and the governed contract whose consumer list gained the boundary module.** | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1416-1416 |
...
| **The read-scope contract whose consumer list gained the boundary module.** | "replacement_contract = \"contract:knowledge-read-scope-cases\"" | mcp/tests/evidence-lifecycle.toml:1420-1420 |
| **The read-scope contract whose consumer list gained the boundary module.** | "replacement_contract = \"contract:knowledge-read-scope-cases\"" | mcp/tests/evidence-lifecycle.toml:1416-1416 |
...
| The two `consumers` registrations the module obliged. | "mcp/tests/test_knowledge_review_surface.py"; `test_knowledge_review_surface` | mcp/tests/evidence-lifecycle.toml:1405-1405; mcp/tests/evidence-lifecycle.toml:1434-1434 |
| The catalogue pin the leaf did not move. | "LIFECYCLE_CONTRACT_COUNT = 15"; "LIFECYCLE_ARTIFACT_COUNT = 65" | mcp/tests/test_dependency_ownership_ast_helpers.py:44-45 |
...
| **The budget pair the populations are measured against, and the `UsageError` that makes an over-budget lane execute zero tests.** | `unit_case_budget`; `integration_case_budget`; `pytest_collection_finish` | pyproject.toml:244-245; mcp/tests/conftest.py:132-143 |
| The catalogue pin's three constants, whose **counts** a consumer-only change does not move. | "LIFECYCLE_CONTRACT_COUNT = 15"; "LIFECYCLE_ARTIFACT_COUNT = 65" | mcp/tests/test_dependency_ownership_ast_helpers.py:44-46 |
