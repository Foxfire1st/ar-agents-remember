...
| The lane rows that admit both L14 modules to the `unit-regression` lane. | "mcp/tests/test_citation_index_resilience.py"; "mcp/tests/test_fresh_user_harness.py" | mcp/tests/test-evidence-lanes.toml:31-31; mcp/tests/test-evidence-lanes.toml:69-69; mcp/tests/test-evidence-lanes.toml:31-31; mcp/tests/test-evidence-lanes.toml:69-69 |
...
| The L36 lane registration the fail-closed manifest requires. | "mcp/tests/test_cross_master_concurrency.py" | mcp/tests/test-evidence-lanes.toml:230-230 |
...
| The lane registration the fail-closed manifest requires for that module. | "mcp/tests/test_lifecycle_playthrough_end_to_end.py" | mcp/tests/test-evidence-lanes.toml:243-243 |
...
| The L5 binding module's lane registration, added by the same change set that created it. | "mcp/tests/test_leaf_doc_master_link_binding.py" | mcp/tests/test-evidence-lanes.toml:240-240 |
...
| The L23 lane registration the fail-closed manifest requires, inserted between two alphabetically adjacent rows so no other entry moved. | "mcp/tests/test_terminal_liveness_registration_order.py" | mcp/tests/test-evidence-lanes.toml:183-183 |
...
| **260913-LCA-L8:** the nine exact-consumer rows the new module's change set adds to the evidence registry. | "mcp/tests/test_terminal_blocker_reasons.py" | mcp/tests/evidence-lifecycle.toml:359-359; mcp/tests/evidence-lifecycle.toml:435-435; mcp/tests/evidence-lifecycle.toml:482-482; mcp/tests/evidence-lifecycle.toml:613-613; mcp/tests/evidence-lifecycle.toml:652-652; mcp/tests/evidence-lifecycle.toml:763-763; mcp/tests/evidence-lifecycle.toml:1077-1077; mcp/tests/evidence-lifecycle.toml:1134-1134; mcp/tests/evidence-lifecycle.toml:1160-1160 |
...
| The lane registration the fail-closed manifest requires for that module (row 165 after the KS-L2 and KS-L3 insertions). | "mcp/tests/test_lifecycle_playthrough_end_to_end.py"; "mcp/tests/test_pause_stop_only_end_to_end.py"; "mcp/tests/test_pause_is_not_publication.py" | mcp/tests/test-evidence-lanes.toml:243-243; mcp/tests/test-evidence-lanes.toml:249-249; mcp/tests/test-evidence-lanes.toml:289-289; mcp/tests/test-evidence-lanes.toml:243-243; mcp/tests/test-evidence-lanes.toml:249-249; mcp/tests/test-evidence-lanes.toml:289-289; mcp/tests/test-evidence-lanes.toml:243-243 |
| The architecture-fitness lane registration the fail-closed manifest requires for that proof. | "mcp/tests/test_terminal_liveness_pane_authority.py" | mcp/tests/test-evidence-lanes.toml:267-267 |
