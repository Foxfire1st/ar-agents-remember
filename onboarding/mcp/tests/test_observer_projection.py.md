...
| The TypeScript mirror of the naming rule, which is why Python moved off `str.capitalize`: the field names are derived type-level with `Capitalize<Camel<Tail>>`. | `stateCountField` | dashboard/src/types/projection.ts:316-320 |
...
- 2026-08-01T10:40+02:00 — 260731-EFA-L4 curator (citation pass): re-verified the eight
  ...
  +10 and none needed reshaping. cit:([`TaskDocNode`, `SeriesSubTaskNode`, `SeriesNode`, `ACTIVE_STATES`, `state_count_field`, `state_count_fields`, `STATE_COUNT_FIELDS`, `Metrics`], mcp/src/agents_remember/observer/projection.py:239-239; mcp/src/agents_remember/observer/projection.py:242-257; mcp/src/agents_remember/observer/projection.py:260-282; mcp/src/agents_remember/observer/projection.py:285-285; mcp/src/agents_remember/observer/projection.py:290-316; mcp/src/agents_remember/observer/projection.py:616-662; mcp/src/agents_remember/observer/projection.py:665-680; mcp/src/agents_remember/observer/projection.py:693-719). No body text changed.
