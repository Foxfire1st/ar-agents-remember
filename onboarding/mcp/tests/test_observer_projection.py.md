...
- 2026-08-01T10:40+02:00 — 260731-EFA-L4 curator (citation pass): re-verified the eight
  ...
  +10 and none needed reshaping. cit:([`TaskDocNode`, `SeriesSubTaskNode`, `SeriesNode`, `ACTIVE_STATES`, `state_count_field`, `state_count_fields`, `STATE_COUNT_FIELDS`, `Metrics`], mcp/src/agents_remember/observer/projection.py:237-237; mcp/src/agents_remember/observer/projection.py:240-255; mcp/src/agents_remember/observer/projection.py:258-280; mcp/src/agents_remember/observer/projection.py:283-283; mcp/src/agents_remember/observer/projection.py:288-314; mcp/src/agents_remember/observer/projection.py:614-660; mcp/src/agents_remember/observer/projection.py:663-678; mcp/src/agents_remember/observer/projection.py:691-717). No body text changed.
