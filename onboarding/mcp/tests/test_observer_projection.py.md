...
- 2026-08-01T10:40+02:00 — 260731-EFA-L4 curator (citation pass): re-verified the eight
  ...
  +10 and none needed reshaping. cit:([`TaskDocNode`, `SeriesSubTaskNode`, `SeriesNode`, `ACTIVE_STATES`, `state_count_field`, `state_count_fields`, `STATE_COUNT_FIELDS`, `Metrics`], mcp/src/agents_remember/observer/projection.py:240-240; mcp/src/agents_remember/observer/projection.py:243-258; mcp/src/agents_remember/observer/projection.py:261-283; mcp/src/agents_remember/observer/projection.py:286-286; mcp/src/agents_remember/observer/projection.py:291-317; mcp/src/agents_remember/observer/projection.py:617-663; mcp/src/agents_remember/observer/projection.py:666-681; mcp/src/agents_remember/observer/projection.py:694-720). No body text changed.
- 2026-08-01T10:40+02:00 — 260731-EFA-L4 curator (citation pass): re-verified the eight
  `projection.py` pointers after a worker inserted ten lines above them; every one moved by exactly
