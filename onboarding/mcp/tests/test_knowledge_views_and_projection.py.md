...
| **The bounding-honesty rule is one statement measured in both directions: rows remaining requires a continuation, and a complete page must carry none.** | `test_incompleteness_and_its_continuation_must_agree` | mcp/tests/test_knowledge_views_and_projection.py:246-275; mcp/src/agents_remember/models/knowledge/view.py:728-772 |
