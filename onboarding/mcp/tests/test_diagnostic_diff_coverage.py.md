...
| --- | --- | --- |
| Closure cases take the validator/store/projection/planning/executor cells the primary suites leave untaken. | `test_cas_collision_fails_closed` | mcp/tests/test_diagnostic_diff_coverage.py:486-492 |
...
| Exercises the shared diagnostics package and executor internals. | `store_module`; `require_gates_one_to_three_green` | mcp/tests/test_diagnostic_diff_coverage.py:17-17; mcp/tests/test_diagnostic_diff_coverage.py:54-59; mcp/tests/test_diagnostic_diff_coverage.py:581-582 |
