...
Part of the 260731-EFA-L7 in-place split family for `test_harness_control_claude_stream_2.py`'s source module; covers the behaviours named by its test classes.

## Code Commentary

- `ClaudeStreamJsonAdapterTests2`
