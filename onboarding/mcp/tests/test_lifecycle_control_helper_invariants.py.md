...
The cases cover worker termination, door/queue ownership, repair failure, retry convergence, and exact completed owners.
...
| --- | --- | --- |
| No external domain source is required for this repository-owned test contract. | `_value` | mcp/tests/test_lifecycle_control_helper_invariants.py:1-339 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The selected scenarios and assertions implement this test unit's forcing proof. | `_value` | mcp/tests/test_lifecycle_control_helper_invariants.py:1-339 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| No meaningful cross-repository reference applies. | `_value` | mcp/tests/test_lifecycle_control_helper_invariants.py:1-339 |
