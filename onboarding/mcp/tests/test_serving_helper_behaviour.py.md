...
| --- | --- | --- |
| The image and retire helpers under test. | "def _looks_like_image(body: bytes"; "def _retire_response(" | mcp/src/agents_remember/serving/_app_common.py:164-164; mcp/src/agents_remember/serving/_app_terminal_routes.py:572-572 |
