...
| --- | --- | --- |
| Diagnostic records must be non-certifying by construction and immune to promotion. | `ModelContractTests.test_promotion_to_acceptance_or_certifying_literals_is_refused` | mcp/tests/test_diagnostic_models.py:432-437 |
