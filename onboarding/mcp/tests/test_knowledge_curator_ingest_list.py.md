...
| The hand-off builders: one entry in revision 1's shape, one target place, the producer's bare symbol spelling, and a producer-written line range. | `entry`; `target`; `symbol`; `_range` | mcp/tests/test_knowledge_curator_ingest_list.py:296-319; mcp/tests/test_knowledge_curator_ingest_list.py:322-325; mcp/tests/test_knowledge_curator_ingest_list.py:334-337; mcp/tests/test_knowledge_curator_ingest_list.py:328-331 |
