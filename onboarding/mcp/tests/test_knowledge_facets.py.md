...
|**The governed artifact this module imports, by its own artifact id, and the two detection consumer rows `KS-R14@v1` added beneath it.**|"id = \"knowledge-facet-cases\""| mcp/tests/evidence-lifecycle.toml:1202-1202 |
