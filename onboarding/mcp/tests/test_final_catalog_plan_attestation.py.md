...
| The suite is registered in the integration lane of the evidence manifest. | "mcp/tests/test_final_catalog_plan_attestation.py" | mcp/tests/test-evidence-lanes.toml:402-402 |
