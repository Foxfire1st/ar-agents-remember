...
| The suite is registered in the integration lane of the evidence manifest. | `test_final_catalog_plan_attestation.py` | mcp/tests/test-evidence-lanes.toml:367-367 |
