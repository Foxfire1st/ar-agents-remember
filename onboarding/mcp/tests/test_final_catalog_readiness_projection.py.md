...
| The suite is registered in the integration lane of the evidence manifest. | `test_final_catalog_readiness_projection.py` | mcp/tests/test-evidence-lanes.toml:368-368 |
