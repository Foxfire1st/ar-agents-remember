...
|The branch-fixture record whose consumer list this module is declared in.|"contract:knowledge-identity-branching-fixture"| mcp/tests/evidence-lifecycle.toml:1051-1051 |
|The merge-cases record whose consumer list this module is also declared in.|"contract:common-base-merge-cases"| mcp/tests/evidence-lifecycle.toml:1159-1159 |
