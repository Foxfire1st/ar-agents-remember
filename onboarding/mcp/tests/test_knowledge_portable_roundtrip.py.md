...
| The lane row that keeps this module in the certifying collection path. | `integration` | mcp/tests/test-evidence-lanes.toml:138-205 |
|The branch-fixture record whose consumer list this module is declared in.|"contract:knowledge-identity-branching-fixture"| mcp/tests/evidence-lifecycle.toml:1190-1191 |
|The merge-cases record whose consumer list this module is also declared in.|"contract:common-base-merge-cases"| mcp/tests/evidence-lifecycle.toml:1280-1281 |
