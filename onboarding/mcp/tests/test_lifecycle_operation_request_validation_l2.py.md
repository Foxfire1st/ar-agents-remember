...
| --- | --- | --- |
| The file defines `test_public_operation_control_payload_refuses_invalid_request_before_authority` as its principal forcing seams. | L43-L85 | `mcp/tests/test_lifecycle_operation_request_validation_l2.py` |
