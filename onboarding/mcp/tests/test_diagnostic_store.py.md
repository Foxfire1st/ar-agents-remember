...
| --- | --- | --- |
| The store namespace is isolated from the certifying quality-report manifest and never writes an optional marker. | `test_namespace_collision_with_the_certifying_manifest_is_refused` | mcp/tests/test_diagnostic_store.py:320-336 |
