...
| Finding | Anchor | Source |
| --- | --- | --- |
| Start returns immediately and duplicate observes one launch. | `test_start_returns_immediately_and_duplicate_observes_one_launch` | mcp/tests/test_lifecycle_operations.py:36-53 |
| The cross-kind/terminal contract-lifecycle lease was removed with the door-operation-journal lock plane, so no lease exclusion is asserted here any more; the retained behaviour is start/observe dedup and the two cancellation boundaries. | `test_cancel_before_boundary_proves_exit_before_releasing_worker_authority` | mcp/tests/test_lifecycle_operations.py:56-117 |
| Cancel before boundary proves exit before releasing worker authority. | `test_cancel_before_boundary_proves_exit_before_releasing_worker_authority` | mcp/tests/test_lifecycle_operations.py:56-117 |
| Cancel after boundary refuses without making approval reusable. | `test_cancel_after_boundary_refuses_without_making_approval_reusable` | mcp/tests/test_lifecycle_operations.py:120-144 |
...
## Update History
- 2026-09-11T23:05:00+00:00: The claim said a contract lifecycle lease excludes cross-kind and terminal mutation and cited `test_contract_lifecycle_lease_excludes_cross_kind_and_terminal_mutation`; the lock plane and that case were deleted, so the row records the removal and names the retained cancellation case that now carries the operation-boundary behaviour.
- 2026-09-11T22:39:01+00:00: Generated citation repair: `test_start_returns_immediately_and_duplicate_observes_one_launch` repointed to mcp/tests/test_lifecycle_operations.py:36-53. No content impact: mechanical anchor-range projection bound to citation source snapshot b911c7c4c4eb354cf78d2a53e1538fc36a5f9a5e36a3702e5953739b48812830; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-11T22:39:01+00:00: Generated citation repair: `test_cancel_before_boundary_proves_exit_before_releasing_worker_authority` repointed to mcp/tests/test_lifecycle_operations.py:56-117. No content impact: mechanical anchor-range projection bound to citation source snapshot b911c7c4c4eb354cf78d2a53e1538fc36a5f9a5e36a3702e5953739b48812830; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-11T22:39:01+00:00: Generated citation repair: `test_cancel_after_boundary_refuses_without_making_approval_reusable` repointed to mcp/tests/test_lifecycle_operations.py:120-144. No content impact: mechanical anchor-range projection bound to citation source snapshot b911c7c4c4eb354cf78d2a53e1538fc36a5f9a5e36a3702e5953739b48812830; claim bytes unchanged; generated by ccr-r10@v1.
