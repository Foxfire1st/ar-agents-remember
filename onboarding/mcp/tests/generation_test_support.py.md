...
| The production builder that turns a generation record into its statements — re-cited by hand after the registry grew to four generations. | `create_schema_statements` | mcp/src/agents_remember/memory/knowledge/schema_generations.py:173-180 |
...
| The version-to-generation resolution this support reads a file through. | `generation_for_version` | mcp/src/agents_remember/memory/knowledge/schema_generations.py:433-454 |
