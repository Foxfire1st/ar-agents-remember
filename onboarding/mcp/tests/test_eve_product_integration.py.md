...
| `CAPS-R17@v1` behaviour 4 is the requirement the declared-exclusion case evidences, and the packet's expected-evidence list asks for the route disposition by name. | `CAPS-R17` | requirements/CAPS-R17-v1-an-eve-seat-launches-with-a-real-effort-consumer.md:61-64 |
...
| The asset and credential boundary. | `EveAssetAndCredentialBoundaryTests` | mcp/tests/test_eve_product_integration.py:1965-2042 |
