...
| The lifecycle suites whose happy paths these arms complete. | `WorktreeSupportTests`; `ContractMemoryModeTests` | mcp/tests/test_worktree_edge_paths.py:134-203; mcp/tests/test_worktree_support.py:847-922 |
