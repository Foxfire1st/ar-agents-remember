...
| Finding | Anchor | Source |
| --- | --- | --- |
| The live case is gated on the installed CLI version and reports a mismatch as a skip, never as a pass. | `test_live_app_server_observes_instruction_sources_and_accepts_the_capsule` | mcp/tests/test_codex_capsule_delivery.py:1206-1207 |
