...
| The terminal operation that now owns reclamation, so the projected move is not a cleanup retry. | `lifecycle_finalize_task_tool` | mcp/src/agents_remember/application/worktree_tools.py:826-859 |
