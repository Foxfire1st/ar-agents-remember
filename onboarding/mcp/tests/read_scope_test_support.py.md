...
| **The governed-artifact and contract rows that make this module part of the catalog.** | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1293-1293 |
| The three declared consumers, checked against the source (the row's consumer list names `mcp/tests/test_knowledge_read_paths.py`). | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1293-1293 |
