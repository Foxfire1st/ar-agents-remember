...
| **The governed-artifact and contract rows that make this module part of the catalog.** | "contract:knowledge-read-scope-cases" | mcp/tests/evidence-lifecycle.toml:1239-1239 |
| The three declared consumers, checked against the source. | "mcp/tests/test_knowledge_read_paths.py" | mcp/tests/evidence-lifecycle.toml:1245-1245 |
