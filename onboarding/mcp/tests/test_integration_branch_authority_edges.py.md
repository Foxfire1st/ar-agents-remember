...
Forces production-bound edge cases for protected code, memory, and ledger refs across admission, irreversible-edge revalidation, crash recovery, and conflicting movement.

### Current Invariants

- Current recorded base pairs are checked at admission and the mutation edge.
- Movement returns exact sync/recovery evidence rather than being silently overwritten.


## PDLS Reconciliation

Authority edge cases now cover the decomposed protected-surface availability and owner-override validators.
