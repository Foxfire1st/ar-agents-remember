...
| --- | --- | --- |
| The integration-lane row this module's classification rests on, and the lane header that declares the classification. | "mcp/tests/test_curator_review_assessment_publication.py"; "integration = [" | mcp/tests/test-evidence-lanes.toml:166-205; mcp/tests/test-evidence-lanes.toml:205-238; mcp/tests/test-evidence-lanes.toml:278-281; mcp/tests/test-evidence-lanes.toml:255-281; mcp/tests/test-evidence-lanes.toml:183-205; mcp/tests/test-evidence-lanes.toml:205-205; mcp/tests/test-evidence-lanes.toml:196-205 |
|The shared support module this module is registered as a consumer of.|"mcp/tests/test_curator_review_assessment_publication.py"| mcp/tests/evidence-lifecycle.toml:360-360; mcp/tests/test-evidence-lanes.toml:278-278; mcp/tests/evidence-lifecycle.toml:403-410; mcp/tests/evidence-lifecycle.toml:414-420 |
