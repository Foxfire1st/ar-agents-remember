...
| --- | --- | --- |
| The integration lane registration this module's classification rests on. | `integration`; "mcp/tests/test_curator_review_assessment_publication.py" | mcp/tests/test-evidence-lanes.toml:161-161; mcp/tests/test-evidence-lanes.toml:230-230 |
