...
| The replay requirement the R4 case pins. | "def _integration_replay_requirements(contract: WorktreeContract) -> IntegrationSources:" | mcp/src/agents_remember/worktrees/modules/integrate.py:255-275 |
