...
| Finding | Anchor | Source |
| --- | --- | --- |
| The ancestry validator the R3 cases pin, including the expected-head set. | `_validate_closeout_source_heads`; `_landed_source_heads` | mcp/src/agents_remember/worktrees/modules/closeout.py:286-315; mcp/src/agents_remember/worktrees/modules/closeout.py:144-160 |
| The widened condition that admits a checkpoint's recorded head. | "contract.integration_status in {\"completed\", \"checkpointed\"} and integrated" | mcp/src/agents_remember/worktrees/modules/closeout.py:156-156 |
| The replay requirement the R4 case pins. | `_integration_replay_requirements` | mcp/src/agents_remember/worktrees/modules/integrate.py:256-278 |
...
| The closed-input normalizer R1/R2 are pinned through. | `normalize_closeout_input` | mcp/src/agents_remember/worktrees/closeout_input.py:123-179 |
