...
| --- | --- | --- |
| Diagnostics may only replicate the exact canonical scenario rails at diagnostic altitude. | `DiagnosticPlanningTests.test_rail_catalog_drift_is_refused_as_a_second_scenario` | mcp/tests/test_diagnostic_planning.py:275-288 |
