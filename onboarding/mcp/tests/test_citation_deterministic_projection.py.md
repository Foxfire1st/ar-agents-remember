...
| The suite is registered in the integration lane of the evidence manifest. | `test_citation_deterministic_projection.py` | mcp/tests/test-evidence-lanes.toml:223-223 |
