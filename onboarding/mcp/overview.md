...
| Finding | Anchor | Source |
| --- | --- | --- |
| A ledger view is derived from Git and cache write failure is only an availability result. | `derive_memory_ledger`; `refresh_memory_cache` | mcp/src/agents_remember/kernel/memory_cache.py:22-41; mcp/src/agents_remember/kernel/memory_cache.py:65-91 |
