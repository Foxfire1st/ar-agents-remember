...
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/bootstrap-state-template.md` |
...
| Finding                                                                                  | Citations | Source Path                                                                                  |
| ---------------------------------------------------------------------------------------- | --------- | -------------------------------------------------------------------------------------------- |
| The state template records bootstrap mode, memory root, onboarding root, branch, topology, source inventory status, and phase status across the full C-03 lifecycle. | L1-L31    | [bootstrap-state-template.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/bootstrap-state-template.md) |
...
| C-03 requires every bootstrap to maintain `bootstrap/STATE.md` from this template. | L411-L438 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/SKILL.md) |
