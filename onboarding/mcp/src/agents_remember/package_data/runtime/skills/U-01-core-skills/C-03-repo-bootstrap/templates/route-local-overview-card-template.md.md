...
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/route-local-overview-card-template.md` |
...
| Finding                                                                                         | Citations | Source Path                                                                                              |
| ----------------------------------------------------------------------------------------------- | --------- | -------------------------------------------------------------------------------------------------------- |
| The overview card template records route metadata, governed paths, required explanation topics, inputs, links, and open questions. | L1-L61    | [route-local-overview-card-template.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/route-local-overview-card-template.md) |
| C-03 Phase 4C writes overview cards for each selected governing route before route-local overview waves. | L738-L762 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/SKILL.md) |
