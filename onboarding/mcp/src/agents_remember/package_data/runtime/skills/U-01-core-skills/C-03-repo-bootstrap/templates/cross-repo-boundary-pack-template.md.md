...
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/cross-repo-boundary-pack-template.md` |
...
| Finding                                                                                  | Citations | Source Path                                                                                               |
| ---------------------------------------------------------------------------------------- | --------- | --------------------------------------------------------------------------------------------------------- |
| The boundary pack records allowed adjacent repos, boundary summaries, confirmed interfaces, and shared contracts. | L1-L31    | [cross-repo-boundary-pack-template.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/cross-repo-boundary-pack-template.md) |
...
| C-03 Phase 4F writes boundary packs for priority routes with inbound or outbound cross-repo signals. | L837-L859 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/SKILL.md) |
