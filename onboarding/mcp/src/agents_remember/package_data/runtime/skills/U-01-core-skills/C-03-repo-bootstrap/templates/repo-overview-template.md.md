...
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/repo-overview-template.md` |
...
The root overview is the minimum successful bootstrap output and should stay high-signal. Its `## Hot Path Summary` gives C-04 and the route-index generator a compact discovery summary. Detailed local routing moves into route-local overviews once they exist. Its `sourceRoute` is `<repo-root>`, and `lastVerifiedCommitHash` plus `lastVerifiedCommitDate` describe the source commit C-02 should compare against for repo-wide overview drift.
...
| Finding                                                                                       | Citations | Source Path                                                                            |
| --------------------------------------------------------------------------------------------- | --------- | -------------------------------------------------------------------------------------- |
| The repo overview template defines metadata, route-based verification fields, repo purpose, hot-path summary, architecture, code structure, functional areas, cross-repo references, build/dev commands, invariants, glossary, docs references, next work, verification needs, and update history. | L1-L83    | [repo-overview-template.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/repo-overview-template.md) |
| C-03 treats the root repo overview as the minimum successful bootstrap output. | L8-L14 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/SKILL.md) |
| C-03 Phase 3 synthesizes the root repo overview from state, input ledger, scout report, area briefs, and existing overview when present. | L604-L651 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/SKILL.md) |
