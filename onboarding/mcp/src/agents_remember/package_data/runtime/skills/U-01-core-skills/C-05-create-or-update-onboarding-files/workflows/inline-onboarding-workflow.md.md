...
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/workflows/inline-onboarding-workflow.md` |
