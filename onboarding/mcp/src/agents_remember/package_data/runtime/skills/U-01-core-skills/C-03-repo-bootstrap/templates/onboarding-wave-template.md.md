...
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/onboarding-wave-template.md` |
...
| Finding                                                                                       | Citations | Source Path                                                                               |
| --------------------------------------------------------------------------------------------- | --------- | ----------------------------------------------------------------------------------------- |
| The onboarding wave template records wave metadata, cards, deferred targets, evidence needs, worker instructions, assignments, done criteria, and review questions. | L1-L65    | [onboarding-wave-template.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/onboarding-wave-template.md) |
| C-03 Phase 4H writes onboarding wave manifests and gives each file worker a file card plus C-05 instructions. | L886-L916 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/SKILL.md) |
