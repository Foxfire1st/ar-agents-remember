...
| The managed invocation section routes through MCP `grepai_search` and `grepai_trace` so agents do not use global GrepAI state. | L14-L27 | [grepai-high-leverage-usage.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-04-retrieval-strategy-router/grepai-high-leverage-usage.md) |
| The command chooser maps semantic routing, compact API anchors, snippet search, project/path scoping, trace, status, and stats to GrepAI command patterns. | L29-L40 | [grepai-high-leverage-usage.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-04-retrieval-strategy-router/grepai-high-leverage-usage.md) |
...
| Trace, coverage, and practical rules explain when GrepAI trace is acceptable, how to check status, and how to keep result budgets small. | L131-L200 | [grepai-high-leverage-usage.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-04-retrieval-strategy-router/grepai-high-leverage-usage.md) |
| The C-04 skill links agents to this catalog from the Semantics section. | L75-L78 | [C-04 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-04-retrieval-strategy-router/SKILL.md) |
