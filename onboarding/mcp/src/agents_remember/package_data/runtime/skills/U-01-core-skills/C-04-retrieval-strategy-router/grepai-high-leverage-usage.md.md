...
| The managed invocation section routes through MCP `grepai_search` and `grepai_trace`, defaults examples to JSON, and says `repo_ids` must be MCP-configured repositories. | L14-L28 | [grepai-high-leverage-usage.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-04-retrieval-strategy-router/grepai-high-leverage-usage.md) |
