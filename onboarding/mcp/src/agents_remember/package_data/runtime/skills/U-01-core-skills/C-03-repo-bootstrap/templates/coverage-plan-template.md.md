...
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/coverage-plan-template.md` |
...
| Finding                                                                                           | Citations | Source Path                                                                               |
| ------------------------------------------------------------------------------------------------- | --------- | ----------------------------------------------------------------------------------------- |
| The coverage plan template captures strategy, area goals, route classification, file classification, and evidence pack queues. | L1-L36    | [coverage-plan-template.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/coverage-plan-template.md) |
| The template records deferred routes/files, slice cleanup decisions, developer review questions, and decisions for later waves. | L38-L65   | [coverage-plan-template.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/coverage-plan-template.md) |
| C-03 Phase 4A writes `bootstrap/coverage-plan.md` from this template and classifies deleted, moved, or stale onboarding routes when needed. | L735-L780 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/SKILL.md) |
