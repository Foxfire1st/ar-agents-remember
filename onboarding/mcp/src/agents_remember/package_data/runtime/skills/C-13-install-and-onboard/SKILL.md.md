...
| Finding | Citations | Source Path |
| --- | --- | --- |
| Stage 2/3 delegate memory init and bootstrap to these skills. | L88-L116 | [C-00 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/C-00-initialize-memory-repo/SKILL.md) |
| Existing-memory adoption is delegated to baseline adoption. | L97-L101 | [C-10 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/C-10-adopt-memory-baseline/SKILL.md) |
