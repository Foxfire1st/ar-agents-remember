...
| Finding                                                                                                                                                                                                                                    | Citations | Source Path                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- | ---------------------------------------------------------------------------------------------------- |
| The skill names task-start drift, pre-code-commit missing-onboarding checks, closeout `memory_quality_check`, and targeted style repair as one C-02 quality control workflow. | L27-L40 | [C-02 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/C-02-memory-quality-control/SKILL.md) |
...
| Pre-code-commit quality control runs `check_missing_onboarding` only against current worktree additions so newly added files cannot escape onboarding. | L147-L164 | [C-02 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/C-02-memory-quality-control/SKILL.md) |
| Closeout quality control runs MCP `memory_quality_check` and uses focused fixers such as `history_order_fix.py` only after reported findings. | L166-L191 | [C-02 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/C-02-memory-quality-control/SKILL.md) |
