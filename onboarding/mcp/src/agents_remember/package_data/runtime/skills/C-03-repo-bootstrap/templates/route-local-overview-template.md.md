...
| C-03 Phase 4D writes route-local overviews in mirrored source folders using this template. | L764-L812 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/C-03-repo-bootstrap/SKILL.md) |
