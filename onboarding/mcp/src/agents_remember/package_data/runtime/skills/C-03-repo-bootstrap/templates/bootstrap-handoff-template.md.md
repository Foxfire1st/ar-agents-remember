...
| C-03 Phase 5 writes `bootstrap/handoff.md` from this template and makes handoff the automated-bootstrap boundary before separate closeout. | L1031-L1057 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/C-03-repo-bootstrap/SKILL.md) |
