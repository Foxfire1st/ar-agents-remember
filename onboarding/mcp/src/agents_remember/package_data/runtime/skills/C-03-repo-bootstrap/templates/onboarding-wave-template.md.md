...
| C-03 Phase 4H writes onboarding wave manifests and gives each file worker a file card plus C-05 instructions. | L886-L916 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/C-03-repo-bootstrap/SKILL.md) |
