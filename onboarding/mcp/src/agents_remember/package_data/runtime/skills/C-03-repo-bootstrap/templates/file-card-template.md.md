...
| C-03 Phase 4G writes file cards for priority source files and requires them before file-level onboarding unless the repo is tiny. | L861-L884 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/C-03-repo-bootstrap/SKILL.md) |
| C-03 Phase 4H says each file worker receives one file card and follows C-05 for file-level onboarding. | L886-L916 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/C-03-repo-bootstrap/SKILL.md) |
