...
| C-03 requires source inventory review to be written to `bootstrap/input-ledger.md` using this template before automated execution starts. | L226-L254; L548-L564 | [C-03 SKILL.md](agents-remember-md/mcp/src/agents_remember/package_data/runtime/skills/C-03-repo-bootstrap/SKILL.md) |
