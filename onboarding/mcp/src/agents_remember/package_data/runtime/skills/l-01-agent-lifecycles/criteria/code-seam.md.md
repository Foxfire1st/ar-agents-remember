...
| The reviewer role binds `code-seam` at master-exit, super-exit, and applicable leaf full-loop reviews, and keeps the promotion ratchet as the catalog amendment path. | `code-seam`; `## Promotion Ratchet` | skills/l-01-agent-lifecycles/roles/reviewer.md:35-42; skills/l-01-agent-lifecycles/criteria/code-seam.md:93-103 |
