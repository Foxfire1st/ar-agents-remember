...
| Curator dispatch carries exact approved packets and per-revision reviewer adjudication. | "Curator onboarding handoff." | mcp/src/agents_remember/package_data/runtime/skills/l-01-agent-lifecycles/roles/manager.md:187-187 |
...
- 2026-09-14T19:00+02:00 — 260913-LCA-L12 curator (drift re-verification): the source moved since
  the recorded verification commit (the scheduling sentence now prefers plain fast-forward
  mechanics). Re-read the card: it makes no claim about replay or fast-forward vocabulary, and its
  cited headings and ranges still hold. No wording changed; verification metadata remains
  closeout-owned.
