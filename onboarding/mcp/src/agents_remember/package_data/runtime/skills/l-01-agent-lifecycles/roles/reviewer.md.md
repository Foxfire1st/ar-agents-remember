...
| No unfinished leaf work is hidden inside the handover packet. | "no unfinished leaf work is hidden"; "**no unfinished leaf work is hidden inside the packet**" | mcp/src/agents_remember/package_data/runtime/skills/l-01-agent-lifecycles/roles/reviewer.md:102-109; .agents/skills/l-01-agent-lifecycles/roles/reviewer.md:108-109 |
...
| Reviewer duties include writing the verdict artifact and returning a baseline block as decomposable fix leaves. | "The verdict artifact"; "decomposable fix leaves" | skills/l-01-agent-lifecycles/roles/reviewer.md:83-93; skills/l-01-agent-lifecycles/roles/reviewer.md:119-122 |
| Reviewer communications use `message_parent` for missing context or structural routing problems without carrying the parent's runtime identity. | `message_parent` | mcp/src/agents_remember/package_data/runtime/skills/l-01-agent-lifecycles/roles/reviewer.md:130-130 |
