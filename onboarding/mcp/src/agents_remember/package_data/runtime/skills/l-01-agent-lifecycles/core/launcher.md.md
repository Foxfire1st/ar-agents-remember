...
| The manifest declares the launcher entry under the ambient-launcher routing condition whose instruction source is this file. | `routing_condition` | skills/l-01-agent-lifecycles/composition-manifest.json:503-503 |
