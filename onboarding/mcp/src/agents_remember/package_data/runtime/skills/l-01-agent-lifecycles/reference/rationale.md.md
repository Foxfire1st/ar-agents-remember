...
| The assembly order with no reference plane in it, which is the manifest half of the cannot-affect-a-capsule property. | "composition_order" | skills/l-01-agent-lifecycles/composition-manifest.json:544-544 |
