# P-01 implementation planning SKILL.md

| Field                  | Value                                      |
| ---------------------- | ------------------------------------------ |
| repository             | agents-remember-md                         |
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/W-01-heavy-task-workflow/skills/P-04-planning/P-01-implementation-planning/SKILL.md` |
...
This phase-local skill writes or revises the W-01 implementation plan.

## Notes

Planning remains scheduling-only and should consume approved requirements, architecture, output docs, and source evidence without reopening design silently.
