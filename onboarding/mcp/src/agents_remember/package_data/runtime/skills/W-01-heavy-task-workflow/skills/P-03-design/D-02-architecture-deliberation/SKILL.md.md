# D-02 architecture deliberation SKILL.md

| Field                  | Value                                      |
| ---------------------- | ------------------------------------------ |
| repository             | agents-remember-md                         |
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/W-01-heavy-task-workflow/skills/P-03-design/D-02-architecture-deliberation/SKILL.md` |
...
This phase-local skill drives architecture deliberation during W-01 design.

## Notes

It asks architecture-facing questions one by one and records developer answers for projection into target-state documentation.
