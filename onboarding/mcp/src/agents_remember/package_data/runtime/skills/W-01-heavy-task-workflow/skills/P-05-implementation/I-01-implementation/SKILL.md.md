# I-01 implementation SKILL.md

| Field                  | Value                                      |
| ---------------------- | ------------------------------------------ |
| repository             | agents-remember-md                         |
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/W-01-heavy-task-workflow/skills/P-05-implementation/I-01-implementation/SKILL.md` |
...
This phase-local skill executes the approved W-01 implementation plan.

## Notes

It runs from the first unchecked implementation step through completion while recording issues without silently reopening design.
