# S-02 architecture question framing SKILL.md

| Field                  | Value                                      |
| ---------------------- | ------------------------------------------ |
| repository             | agents-remember-md                         |
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/W-01-heavy-task-workflow/skills/P-02-synthesis/S-02-architecture-question-framing/SKILL.md` |
...
This phase-local skill frames architecture questions for W-01 synthesis.

## Notes

Changes here affect how research and requirement framing outputs become developer-facing architecture deliberation questions.
