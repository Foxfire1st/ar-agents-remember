# S-01 requirement question framing SKILL.md

| Field                  | Value                                      |
| ---------------------- | ------------------------------------------ |
| repository             | agents-remember-md                         |
| path                   | `mcp/src/agents_remember/package_data/runtime/skills/W-01-heavy-task-workflow/skills/P-02-synthesis/S-01-requirement-question-framing/SKILL.md` |
...
This phase-local skill frames requirement questions for W-01 synthesis.

## Notes

Changes here affect how research findings are converted into developer-facing requirement clarification questions.
