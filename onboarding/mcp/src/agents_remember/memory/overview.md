...
| --- | --- | --- |
| The merge orchestration: the ordered sequence, the one-lock policy, the conflict taxonomy and the engine-supplied conflict key. | `merge_knowledge_datasets`; `_TAXONOMY`; `_conflict_record`; `_freeze_merged` | mcp/src/agents_remember/memory/knowledge/merge.py:133-167; mcp/src/agents_remember/memory/knowledge/merge.py:718-723; mcp/src/agents_remember/memory/knowledge/merge.py:736-747; mcp/src/agents_remember/memory/knowledge/merge.py:808-845 |
