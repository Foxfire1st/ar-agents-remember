...
| The measurement the merge reports, and the merge's own third composition seam. | `MergeCoverage`; `merge_resolved_knowledge_datasets` | mcp/src/agents_remember/application/knowledge_merge.py:74-83; mcp/src/agents_remember/models/knowledge/merge.py:243-284 |
