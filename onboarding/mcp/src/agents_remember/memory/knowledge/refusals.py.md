...
| The refusal codes these factories must stay within, now including the batch codes and the seven this leaf added. | `KnowledgeRefusalCode` | mcp/src/agents_remember/models/knowledge/result.py:61-89 |
