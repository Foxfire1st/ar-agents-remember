...
| The connection contract re-exported here. | `BUSY_TIMEOUT_MILLISECONDS`; `immediate_transaction` | mcp/src/agents_remember/memory/knowledge/connection.py:26-26; mcp/src/agents_remember/memory/knowledge/connection.py:124-127 |
