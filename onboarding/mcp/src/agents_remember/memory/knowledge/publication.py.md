...
| The atomic replace whose directory fsync records the new name, not the bytes under it. | `atomic_replace`; `fsync_file` | mcp/src/agents_remember/kernel/atomic_write.py:78-92; mcp/src/agents_remember/kernel/atomic_write.py:129-140 |
...
## Update History
- 2026-09-18T19:52:24+02:00 — 260915-KS-L23 residue clearance, seat B (uncommitted change set on `ar/260915-ks-l23`, memory base `59eab7a0`): **cleared the one enforced `citation_anchor_absent_from_range` row in this document.** The atomic-replace row paired `fsync_file` with `atomic_write.py:95-105`, which is inside `atomic_replace`; `def fsync_file` now spans `129-140`, so that cell cites it. The `atomic_replace` cell at `78-92` and the claim are unchanged. No claim was re-worded, no anchor or range was dropped to silence a row, and no verification stamp advanced: the candidate is uncommitted and the governed closeout owns the real code and memory commits.
- 2026-09-17T07:33:51+00:00: Generated citation repair: "test_a_failed_replacement_leaves_the_prior_destination_byte_identical"; "test_a_publication_whose_readback_fails_reports_the_destination_it_actually_left"; "test_a_logical_no_op_retains_the_published_bytes" repointed to mcp/tests/test_knowledge_snapshot_publication.py:173-173; mcp/tests/test_knowledge_snapshot_publication.py:204-204; mcp/tests/test_knowledge_snapshot_publication.py:239-239. No content impact: mechanical anchor-range projection bound to citation source snapshot 3fa9290dfd218ae31f16951129eb57f6acdf1a92ecb95026b64d55227e9f1ad6; claim bytes unchanged; generated by ccr-r10@v1.

- 2026-09-17T03:31:11+02:00 — 260915-KS-L9 curator (re-scoped repair): re-pointed `test_a_failed_replacement_leaves_the_prior_destination_byte_identical` in the row 150 of this card from mcp/tests/test_knowledge_snapshot_publication.py:204-206 to mcp/tests/test_knowledge_snapshot_publication.py:173, the extent of the construct the claim is about (the checker named line(s) [173] as its live location); re-pointed `test_a_publication_whose_readback_fails_reports_the_destination_it_actually_left` in the row 150 of this card from mcp/tests/test_knowledge_snapshot_publication.py:173 to mcp/tests/test_knowledge_snapshot_publication.py:204, the extent of the construct the claim is about (the checker named line(s) [204] as its live location)
- 2026-09-17T03:31:11+02:00 — 260915-KS-L9 curator (re-scoped repair): re-pointed `test_a_failed_replacement_leaves_the_prior_destination_byte_identical` in the row 150 of this card from mcp/tests/test_knowledge_snapshot_publication.py:239-240 to mcp/tests/test_knowledge_snapshot_publication.py:173-175, the extent of the construct the claim is about (the checker named line(s) [173] as its live location); re-pointed `test_a_publication_whose_readback_fails_reports_the_destination_it_actually_left` in the row 150 of this card from mcp/tests/test_knowledge_snapshot_publication.py:173-175 to mcp/tests/test_knowledge_snapshot_publication.py:204-206, the extent of the construct the claim is about (the checker named line(s) [204] as its live location)
- 2026-09-17T03:31:11+02:00 — 260915-KS-L9 curator (re-scoped repair): re-pointed `test_a_failed_replacement_leaves_the_prior_destination_byte_identical` in the row 150 of this card from mcp/tests/test_knowledge_snapshot_publication.py:204-206 to mcp/tests/test_knowledge_snapshot_publication.py:173-175, the extent of the construct the claim is about (the checker named line(s) [173] as its live location); re-pointed `test_a_logical_no_op_retains_the_published_bytes` in the row 150 of this card from mcp/tests/test_knowledge_snapshot_publication.py:173-175 to mcp/tests/test_knowledge_snapshot_publication.py:239-240, the extent of the construct the claim is about (the checker named line(s) [239] as its live location)
- 2026-09-17T03:31:11+02:00 — 260915-KS-L9 curator (re-scoped repair): kept one copy of the repeated citation mcp/tests/test_knowledge_snapshot_publication.py:239-240 in the row 150 of this card; the repetition added no pooled evidence
