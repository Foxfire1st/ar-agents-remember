...
| The governing-route reference check, with the ungoverned state never refused. | `_require_governing_route`; "def route_exists(" | mcp/src/agents_remember/memory/knowledge/facets.py:874-887; mcp/src/agents_remember/memory/knowledge/routes.py:242-242 |
