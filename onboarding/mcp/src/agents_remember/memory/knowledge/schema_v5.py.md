...
| **The composition that puts generation 5's table after generation 4's twenty-one and asserts the prefix equality.** | `_compose_generation_5`; `GENERATION_5` | mcp/src/agents_remember/memory/knowledge/schema_generations.py:357-357; mcp/src/agents_remember/memory/knowledge/schema_generations.py:321-321 |
| The schema name and version generation 5 declares, and its place in the registry. | `GENERATION_5_SCHEMA_NAME` | mcp/src/agents_remember/memory/knowledge/schema_generations.py:199-199 |
