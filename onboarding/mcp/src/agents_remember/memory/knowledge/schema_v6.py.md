...
| The created store's own schema name, so a created dataset declares `ar-knowledge-sqlite/v6`. | `GENERATION_6_SCHEMA_NAME` | mcp/src/agents_remember/memory/knowledge/schema_generations.py:213-213 |
