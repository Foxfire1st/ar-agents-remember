...
| The registry whose last entry is the newest supported generation, and the created generation it names. | `GENERATIONS`; `CURRENT_GENERATION` | mcp/src/agents_remember/memory/knowledge/schema_generations.py:365-372; mcp/src/agents_remember/memory/knowledge/schema_generations.py:385-395; mcp/src/agents_remember/memory/knowledge/schema_generations.py:395-416 |
| The created store's own schema name, so a created dataset declares `ar-knowledge-sqlite/v6`. | `GENERATION_6_SCHEMA_NAME` | mcp/src/agents_remember/memory/knowledge/schema_generations.py:207-207 |
