...
| The one envelope seam this write path validates through, and the registry its decision reads. | `validate_record_payload`; `PAYLOAD_MODELS` | mcp/src/agents_remember/memory/knowledge/record_envelope.py:145-190; mcp/src/agents_remember/memory/knowledge/record_envelope.py:96-115 |
