...
| The batch command that composes the claim insert and reports its two written rows. | `_add_claim` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:608-631 |
