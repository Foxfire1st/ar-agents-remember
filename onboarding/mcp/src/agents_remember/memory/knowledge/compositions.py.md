...
| The case that proves the context is bound to the exact revision and a successor appends without rewriting the guarantee. | "test_a_context_is_bound_to_the_exact_revision_and_a_successor_appends" | mcp/tests/test_knowledge_family_composition.py:759-759 |
