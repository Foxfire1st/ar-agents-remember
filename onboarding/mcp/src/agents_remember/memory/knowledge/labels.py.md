...
| The request models, each naming the row the caller read. | `SetInvariantLabelRequest`; `SetFamilyLabelRequest` | mcp/src/agents_remember/models/knowledge/result.py:341-352; mcp/src/agents_remember/models/knowledge/result.py:363-363; mcp/src/agents_remember/models/knowledge/result.py:362-362 |
