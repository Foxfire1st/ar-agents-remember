...
| The two halves of the base comparison: the sealed revision rows and the predecessor edges in their separate table. | `_first_revision_difference`; `_revision_rows`; `_first_missing_edge`; `_edge_set` | mcp/src/agents_remember/memory/knowledge/merge_validation.py:312-331; mcp/src/agents_remember/memory/knowledge/merge_validation.py:374-380; mcp/src/agents_remember/memory/knowledge/merge_validation.py:345-360; mcp/src/agents_remember/memory/knowledge/merge_validation.py:363-371 |
