...
| The attachment read, whose endpoint column is chosen from the declared vocabulary instead of being interpolated from caller text. | `ENDPOINT_COLUMNS`; `ATTACHMENTS_OF_ENDPOINT` | mcp/src/agents_remember/memory/knowledge/view_source.py:104-117; mcp/src/agents_remember/models/knowledge/facet.py:296-305 |
