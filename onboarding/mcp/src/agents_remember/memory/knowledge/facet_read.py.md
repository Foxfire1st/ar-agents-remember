...
| **The case that holds the exact page, the empty-but-real selection and the incompleteness refusal.** | "test_a_facet_does_not_join_a_shipped_seed_and_the_facet_page_is_exact" | mcp/tests/test_knowledge_facets.py:1246-1246 |
