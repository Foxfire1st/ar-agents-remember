...
| The boundary case that proves a rewritten document leaves the binding stale and never re-bound. | `test_a_rewritten_document_leaves_the_binding_stale_and_never_re_bound` | mcp/tests/test_knowledge_citation_boundaries.py:275-333 |
