...
| The requirement family this registry gained, its own declaration of the pair, and the payload model the pair resolves to. | `RequirementRevisionPayload`; `REQUIREMENT_REVISION_KIND` | mcp/src/agents_remember/models/knowledge/requirement.py:172-211; mcp/src/agents_remember/models/knowledge/requirement.py:83-83 |
