...
| The canonical encoder and the atomic publisher this module writes through. | `canonical_json_bytes`; `atomic_write_bytes` | mcp/src/agents_remember/kernel/canonical_json.py:16-25; mcp/src/agents_remember/kernel/atomic_write.py:51-70 |
