...
| The schema preflight and logical-identity readers this step reuses. | `require_supported_structure`; `dataset_identity` | mcp/src/agents_remember/memory/knowledge/merge_schema.py:121-139; mcp/src/agents_remember/memory/knowledge/logical.py:118-138 |
| The node that drives every base and input defect, including the criss-cross history. | "test_disjoint_edits_from_both_sides_survive_in_a_closed_published_candidate" | mcp/tests/test_knowledge_guarded_merge.py:392-486 |
