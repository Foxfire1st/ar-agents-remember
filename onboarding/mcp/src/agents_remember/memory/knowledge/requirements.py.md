...
|**The one-payload-seam entry point this record group calls, with its three refusal paths and one code.**|`validate_record_payload`| mcp/src/agents_remember/memory/knowledge/record_envelope.py:144-190 |
