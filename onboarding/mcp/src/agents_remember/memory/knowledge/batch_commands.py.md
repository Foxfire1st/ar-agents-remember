...
| Finding | Anchor | Source |
| --- | --- | --- |
| The apply loop, the observed failure position and the deferred-foreign-key check at the end of a completed pass. | `apply_commands` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:177-202 |
| The outcome object that carries what the loop observed. | `BatchApplication`; `observed_failure` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:137-155; mcp/src/agents_remember/memory/knowledge/batch_commands.py:156-166; mcp/src/agents_remember/memory/knowledge/batch_commands.py:178-183 |
| The ledger that produces the receipt and registers batch-created identities. | `BatchLedger`; "def written("; `removed` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:124-154 |
| The six-family dispatch table an apply step chooses between, keyed on the vocabulary's own kind sets. | `_APPLY_FAMILIES` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:543-550 |
| The inserting command kinds the dispatch admits. | `_INSERTING_KINDS` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:365-375 |
| The labelling command kinds the dispatch admits, which is a different set from the inserting ones. | `_LABELING_KINDS` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:387-387 |
| The unreachable-kind defect: a command that reaches the dispatch and belongs to no family is refused rather than silently skipped. | `_refuse_unreachable` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:600-609 |
| The two receipt entries a claim that records its own anchor produces. | `_add_claim`; `_anchor_digest` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:608-632; mcp/src/agents_remember/memory/knowledge/batch_commands.py:633-651; mcp/src/agents_remember/memory/knowledge/batch_commands.py:762-763; mcp/src/agents_remember/memory/knowledge/batch_commands.py:787-798 |
| The removal steps, each reporting the digest the row had when it was deleted. | `_remove_anchor`; `_remove_member`; `_remove_claim` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:686-703; mcp/src/agents_remember/memory/knowledge/batch_commands.py:704-712; mcp/src/agents_remember/memory/knowledge/batch_commands.py:713-736; mcp/src/agents_remember/memory/knowledge/batch_commands.py:840-841; mcp/src/agents_remember/memory/knowledge/batch_commands.py:858-859; mcp/src/agents_remember/memory/knowledge/batch_commands.py:867-868 |
| The outcome object that carries what the loop observed. | `BatchApplication`; `observed_failure` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:157-183 |
| The ledger that produces the receipt and registers batch-created identities. | `BatchLedger`; "def written("; `removed` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:115-145 |
| The six-family dispatch and the unreachable-kind defect. | `_apply_command`; `_INSERTING_KINDS`; `_LABELING_KINDS`; `_refuse_unreachable` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:298-309; mcp/src/agents_remember/memory/knowledge/batch_commands.py:365-375; mcp/src/agents_remember/memory/knowledge/batch_commands.py:377-377; mcp/src/agents_remember/memory/knowledge/batch_commands.py:600-609; mcp/src/agents_remember/memory/knowledge/batch_commands.py:387-387 |
| The two receipt entries a claim that records its own anchor produces. | `_add_claim`; `_anchor_digest` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:438-481; mcp/src/agents_remember/memory/knowledge/batch_commands.py:483-651; mcp/src/agents_remember/memory/knowledge/batch_commands.py:787-798 |
| The removal steps, each reporting the digest the row had when it was deleted. | `_remove_anchor`; `_remove_member`; `_remove_claim` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:483-551; mcp/src/agents_remember/memory/knowledge/batch_commands.py:485-560; mcp/src/agents_remember/memory/knowledge/batch_commands.py:563-586; mcp/src/agents_remember/memory/knowledge/batch_commands.py:840-841; mcp/src/agents_remember/memory/knowledge/batch_commands.py:858-859; mcp/src/agents_remember/memory/knowledge/batch_commands.py:867-868 |
| The no-op label edit that contributes no receipt entry. | `_apply_label`; `_set_invariant_label`; `_set_family_label` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:572-583; mcp/src/agents_remember/memory/knowledge/batch_commands.py:779-797; mcp/src/agents_remember/memory/knowledge/batch_commands.py:800-815; mcp/src/agents_remember/memory/knowledge/batch_commands.py:594-605; mcp/src/agents_remember/memory/knowledge/batch_commands.py:822-823 |
| The after-integrity re-proof the apply step runs last: foreign keys, every revision seal, both lineage graphs — and, since this leaf, the authored-effect seals and the change-set succession graph. | `require_after_integrity` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:881-902 |
| The seal half of the re-proof. | `_require_sealed_rows` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:905-916 |
| **The graph half of the re-proof, and the composition pass this leaf added to it.** | `_require_acyclic_graph` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:1100-1113 |
