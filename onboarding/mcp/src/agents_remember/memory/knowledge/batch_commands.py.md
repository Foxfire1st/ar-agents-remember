...
| The outcome object that carries what the loop observed. | `BatchApplication`; `observed_failure` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:164-190; mcp/src/agents_remember/memory/knowledge/batch_commands.py:204-209 |
...
| **The dispatch table an apply step chooses between, keyed on the vocabulary's own kind sets — now seven family rows, the census group's `CENSUS_COMMAND_KINDS` row being this leaf's addition and the last.** | `_APPLY_FAMILIES` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:596-604 |
| The inserting command kinds the dispatch admits. | `_INSERTING_KINDS` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:428-438 |
| The labelling command kinds the dispatch admits, which is a different set from the inserting ones. | `_LABELING_KINDS` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:440-440 |
...
| The two receipt entries a claim that records its own anchor produces. | `_add_claim`; `_anchor_digest` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:818-840; mcp/src/agents_remember/memory/knowledge/batch_commands.py:843-854 |
| The removal steps, each reporting the digest the row had when it was deleted. | `_remove_anchor`; `_remove_member`; `_remove_claim` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:896-911; mcp/src/agents_remember/memory/knowledge/batch_commands.py:914-920; mcp/src/agents_remember/memory/knowledge/batch_commands.py:923-931 |
| The outcome object that carries what the loop observed. | `BatchApplication`; `observed_failure` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:164-190; mcp/src/agents_remember/memory/knowledge/batch_commands.py:204-209 |
| The ledger that produces the receipt and registers batch-created identities. | `BatchLedger`; "def written("; `removed` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:131-161 |
| **The seven-family dispatch and the unreachable-kind defect.** | `_apply_command`; `_INSERTING_KINDS`; `_LABELING_KINDS`; `_refuse_unreachable` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:336-347; mcp/src/agents_remember/memory/knowledge/batch_commands.py:428-438; mcp/src/agents_remember/memory/knowledge/batch_commands.py:440-440; mcp/src/agents_remember/memory/knowledge/batch_commands.py:654-663 |
| The two receipt entries a claim that records its own anchor produces. | `_add_claim`; `_anchor_digest` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:818-840; mcp/src/agents_remember/memory/knowledge/batch_commands.py:843-854 |
| The removal steps, each reporting the digest the row had when it was deleted. | `_remove_anchor`; `_remove_member`; `_remove_claim` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:896-911; mcp/src/agents_remember/memory/knowledge/batch_commands.py:914-920; mcp/src/agents_remember/memory/knowledge/batch_commands.py:923-931 |
| The no-op label edit that contributes no receipt entry. | `_apply_label`; `_set_invariant_label`; `_set_family_label` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:648-659; mcp/src/agents_remember/memory/knowledge/batch_commands.py:833-851; mcp/src/agents_remember/memory/knowledge/batch_commands.py:878-893 |
| The after-integrity re-proof the apply step runs last: foreign keys, every revision seal, both lineage graphs — and, since this leaf, the authored-effect seals and the change-set succession graph. | `require_after_integrity` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:937-958 |
| The seal half of the re-proof. | `_require_sealed_rows` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:961-972 |
| **The graph half of the re-proof, and the composition pass this leaf added to it.** | `_require_acyclic_graph` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:1156-1169 |
| **The census record group's dispatch family — the seventh row of the dispatch table, handed no `pending` set and delegating to the group's own in-transaction step.** | `_apply_family_census` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:350-371 |
...
| The store's two batch-facing primitives, which the apply step calls instead of a nested operation. | `insert_invariant_identity`; `insert_revision_aggregate` | mcp/src/agents_remember/memory/knowledge/store.py:332-349; mcp/src/agents_remember/memory/knowledge/store.py:351-361 |
...
## Update History
- 2026-09-20T11:53:49+00:00: Generated citation repair: `insert_invariant_identity`; `insert_revision_aggregate` repointed to mcp/src/agents_remember/memory/knowledge/store.py:332-349; mcp/src/agents_remember/memory/knowledge/store.py:351-361. No content impact: mechanical anchor-range projection bound to citation source snapshot 0849f052762b22876ef5b9a278767e8b11854dff23a8149d48010a306f68021a; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-20T01:29+02:00 — 260915-KS-L30 curator (uncommitted change set on `ar/260915-ks-l30-ar`, base `7dcec036094768c5f50e571fb45e59a27ae78efc`): **cleared this card's two enforced citation rows — one stale range each, both on the removal-steps row.** The row names three removal steps and cited `:872-887` for `_remove_anchor`, which is declared at 896; its own declaration extent is `:896-911` (the helper opens at 896, refuses a missing row through `batch_command_refusal`, and returns `_written_entry("removed", "source_anchor", ...)` at 911). That range was repointed to `:896-911` in both rows; the sibling ranges `:914-920` (`_remove_member`) and `:923-931` (`_remove_claim`) were already live and are unchanged, as are the Finding text, the anchors and every other row. No citation was dropped and no range was deleted. The checklist reported this row twice because the document carries the row twice — verbatim duplicates of one another; they are separate claims to the checker, so each was billed separately and each is cleared by the same repoint. The duplicate itself is left exactly as it stands: removing a row is outside this pass, and both copies now carry the same correct citation. No verification stamp was advanced.
- 2026-09-20T01:00+02:00 — 260915-KS citation residue clearance (uncommitted change set on memory base `66b2ae8adebea11bc2300d2d51822f321a128657`): cleared the 15 enforced citation rows this card carried (citation_anchor_absent_from_range): every flagged range was hand-read against mcp/src/agents_remember/memory/knowledge/batch_commands.py and already held the anchor its claim names (`_INSERTING_KINDS`, `_LABELING_KINDS`, `_add_claim`, `_anchor_digest`, `_apply_command`, `_apply_label`, `_remove_claim`, `_remove_member`, `_set_family_label`, `observed_failure`), so no range was changed; every claim wording, anchor and every other range is unchanged, and no verification stamp was advanced.
- 2026-09-20T00:31+02:00 — 260915-KS-L30 curator (uncommitted change set on `ar/260915-ks-l30-ar`, base `7dcec036094768c5f50e571fb45e59a27ae78efc`): **mechanical citation-range projection** against this leaf's candidate. The checklist reported 15 row(s) whose cited range no longer holds its anchor although the construct is present in the cited file; each range was widened to the lines that carry it — `_INSERTING_KINDS`; `_LABELING_KINDS`; `_add_claim`; `_anchor_digest`; `_apply_command`; `_apply_label`; `_remove_claim`; `_remove_member`; `_set_family_label`; `observed_failure`. No claim wording, anchor or citation was added, removed or re-worded, and no range was deleted: the new range is the checklist's own resolved extent for that anchor on this candidate. No verification stamp was advanced.
- 2026-09-19T22:28:52+00:00: Generated citation repair: `_APPLY_FAMILIES` repointed to mcp/src/agents_remember/memory/knowledge/batch_commands.py:596-604. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:28:52+00:00: Generated citation repair: `_INSERTING_KINDS` repointed to mcp/src/agents_remember/memory/knowledge/batch_commands.py:428-438. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:28:52+00:00: Generated citation repair: `_LABELING_KINDS` repointed to mcp/src/agents_remember/memory/knowledge/batch_commands.py:440-440. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:28:52+00:00: Generated citation repair: `require_after_integrity` repointed to mcp/src/agents_remember/memory/knowledge/batch_commands.py:937-958. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:28:52+00:00: Generated citation repair: `_require_sealed_rows` repointed to mcp/src/agents_remember/memory/knowledge/batch_commands.py:961-972. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:28:52+00:00: Generated citation repair: `_require_acyclic_graph` repointed to mcp/src/agents_remember/memory/knowledge/batch_commands.py:1156-1169. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:28:52+00:00: Generated citation repair: `_apply_family_census` repointed to mcp/src/agents_remember/memory/knowledge/batch_commands.py:350-371. No content impact: mechanical anchor-range projection bound to citation source snapshot 440311ed835ff15c77271ad85c2bef2103d2b46ebe061b96476b211b3d19cd24; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-19T22:33+02:00 — 260918-TSIP-L11 curator (memory worktree `fd1a024e`, code `7879f5b2`): cleared the inherited citation debt on 8 claim(s) by RE-READING each claim against the merged tree and RE-DERIVING every cited range from the construct's real extent in the file the claim cites (`extents.anchor_extents`), never by adding a delta to an old number and never through the mechanical projection (no generated citation-repair bullet is written, so no claim is reopened by this edit). Claims re-read: `batch_commands.py.md:136` (`BatchApplication`, `observed_failure`); `batch_commands.py.md:142` (`_add_claim`, `_anchor_digest`); `batch_commands.py.md:143` (`_remove_anchor`, `_remove_member`, `_remove_claim`); `batch_commands.py.md:144` (`BatchApplication`, `observed_failure`); `batch_commands.py.md:146` (`_apply_command`, `_INSERTING_KINDS`, `_LABELING_KINDS`, `_refuse_unreachable`); `batch_commands.py.md:147` (`_add_claim`, `_anchor_digest`); `batch_commands.py.md:148` (`_remove_anchor`, `_remove_member`, `_remove_claim`); `batch_commands.py.md:149` (`_apply_label`, `_set_invariant_label`, `_set_family_label`).
