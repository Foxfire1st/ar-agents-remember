...
| The three-family dispatch an apply step chooses between. | `_apply_command` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:210-212 |
| The inserting command kinds the dispatch admits. | `_INSERTING_KINDS` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:227-250 |
| The labelling command kinds the dispatch admits, which is a different set from the inserting ones. | `_LABELING_KINDS` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:262-285 |
| The unreachable-kind defect: a command that reaches the dispatch and belongs to no family is refused rather than silently skipped. | `_refuse_unreachable` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:468-474 |
| The two receipt entries a claim that records its own anchor produces. | `_add_claim`; `_anchor_digest` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:608-632; mcp/src/agents_remember/memory/knowledge/batch_commands.py:633-651 |
| The removal steps, each reporting the digest the row had when it was deleted. | `_remove_anchor`; `_remove_member`; `_remove_claim` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:686-703; mcp/src/agents_remember/memory/knowledge/batch_commands.py:704-712; mcp/src/agents_remember/memory/knowledge/batch_commands.py:713-736 |
| The outcome object that carries what the loop observed. | `BatchApplication`; `observed_failure` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:118-159 |
| The ledger that produces the receipt and registers batch-created identities. | `BatchLedger`; "def written("; `removed` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:89-123 |
| The three-family dispatch and the unreachable-kind defect. | `_apply_command`; `_INSERTING_KINDS`; `_LABELING_KINDS`; `_refuse_unreachable` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:192-229; mcp/src/agents_remember/memory/knowledge/batch_commands.py:289-306 |
| The two receipt entries a claim that records its own anchor produces. | `_add_claim`; `_anchor_digest` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:438-481; mcp/src/agents_remember/memory/knowledge/batch_commands.py:483-651 |
| The removal steps, each reporting the digest the row had when it was deleted. | `_remove_anchor`; `_remove_member`; `_remove_claim` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:483-551; mcp/src/agents_remember/memory/knowledge/batch_commands.py:485-560; mcp/src/agents_remember/memory/knowledge/batch_commands.py:563-586 |
...
| The after-integrity re-proof the apply step runs last: foreign keys, every revision seal, both lineage graphs. | `require_after_integrity` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:727-750 |
| The seal half of the re-proof. | `_require_sealed_rows` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:749-764 |
| **The graph half of the re-proof, and the composition pass this leaf added to it.** | `_require_acyclic_graph` | mcp/src/agents_remember/memory/knowledge/batch_commands.py:881-913 |
