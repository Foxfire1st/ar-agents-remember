...
| The family-revision endpoint check. | `require_family_revision_endpoint` | mcp/src/agents_remember/memory/knowledge/endpoints.py:48-62 |
| The invariant-revision endpoint check. | `require_invariant_revision_endpoint` | mcp/src/agents_remember/memory/knowledge/endpoints.py:65-79 |
