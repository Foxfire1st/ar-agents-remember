...
| The narrow ownership read that answers the family half. | `family_id_of_revision` | mcp/src/agents_remember/memory/knowledge/families.py:233-251 |
...
| The membership operation that calls both checks before its write. | `create_family_member` | mcp/src/agents_remember/memory/knowledge/memberships.py:59-80 |
