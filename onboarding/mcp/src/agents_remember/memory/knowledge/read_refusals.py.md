...
| **The six codes and the one operation this leaf added to the shared vocabulary.** | `KnowledgeRefusalCode`; `KnowledgeOperation` | mcp/src/agents_remember/models/knowledge/result.py:76-141; mcp/src/agents_remember/models/knowledge/result.py:36-72 |
