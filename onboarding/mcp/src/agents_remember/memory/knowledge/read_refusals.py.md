...
| **The node that measures a refused read of a real database leaving the file byte-identical.** | "test_a_refused_read_of_a_real_database_leaves_the_file_byte_identical" | mcp/tests/test_knowledge_read_boundaries.py:944-944 |
