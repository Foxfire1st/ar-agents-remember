# mcp/src/agents_remember/worktrees/integration_branch_repository.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/worktrees/integration_branch_repository.py` |
| doc_type | `file-level-onboarding` |
| lastUpdated | 2026-08-16T03:24+02:00 |
...
| --- | --- | --- |
| Canonical local-branch identity rejects ambiguous symbolic authority. | `canonical_local_branch` | mcp/src/agents_remember/worktrees/integration_branch_repository.py:10-39 |
| Code and external-memory default resolvers keep their authority sources distinct. | `repository_default_branch`, `memory_repository_default_branch` | mcp/src/agents_remember/worktrees/integration_branch_repository.py:42-83 |
| Linked-worktree enumeration reports exact canonical branch owners. | `branch_worktree_owners` | mcp/src/agents_remember/worktrees/integration_branch_repository.py:116-139 |
