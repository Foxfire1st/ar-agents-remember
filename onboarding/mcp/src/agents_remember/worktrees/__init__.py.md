# mcp/src/agents_remember/worktrees/__init__.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/worktrees/__init__.py` |
...
Marks the Python package described as “Git worktree and task-branch services”.
...
| --- | --- | --- |
| Package description | "Git worktree and task-branch services." | mcp/src/agents_remember/worktrees/__init__.py:1-1 |
