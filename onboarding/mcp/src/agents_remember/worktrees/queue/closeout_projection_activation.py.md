...
| Focused tests force source-alias failure into a typed projection problem. | `AtomicSeriesActivationTests` | mcp/tests/test_atomic_series_activation.py:96-137 |
