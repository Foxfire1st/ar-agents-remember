...
| --- | --- | --- |
| Invalid profile resolution produces typed admission failure before any Gate-1 command starts. | `_admitted_selection` | mcp/src/agents_remember/worktrees/modules/quality/gate.py:577-591 |
