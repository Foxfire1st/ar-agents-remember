...
| --- | --- | --- |
| The typed outcome carries external-memory refresh and commit results across normal and recovered closeout. | "class MemoryCloseoutOutcome:" | mcp/src/agents_remember/worktrees/queue/closeout_recovery.py:47-56 |
| Finalization recovery proves exact clean heads, the ledger mapping, and memory ancestry without replaying mutation. | `prove_closeout_recovery_commits` | mcp/src/agents_remember/worktrees/queue/closeout_recovery.py:59-74 |
| Code recovery receives typed intent, proves clean HEAD and the accepted tree, then journals the code cell. | `accepted_code_commit` | mcp/src/agents_remember/worktrees/queue/closeout_recovery.py:168-226 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The current module exposes `MemoryCloseoutOutcome`, `prove_closeout_recovery_commits`, `accepted_code_commit` at this ownership boundary. | "class MemoryCloseoutOutcome:"; "def prove_closeout_recovery_commits("; "def accepted_code_commit(" | mcp/src/agents_remember/worktrees/queue/closeout_recovery.py:48-56; mcp/src/agents_remember/worktrees/queue/closeout_recovery.py:59-74; mcp/src/agents_remember/worktrees/queue/closeout_recovery.py:168-226 |
