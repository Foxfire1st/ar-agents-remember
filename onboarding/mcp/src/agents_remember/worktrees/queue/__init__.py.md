...
| path | `mcp/src/agents_remember/worktrees/queue/__init__.py` |
...
| --- | --- | --- |
| The package marker docstring. | "Closeout-queue modules for task-derived sprint scheduling." | mcp/src/agents_remember/worktrees/queue/__init__.py:1-1 |
...
- 2026-08-21T00:45+02:00 — Created for 260815-DAG master full-gate repair: the `worktrees/queue`
