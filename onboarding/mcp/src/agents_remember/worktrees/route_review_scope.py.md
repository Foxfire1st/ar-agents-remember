...
| Integration publication calls the current master review inside authority. | `publish_series_integration_under_authority` | mcp/src/agents_remember/worktrees/series_closeout.py:62-85 |
