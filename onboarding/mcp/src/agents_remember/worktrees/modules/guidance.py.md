...
| lastUpdated            | 2026-09-08T17:36:08+02:00 |
...
| Three of the five `recovery_guidance` callers: the blocked memory, provider-setup and stale-base starts. | "choose_memory_recovery"; "choose_provider_setup_recovery"; "choose_stale_base_recovery" | mcp/src/agents_remember/worktrees/modules/start.py:219-219; mcp/src/agents_remember/worktrees/modules/start.py:273-273; mcp/src/agents_remember/worktrees/modules/start.py:413-413 |
| The fourth: the closeout preview's `request_commit_approval` gate. | `request_commit_approval` | mcp/src/agents_remember/worktrees/modules/closeout.py:351-351 |
