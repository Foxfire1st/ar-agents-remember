...
| Freshness, consumer paths, identity fields, and interactive/projected observation. | `base_freshness`; `WorktreeStatusFacts` | mcp/src/agents_remember/worktrees/modules/guidance.py:378-428; mcp/src/agents_remember/worktrees/modules/guidance.py:83-121 |
