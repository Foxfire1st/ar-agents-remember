...
cit:([`_integrated_result`], mcp/src/agents_remember/worktrees/modules/integrate.py:373-408), the local
checkpoint result cit:([`_checkpoint_result`], mcp/src/agents_remember/worktrees/modules/integrate.py:674-714),
...
| The local final route calls this writer instead of amending the contract inline. | `_integrated_result` | mcp/src/agents_remember/worktrees/modules/integrate.py:373-408 |
| The local checkpoint route calls the same writer with `checkpoint=True`. | `_checkpoint_result` | mcp/src/agents_remember/worktrees/modules/integrate.py:674-714 |
