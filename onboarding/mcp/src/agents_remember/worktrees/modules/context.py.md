...
| Closeout preview resolves candidate-rooted context for route-index and sidecar classification. | "def _memory_refresh_preview(" | mcp/src/agents_remember/worktrees/modules/closeout.py:181-181 |
