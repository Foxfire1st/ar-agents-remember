...
| The external-memory phase resolves that contract context before refreshing onboarding and running post-refresh quality. | "def _refresh_external_memory(" | mcp/src/agents_remember/worktrees/modules/closeout_external.py:121-121 |
