...
| Closeout preview resolves candidate-rooted context for route-index and sidecar classification. | "def _memory_refresh_preview(" | mcp/src/agents_remember/worktrees/modules/closeout.py:171-171 |
| Closeout replaces the resolved context's code root with the task worktree. | "def _closeout_contract_context(" | mcp/src/agents_remember/worktrees/modules/closeout.py:700-700 |
