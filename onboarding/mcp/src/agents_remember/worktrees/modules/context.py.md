...
| Closeout replaces the resolved context's code root with the task worktree. | "def _closeout_contract_context(" | mcp/src/agents_remember/worktrees/modules/closeout.py:671-671 |
| The external-memory phase resolves that contract context before refreshing onboarding and running post-refresh quality. | "def _refresh_external_memory(" | mcp/src/agents_remember/worktrees/modules/closeout_external.py:108-108 |
