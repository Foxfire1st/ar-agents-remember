...
| Closeout replaces the resolved context's code root with the task worktree. | "def _closeout_contract_context(" | mcp/src/agents_remember/worktrees/modules/closeout.py:969-971 |
