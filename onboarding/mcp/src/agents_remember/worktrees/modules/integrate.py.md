...
- **The ledger projection is now proved on both surfaces.** `_require_ledger_projection(...)`
  ...
  cit:([`_route_commits`], mcp/src/agents_remember/worktrees/modules/integrate.py:527-539) selects. Before this the
