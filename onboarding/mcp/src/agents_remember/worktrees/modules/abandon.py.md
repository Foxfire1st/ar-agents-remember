...
| Finding | Anchor | Source |
| --- | --- | --- |
| Abandon passes its dry-run flag into terminal result validation. | `_abandon_terminal_outputs` | mcp/src/agents_remember/worktrees/modules/abandon.py:384-445 |
