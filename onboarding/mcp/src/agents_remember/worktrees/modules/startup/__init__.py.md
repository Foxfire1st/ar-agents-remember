...
| --- | --- | --- |
| The package docstring names start contract, provider, leaf-ref, and result collaborators. | L1 | `mcp/src/agents_remember/worktrees/modules/startup/__init__.py` |
