...
cit:(["def status_payload", "landing_refs(contract)"], mcp/src/agents_remember/worktrees/modules/guidance.py:465-465; mcp/src/agents_remember/worktrees/modules/guidance.py:467-467), and `observer/landing_state.LandingStateRefresher`, which holds it as
...
| --- | --- | --- |
| `status_payload` calls `landing_refs` and emits its result as the `landing` block. | `status_payload`; `_status_payload_with_landing` | mcp/src/agents_remember/worktrees/modules/guidance.py:403-455; mcp/src/agents_remember/worktrees/modules/guidance.py:465-467 |
