# mcp/src/agents_remember/worktrees/modules/quality/__init__.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/worktrees/modules/quality/__init__.py` |
...
Marks the Python package described as “Worktree quality execution, publication, and closeout policy”.
...
| --- | --- | --- |
| Package description | "Worktree quality execution, publication, and closeout policy." | mcp/src/agents_remember/worktrees/modules/quality/__init__.py:1-1 |
