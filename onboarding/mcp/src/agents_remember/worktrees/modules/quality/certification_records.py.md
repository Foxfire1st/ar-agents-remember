...
| Admission persistence preserves the stored admission provenance. | "def _persist_admission" | mcp/src/agents_remember/worktrees/modules/quality/certification_records.py:533-533 |
...
| Map a terminal gate catalog into typed rail results (payload-bound). | "def terminal_results" | mcp/src/agents_remember/worktrees/modules/quality/certification_terminal.py:172-172 |
| Memory rails are read through the bound certification-memory owner. | "def _bound_memory_rails" | mcp/src/agents_remember/worktrees/modules/quality/certification_records.py:447-466 |
