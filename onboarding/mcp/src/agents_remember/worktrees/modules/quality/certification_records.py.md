...
| Admission persistence preserves the stored admission provenance. | "def _persist_admission" | mcp/src/agents_remember/worktrees/modules/quality/certification_records.py:513-530 |
...
| Map a terminal gate catalog into typed rail results (payload-bound). | "def terminal_results" | mcp/src/agents_remember/worktrees/modules/quality/certification_terminal.py:112-167 |
