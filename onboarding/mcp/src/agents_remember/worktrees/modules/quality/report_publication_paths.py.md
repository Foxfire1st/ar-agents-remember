...
| The publisher supplies selected-certificate and prior-current protection before moving the pointer. | `_publish_reports` | mcp/src/agents_remember/worktrees/modules/quality/clean_executor.py:437-532 |
