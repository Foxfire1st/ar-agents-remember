...
| --- | --- | --- |
| The package overview describes the module split. | `# mcp/src/agents_remember/worktrees/modules Overview` | onboarding/mcp/src/agents_remember/worktrees/modules/overview.md:1-753 |
