...
| Gate delegation policy model. | `GatePolicy`; `DEFAULT_GATE_POLICY` | mcp/src/agents_remember/controlplane/gate_policy.py:51-61; mcp/src/agents_remember/controlplane/gate_policy.py:64-64 |
