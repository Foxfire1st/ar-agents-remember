...
| MCP cleanup enters the result-returning application owner without CLI parsing. | "def worktree_cleanup_tool" | mcp/src/agents_remember/application/worktree_tools.py:773-773 |
