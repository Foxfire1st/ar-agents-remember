# mcp/src/agents_remember/worktrees/organizational_completion.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/worktrees/organizational_completion.py` |
...
| --- | --- | --- |
| Exact final-leaf plan requires sibling code/memory/ledger proof and sprint integrationBranch. | `organizational_completion_plan` | mcp/src/agents_remember/worktrees/organizational_completion.py:87-144 |
| Scope validation pins executionNature, owning master, and canonical child. | `_completion_scope` | mcp/src/agents_remember/worktrees/organizational_completion.py:147-183 |
| Sibling code ancestry is re-proved against the sprint super. | `_require_landed_sibling` | mcp/src/agents_remember/worktrees/organizational_completion.py:307-343 |
| Sibling memory ancestry and unique ledger mapping are enforced. | `_require_landed_sibling_memory`, `_sibling_memory_mappings` | mcp/src/agents_remember/worktrees/organizational_completion.py:376-385; mcp/src/agents_remember/worktrees/organizational_completion.py:413-443 |
| Master completion is published only with the exact certified fingerprint. | `publish_organizational_master_completion` | mcp/src/agents_remember/worktrees/organizational_completion.py:229-264 |
