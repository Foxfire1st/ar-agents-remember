...
| Focused tests cover release-before-contract-deletion and paused-series preservation. | `AtomicSeriesActivationTests` | mcp/tests/test_atomic_series_activation.py:96-137 |
