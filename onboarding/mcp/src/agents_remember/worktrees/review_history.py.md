...
| Publication field validation, developer-permission parsing, and sealed baseline creation. | `_validate_publication_fields`; `_parse_developer_exception`; `_record_baseline` | mcp/src/agents_remember/worktrees/review_history.py:108-187 |
| Successor monotonicity and duplicate/blank-ID refusals. | `_record_successor`; `_require_unique_ids` | mcp/src/agents_remember/worktrees/review_history.py:189-227 |
