...
| Content-domain conflict and staged-resolution proof is delegated to the Git owner. | `content_conflicts`; `validate_staged_resolution` | mcp/src/agents_remember/worktrees/sync_transaction_git.py:286-293; mcp/src/agents_remember/worktrees/sync_transaction_git.py:456-474 |
