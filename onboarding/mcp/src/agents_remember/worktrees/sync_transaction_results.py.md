...
| Finding | Citations | Source Path |
| --- | --- | --- |
| Conflict ownership and parked-WIP versus merge result shapes. | L69-L111; L114-L141; L144-L168 | [mcp/src/agents_remember/worktrees/sync_transaction_results.py](mcp/src/agents_remember/worktrees/sync_transaction_results.py) |
| Policy choice and non-mutating initial/active/cancel previews. | L26-L48; L51-L66; L171-L185; L188-L205 | [mcp/src/agents_remember/worktrees/sync_transaction_results.py](mcp/src/agents_remember/worktrees/sync_transaction_results.py) |
| Terminal and no-authority replay results remain distinct. | L208-L243; L246-L259 | [mcp/src/agents_remember/worktrees/sync_transaction_results.py](mcp/src/agents_remember/worktrees/sync_transaction_results.py) |
| Content-domain conflict and staged-resolution proof is delegated to the Git owner. | L285-L292; L438-L456 | [mcp/src/agents_remember/worktrees/sync_transaction_git.py](mcp/src/agents_remember/worktrees/sync_transaction_git.py) |
