...
| --- | --- | --- |
| The module defines `integration_resolution_required` as its public seam. | `integration_resolution_required` | mcp/src/agents_remember/worktrees/integration/integration_resolution_handoff.py:14-107 |
