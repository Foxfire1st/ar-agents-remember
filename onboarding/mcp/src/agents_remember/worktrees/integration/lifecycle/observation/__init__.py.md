# mcp/src/agents_remember/worktrees/integration/lifecycle/observation/__init__.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/worktrees/integration/lifecycle/observation/__init__.py` |
...
Marks the Python package described as “Lifecycle journal observation services”.
...
| --- | --- | --- |
| Package description | "Lifecycle journal observation services." | mcp/src/agents_remember/worktrees/integration/lifecycle/observation/__init__.py:1-1 |
