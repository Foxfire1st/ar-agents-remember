...
| --- | --- | --- |
| The module defines `AdoptedLifecycleArtifact`; `LifecycleEnclosureAdoptionReceipt`; `LifecycleEnclosureAdoptionPreview` as its public seam. | L32-L37; L40-L53; L57-L79 | `mcp/src/agents_remember/worktrees/integration/lifecycle/lifecycle_enclosure_adoption.py` |
