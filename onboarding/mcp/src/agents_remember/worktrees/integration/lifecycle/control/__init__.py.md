# mcp/src/agents_remember/worktrees/integration/lifecycle/control/__init__.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/worktrees/integration/lifecycle/control/__init__.py` |
...
Marks the Python package described as “Lifecycle control execution services”.
...
| --- | --- | --- |
| Package description | "Lifecycle control execution services." | mcp/src/agents_remember/worktrees/integration/lifecycle/control/__init__.py:1-1 |
