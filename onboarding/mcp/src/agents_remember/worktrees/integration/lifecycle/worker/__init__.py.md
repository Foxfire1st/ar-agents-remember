# mcp/src/agents_remember/worktrees/integration/lifecycle/worker/__init__.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/worktrees/integration/lifecycle/worker/__init__.py` |
...
Marks the Python package described as “Lifecycle worker launch, observation, and termination”.
...
| --- | --- | --- |
| Package description | "Lifecycle worker launch, observation, and termination." | mcp/src/agents_remember/worktrees/integration/lifecycle/worker/__init__.py:1-1 |
