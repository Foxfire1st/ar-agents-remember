...
| --- | --- | --- |
| The module defines `LifecycleControlError` as its public seam. | L14-L89 | `mcp/src/agents_remember/worktrees/integration/lifecycle/lifecycle_operation_control_errors.py` |
