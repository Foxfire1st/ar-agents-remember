...
| An existing semantic authority address retains its original stored record. | `_retain_original_authorities` | mcp/src/agents_remember/worktrees/integration/closeout/certification/admission.py:203-213 |
