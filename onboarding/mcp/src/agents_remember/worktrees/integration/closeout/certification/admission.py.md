...
| Only exact selected red evidence and supplied corrective decisions enter prior-red admission. | `_prior_red_context` | mcp/src/agents_remember/worktrees/integration/closeout/certification/admission.py:203-243 |
