...
| --- | --- | --- |
| Door source facts use current Git and task authority. | n/a | [mcp/src/agents_remember/worktrees/integration/closeout/door_source.py](mcp/src/agents_remember/worktrees/integration/closeout/door_source.py) |
