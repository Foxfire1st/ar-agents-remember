...
| Cache changes leave memory candidate identity stable while real content changes it. | `test_start_and_memory_candidate_do_not_take_authority_from_the_cache` | mcp/tests/test_worktree_sync.py:507-539 |
