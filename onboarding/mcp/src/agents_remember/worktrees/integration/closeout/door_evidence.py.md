...
| Finding | Anchor | Source |
| --- | --- | --- |
| Door evidence is captured before generation identity is published. | `capture_door_candidate_evidence`; `DoorCandidateEvidence` | mcp/src/agents_remember/worktrees/integration/closeout/door_evidence.py:39-60; mcp/src/agents_remember/worktrees/integration/closeout/door_evidence.py:167-203 |
