...
| Finding | Anchor | Source |
| --- | --- | --- |
| The door candidate contains only real candidate/base and review/memory facts. | `DoorCandidateEvidence` | mcp/src/agents_remember/worktrees/integration/closeout/door_evidence.py:38-54 |
| Current source bases and cache-excluding memory tree capture. | `require_source_bases_current` | mcp/src/agents_remember/worktrees/integration/closeout/door_evidence.py:57-95 |
| Review and task evidence remain independently validated. | `_review_provenance` | mcp/src/agents_remember/worktrees/integration/closeout/door_evidence.py:168-247 |
