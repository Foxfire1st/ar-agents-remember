...
| Finding | Anchor | Source |
| --- | --- | --- |
| `_current` owns the corresponding behavior described above. | `_current` | mcp/src/agents_remember/worktrees/integration/closeout/prepared_certification.py:140-148 |
| `_PreparedScopeAuthority` owns the corresponding behavior described above. | `_PreparedScopeAuthority` | `mcp/src/agents_remember/worktrees/integration/closeout/prepared_certification.py:124-159` |
| `_export` owns the corresponding behavior described above. | `_export` | mcp/src/agents_remember/worktrees/integration/closeout/prepared_certification.py:564-613 |
| `_manifest` owns the corresponding behavior described above. | `_manifest` | mcp/src/agents_remember/worktrees/integration/closeout/prepared_certification.py:616-665 |
| `_select` owns the corresponding behavior described above. | `_select` | mcp/src/agents_remember/worktrees/integration/closeout/prepared_certification.py:668-718 |
| `PreparedMemoryCertificationAdapter` owns the corresponding behavior described above. | `PreparedMemoryCertificationAdapter` | mcp/src/agents_remember/worktrees/integration/closeout/prepared_certification.py:721-785 |
