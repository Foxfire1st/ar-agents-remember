...
| Finding | Anchor | Source |
| --- | --- | --- |
| Evidence remains confined to contract-owned roots. | `resolve_curator_evidence_ref` | mcp/src/agents_remember/worktrees/integration/closeout/curator_coherence.py:714-745 |
