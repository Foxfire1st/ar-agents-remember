# mcp/src/agents_remember/worktrees/integration/closeout/__init__.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/worktrees/integration/closeout/__init__.py` |
...
Marks the Python package described as “Closeout-door admission, publication, and recovery”.
...
| --- | --- | --- |
| Package description | "Closeout-door admission, publication, and recovery." | mcp/src/agents_remember/worktrees/integration/closeout/__init__.py:1-1 |
