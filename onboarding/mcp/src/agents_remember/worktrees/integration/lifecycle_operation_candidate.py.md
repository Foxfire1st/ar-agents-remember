# mcp/src/agents_remember/worktrees/integration/lifecycle_operation_candidate.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/worktrees/integration/lifecycle_operation_candidate.py` |
...
| --- | --- | --- |
| Candidate identity has explicit state/tree/fingerprint fields. | `LifecycleOperationCandidate` | mcp/src/agents_remember/worktrees/integration/lifecycle_operation_candidate.py:16-20 |
| Canonical JSON binds normalized input and Git provenance. | `lifecycle_operation_candidate` | mcp/src/agents_remember/worktrees/integration/lifecycle_operation_candidate.py:28-60 |
