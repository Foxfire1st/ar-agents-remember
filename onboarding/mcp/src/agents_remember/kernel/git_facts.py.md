...
- 2026-07-31T21:20+02:00 — 260731-EFA-L3 curator: body corrected. The Invariants section said "the
  ...
  `GIT_METADATA_TIMEOUT_SECONDS` (30) (cit:([`GIT_METADATA_TIMEOUT_SECONDS`], mcp/src/agents_remember/kernel/git_command.py:72-72)); `status --porcelain` at `GIT_LOCAL_TIMEOUT_SECONDS`
  (300) (cit:([`GIT_LOCAL_TIMEOUT_SECONDS`], mcp/src/agents_remember/kernel/git_command.py:70-70)) because it stats the whole work tree. Added the surviving degrade-to-data note
