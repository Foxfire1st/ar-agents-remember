...
| The cases: the eve row is last and the others are unchanged, it consults its probe and never PATH, and the path harnesses keep the ordinary lookup. | `EveRegistryTests` | mcp/tests/test_eve_product_integration.py:575-629 |
