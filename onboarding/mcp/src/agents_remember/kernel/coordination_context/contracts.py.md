...
| Finding | Anchor | Source |
| --- | --- | --- |
| Worktree contract parsing and task-root candidate logic live in the worktrees package. | `load_contract` | mcp/src/agents_remember/worktrees/worktree_contract.py:434-464 |
