...
| Context construction owns resolved task/worktree/memory roots and ledger selection. | `build_coordination_context` | mcp/src/agents_remember/kernel/coordination_context/resolver.py:252-308 |
