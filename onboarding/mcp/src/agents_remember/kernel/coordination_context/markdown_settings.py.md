...
| The topology-derived storage default is gone; `StorageSettings.mode`/`.default` are the one non-topology default. | `DEFAULT_STORAGE_MODE` | mcp/src/agents_remember/kernel/coordination_context/models.py:42-42 |
...
## Update History
- 2026-09-17T20:42:17+00:00: Generated citation repair: `DEFAULT_STORAGE_MODE` repointed to mcp/src/agents_remember/kernel/coordination_context/models.py:42-42. No content impact: mechanical anchor-range projection bound to citation source snapshot a7178848e5b50ce4b2c04d35c06a10a15d6ed52d29d3880b7d032b23fc57f74b; claim bytes unchanged; generated by ccr-r10@v1.
