...
| --- | --- | --- |
| The compatibility facade exposes the package resolver entry point. | "def resolve_coordination_context" | mcp/src/agents_remember/kernel/coordination_context_resolver.py:134-134 |
...
| Focused implementation modules live under the coordination-context package. | "def build_coordination_context" | mcp/src/agents_remember/kernel/coordination_context/resolver.py:252-252 |
