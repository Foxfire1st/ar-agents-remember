...
| Graph authoring and sprint linkage dry-runs lock with `create=False`; apply paths re-lock. | `author_execution_graph`; `attach_master`; `detach_master` | mcp/src/agents_remember/application/task_docs/task_execution_topology.py:193-261; mcp/src/agents_remember/application/task_docs/task_sprint_linkage.py:197-241; mcp/src/agents_remember/application/task_docs/task_sprint_linkage.py:244-293 |
