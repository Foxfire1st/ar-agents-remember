...
`l-02-agent-orchestration/templates/` file, `turn_report_artifact(...)` derives
...
| Finding | Source Path |
| --- | --- |
| The L2 worker job requires a durable turn report at hand-off. | [worker.md](agents-remember/mcp/src/agents_remember/package_data/runtime/skills/l-02-agent-orchestration/jobs/worker.md) |
| The bundled turn-report template is the worker artifact shape. | [turn-report.md](agents-remember/mcp/src/agents_remember/package_data/runtime/skills/l-02-agent-orchestration/templates/turn-report.md) |
| The bundled master-handover template is rendered by the helper. | [master-handover-packet.md](agents-remember/mcp/src/agents_remember/package_data/runtime/skills/l-02-agent-orchestration/templates/master-handover-packet.md) |
