# mcp/src/agents_remember/providers/__init__.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/providers/__init__.py` |
...
Marks the Python package described as “Provider lifecycle, health, and query services”.
...
| --- | --- | --- |
| Package description | "Provider lifecycle, health, and query services." | mcp/src/agents_remember/providers/__init__.py:1-1 |
