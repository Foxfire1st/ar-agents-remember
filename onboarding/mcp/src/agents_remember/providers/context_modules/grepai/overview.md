# mcp/src/agents_remember/providers/context_modules/grepai/ - GrepAI Context Overview

| Field                  | Value                                      |
| ---------------------- | ------------------------------------------ |
| repository             | agents-remember-md                         |
| sourceRoute            | `mcp/src/agents_remember/providers/context_modules/grepai/` |
...
`context_modules/grepai/` owns Docker-owned GrepAI provider context constants, runtime layout, mirrored root syncing, workspace config generation, and disposable `.grepai/` artifact cleanup.
