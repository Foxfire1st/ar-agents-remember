# mcp/src/agents_remember/providers/context_modules/grepai/workspace.py

| Field                  | Value                                      |
| ---------------------- | ------------------------------------------ |
| repository             | agents-remember-md                         |
| path                   | `mcp/src/agents_remember/providers/context_modules/grepai/workspace.py` |
...
| GrepAI lifecycle actions write the workspace config before starting or synchronizing the Docker-owned runner. | [lifecycle_modules/grepai/actions.py](../../lifecycle_modules/grepai/actions.py.md) |
