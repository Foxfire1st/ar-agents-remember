...
| --- | --- | --- |
| The public context facade imports CGC exports through this subpackage facade. | "agents_remember.providers.cgc.context" | mcp/src/agents_remember/providers/context/__init__.py:13-13 |

## Update History

- 2026-08-02T20:43+02:00 — W2-B08: anchored 1 CGC context-facade reference claim and corrected its source to the public providers/context facade; ranges remain generated by the scoped fixer. Verification metadata stays pinned until closeout.
