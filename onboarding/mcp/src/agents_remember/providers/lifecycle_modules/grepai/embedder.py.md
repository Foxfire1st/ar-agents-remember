# mcp/src/agents_remember/providers/lifecycle_modules/grepai/embedder.py

| Field                  | Value                                      |
| ---------------------- | ------------------------------------------ |
| repository             | agents-remember-md                         |
| path                   | `mcp/src/agents_remember/providers/lifecycle_modules/grepai/embedder.py` |
...
| Finding | Source Path |
| --- | --- |
| Embedder settings and container endpoint are derived in GrepAI core. | [core.py](agents-remember-md/mcp/src/agents_remember/providers/lifecycle_modules/grepai/core.py) |
| GrepAI install/start composes backend, embedder, and runner lifecycle steps. | [actions.py](agents-remember-md/mcp/src/agents_remember/providers/lifecycle_modules/grepai/actions.py) |
