...
| The public package facade re-exports every model here. | `diagnostics.__all__` | mcp/src/agents_remember/certification/diagnostics/__init__.py:11-25; mcp/src/agents_remember/certification/diagnostics/__init__.py:43-67 |
| The durable store serializes and revalidates these records on every read and write. | `DiagnosticManifestStore._read_manifest` | mcp/src/agents_remember/certification/diagnostics/store.py:248-264 |
| The run controller builds attempt records, drafts, and runtime bindings from these models. | `DiagnosticExecutionEngine._attempt_record`; `_draft` | mcp/src/agents_remember/worktrees/modules/quality/diagnostic_executor.py:434-516 |
