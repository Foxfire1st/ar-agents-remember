...
| --- | --- | --- |
| Diagnostic evidence can never satisfy or promote into the R14 final proof. | `diagnostic_never_satisfies_certification` | mcp/src/agents_remember/certification/diagnostics/projection.py:155-166 |

## Repo-Internal References

| Finding | Anchor | Source |
| --- | --- | --- |
| Reads the durable per-candidate manifest and newest terminal through the isolated store. | `DiagnosticManifestStore.manifest`; `DiagnosticManifestStore.newest_terminal` | mcp/src/agents_remember/certification/diagnostics/store.py:63-70 |
| The lane model reuses the certification-domain frozen-model and digest helpers. | `FrozenContractModel`; `content_digest` | mcp/src/agents_remember/certification/models.py:32-40; mcp/src/agents_remember/certification/digests.py:1-22 |
...
| The facade re-exports lane projection helpers for closeout consumers. | `diagnostics.__all__` | mcp/src/agents_remember/certification/diagnostics/__init__.py:31-37; mcp/src/agents_remember/certification/diagnostics/__init__.py:43-67 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The projection stays repository-neutral over store and candidate inputs only. | `project_diagnostic_lane` | mcp/src/agents_remember/certification/diagnostics/projection.py:101-140 |
