...
| The lane model reuses the certification-domain frozen-model and digest helpers. | `FrozenContractModel`; `content_digest` | mcp/src/agents_remember/certification/models.py:46-49; mcp/src/agents_remember/certification/digests.py:1-22 |
