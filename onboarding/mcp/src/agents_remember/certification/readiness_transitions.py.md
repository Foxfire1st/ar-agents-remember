...
| The certification facade imports and re-exports the transition table and validator. | `readiness_transitions` | mcp/src/agents_remember/certification/__init__.py:48-51 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| Transition refusals are forced by the public-contract readiness transitions test. | `require_readiness_transition` | mcp/tests/test_quality_gate_public_contract.py:812-817 |
