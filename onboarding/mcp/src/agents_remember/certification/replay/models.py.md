...
| Finding | Anchor | Source |
| --- | --- | --- |
| The vocabulary reuses the certification-domain frozen-model base, gate/rail identity, findings, and semantic text. | `FrozenContractModel`; `GateId`; `RailIdentity`; `CertificationContractFinding`; `SemanticText` | mcp/src/agents_remember/certification/models.py:46-49; mcp/src/agents_remember/certification/models.py:169-172; mcp/src/agents_remember/certification/models.py:42-42 |
| Span categories alias the R16 telemetry span vocabulary; catalogs reuse the telemetry rail records. | `TelemetrySpanKind`; `CatalogRailRecord`; `CatalogCounts` | mcp/src/agents_remember/certification/telemetry/models.py |
...
| The public subpackage facade re-exports the full vocabulary. | `replay.__all__` | mcp/src/agents_remember/certification/replay/__init__.py:56-88 |
| The freeze owner consumes the population rows and change records defined here. | `PopulationGeneration`; `ReplayFreezeInputChange` | mcp/src/agents_remember/certification/replay/freeze.py:39-54; mcp/src/agents_remember/certification/replay/freeze.py:93-116 |
