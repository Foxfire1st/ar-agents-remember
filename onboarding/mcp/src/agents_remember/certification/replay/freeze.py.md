...
| --- | --- | --- |
| A replay leg freezes the exact source/plan/profile/runtime dimensions before running, and only those dimensions can refuse a pair. | `ReplayFreezeInput`; `compare_replay_freezes` | mcp/src/agents_remember/certification/replay/freeze.py:39-54; mcp/src/agents_remember/certification/replay/freeze.py:134-157 |

## Repo-Internal References

| Finding | Anchor | Source |
| --- | --- | --- |
| The vocabulary reuses the certification-domain frozen-model base and semantic text. | `FrozenContractModel`; `SemanticText` | mcp/src/agents_remember/certification/models.py:46-49; mcp/src/agents_remember/certification/models.py:42-42 |
...
| Incomparability findings use the shared typed finding contract. | `CertificationContractFinding` | mcp/src/agents_remember/certification/models.py:169-172 |
...
| The public subpackage facade re-exports every freeze owner. | `replay.__all__` | mcp/src/agents_remember/certification/replay/__init__.py:56-88 |
