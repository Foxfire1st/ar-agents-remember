...
| Predecessor identities use the R21 gate-certificate identity model. | `GateCertificateIdentity` | mcp/src/agents_remember/certification/certificate_models.py:102-104 |
