...
| Gate-1..3 manifests come from the shared result-manifest contracts. | `GateResultManifest` | mcp/src/agents_remember/certification/models.py:434-456 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| A registry profile declares repository-neutral certification identity and inputs. | "class RegistryProfile" | mcp/src/agents_remember/certification/models.py:117-120 |
| The certification plan binds its candidate and ordered gate plans. | "class CertificationPlan" | mcp/src/agents_remember/certification/models.py:303-319 |
