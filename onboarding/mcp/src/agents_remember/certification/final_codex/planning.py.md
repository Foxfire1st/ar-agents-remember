...
| Gate-1..3 manifests come from the shared result-manifest contracts. | `GateResultManifest` | mcp/src/agents_remember/certification/models.py:1-200 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The lane is repository-neutral and consumes profile/plan declarations, never repository-selected behavior. | `RegistryProfile`; `CertificationPlan` | mcp/src/agents_remember/certification/models.py:1-200 |
