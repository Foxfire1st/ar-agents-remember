...
| The certification facade imports and re-exports the readiness observations and projection models. | `readiness_models` | mcp/src/agents_remember/certification/__init__.py:38-47 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The typed vocabulary is mirrored by the coverage suite's negative fixtures. | `CloseoutReadinessInput` | mcp/tests/test_quality_gate_public_contract_coverage.py:402-428 |
