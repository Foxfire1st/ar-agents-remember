...
| The quality gate admits the same profile per exact candidate checkout. | `_admitted_selection`; `_admit_prepared_profile` | mcp/src/agents_remember/worktrees/modules/quality/clean_executor.py:230-244; mcp/src/agents_remember/worktrees/modules/quality/gate.py:577-591 |
