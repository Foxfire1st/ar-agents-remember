...
| The profile report command selects the admitted executor and renders it through DaggerModuleExecutorAdapter. | "def _profile_report_command(" | mcp/src/agents_remember/worktrees/modules/quality/gate.py:565-565 |
