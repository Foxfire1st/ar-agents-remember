...
| --- | --- | --- |
| The package re-exports every telemetry symbol from the four owning modules. | `from agents_remember.certification.telemetry.adapters import (...); from agents_remember.certification.telemetry.models import (...); from agents_remember.certification.telemetry.projection import (...); from agents_remember.certification.telemetry.store import (...); from agents_remember.certification.telemetry.validation import (...)` | mcp/src/agents_remember/certification/telemetry/__init__.py:3-103 |
...
| The certification facade imports the telemetry surface through this package. | `from agents_remember.certification.telemetry import (...); `__all__` | mcp/src/agents_remember/certification/__init__.py:63-101 |
