...
| Focused tests prove source-pair isolation, replacement selection, vacancy, and archive evidence. | `AtomicSeriesActivationTests` | mcp/tests/test_atomic_series_activation.py:96-137 |
