# mcp/src/agents_remember/models/closeout/__init__.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/models/closeout/__init__.py` |
...
Marks the Python package described as “Closeout admission and scheduling models”.
...
| --- | --- | --- |
| Package description | "Closeout admission and scheduling models." | mcp/src/agents_remember/models/closeout/__init__.py:1-1 |
