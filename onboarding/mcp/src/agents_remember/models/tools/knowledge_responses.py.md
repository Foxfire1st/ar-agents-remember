...
| The project handler that returns the per-path published/retained/discrepancy lists and the manifest generation. | `knowledge_project_payload` | mcp/src/agents_remember/mcp/tools/knowledge.py:840-843 |
| The project handler that returns the per-path published/retained/discrepancy lists and the manifest generation. | `knowledge_project_payload` | mcp/src/agents_remember/mcp/tools/knowledge.py:840-843 |
...
- 2026-09-20T17:23:31+00:00: Generated citation repair: `knowledge_change_payload`; `DECLARED_CHANGE_KINDS` repointed to mcp/src/agents_remember/mcp/tools/knowledge.py:386-401; mcp/src/agents_remember/mcp/tools/knowledge.py:98-105. No content impact: mechanical anchor-range projection bound to citation source snapshot 02d8f0b256fe50bf7458ae56160b7e02e4466423e76d3ab197e12477f370f5b8; claim bytes unchanged; generated by ccr-r10@v1.
