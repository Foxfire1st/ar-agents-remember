...
| The project handler that returns the per-path published/retained/discrepancy lists and the manifest generation. | `knowledge_project_payload` | mcp/src/agents_remember/mcp/tools/knowledge.py:507-546 |
| The one registered shape it is a payload of, where the state/payload exclusion is a validator rather than handler discipline. | `ViewPayload`; `ViewResult`; `_require_one_outcome` | mcp/src/agents_remember/models/knowledge/view.py:901-945; mcp/src/agents_remember/models/knowledge/view.py:1092-1107; mcp/src/agents_remember/models/knowledge/view.py:1102-1107; mcp/src/agents_remember/models/knowledge/change_set.py:279-279; mcp/src/agents_remember/models/knowledge/detection.py:1000-1000; mcp/src/agents_remember/models/knowledge/diff.py:529-529 |
