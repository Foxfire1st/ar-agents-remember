...
| The five strict response contracts those rows map to, in the module that declares them. | `KnowledgeReadResponse`; `KnowledgeProjectResponse` | mcp/src/agents_remember/models/tools/knowledge_responses.py:35-52; mcp/src/agents_remember/models/tools/knowledge_responses.py:121-133 |
