...
| **The facet suite's re-scoped assertion, which now unions this leaf's published constant instead of a literal.** | "test_the_facet_commands_join_the_closed_union_and_its_dispatch_tables" | mcp/tests/test_knowledge_facets.py:824-824 |
