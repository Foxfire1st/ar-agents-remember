...
| The schema generation this name is validated against at open and on reopen. | `inspect_schema`; `create_or_validate_schema` | mcp/src/agents_remember/memory/knowledge/connection.py:54-84 |
