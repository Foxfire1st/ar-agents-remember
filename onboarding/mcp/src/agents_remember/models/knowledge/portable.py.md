...
| The identity shape both requests and both results carry. | `SnapshotIdentity` | mcp/src/agents_remember/models/knowledge/candidate.py:139-148 |
| The refusal shape a refused validation or result carries. | `KnowledgeRefusal` | mcp/src/agents_remember/models/knowledge/result.py:163-173 |
