...
|The facet kind set derived from those entries rather than restated.|`FACET_RECORD_KINDS`| mcp/src/agents_remember/memory/knowledge/record_envelope.py:136-136; mcp/src/agents_remember/memory/knowledge/record_envelope.py:137-183 |
| The requirement family the registry gained, derived from the entries it unpacks. | `REQUIREMENT_RECORD_KINDS` | mcp/src/agents_remember/memory/knowledge/record_envelope.py:195-197 |
...
| The facet kind set derived from those entries rather than restated. | `FACET_RECORD_KINDS` | mcp/src/agents_remember/memory/knowledge/record_envelope.py:183-183 |
