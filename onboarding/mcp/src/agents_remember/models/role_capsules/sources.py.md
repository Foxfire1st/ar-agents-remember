...
| The value guards for this module's declared `CapsuleSource.text`, including the non-UTF-8 refusal; the empty-body and not-UTF-8 refusals are now one case, because they are one question asked of the same accessor. | `test_a_source_whose_revision_is_not_its_own_digest_is_refused`; `test_a_source_with_no_readable_instruction_text_is_refused_by_name`; `test_a_source_with_a_blank_identity_or_path_is_refused` | mcp/tests/test_role_capsule_compiler.py:978-990; mcp/tests/test_role_capsule_compiler.py:993-1020; mcp/tests/test_role_capsule_compiler.py:1157-1189 |
