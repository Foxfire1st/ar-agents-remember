...
- **admitted input** — cit:([`CapsuleAdmittedFacts`, `CapsuleBinding`], mcp/src/agents_remember/models/role_capsules/types.py:198-227; mcp/src/agents_remember/models/role_capsules/types.py:299-318).
  ...
  that cit:([`CapsuleToolPolicy.permits`], mcp/src/agents_remember/models/role_capsules/types.py:193-197) answers subset questions from. The compiler never infers a role from prose
  and never grants a capability.
- **content output** — cit:([`CapsuleCapsule`], mcp/src/agents_remember/models/role_capsules/types.py:435-448) carries ordered cit:([`CapsuleInstructionUnit`], mcp/src/agents_remember/models/role_capsules/types.py:378-395) values, the optional task context, skill references, requested tools,
...
| Finding | Citations | Source Path |
| --- | --- | --- |
| The frozen role and operation vocabulary these types are declared against. | `CapsuleRole`; `CapsuleOperation`; `CAPSULE_ROLES`; `CAPSULE_OPERATIONS` | mcp/src/agents_remember/models/role_capsules/vocabulary.py:20-32; mcp/src/agents_remember/models/role_capsules/vocabulary.py:33-46; mcp/src/agents_remember/models/role_capsules/vocabulary.py:64-75; mcp/src/agents_remember/models/role_capsules/vocabulary.py:77-89 |
