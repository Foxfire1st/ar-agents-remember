...
| Missing mandatory material and wrongly-rooted/undeclared sources are refused rather than omitted. | `test_missing_mandatory_material_is_refused_rather_than_omitted`; `test_a_source_the_manifest_does_not_declare_is_refused`; `test_a_source_read_from_the_wrong_composition_root_is_refused`; `test_repository_specialization_must_be_admitted_on_the_binding` | mcp/tests/test_role_capsule_compiler.py:583-606; mcp/tests/test_role_capsule_compiler.py:616-623; mcp/tests/test_role_capsule_compiler.py:626-631; mcp/tests/test_role_capsule_compiler.py:614-618 |
