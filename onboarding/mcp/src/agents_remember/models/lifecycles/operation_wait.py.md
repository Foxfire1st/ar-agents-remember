...
| The public wire response carrying the outcome. | `WorktreeStatusWaitResponse`; `outcome` | mcp/src/agents_remember/models/worktree.py:335-355 |
| The durable cursor the waiters compare. | `meaningfulRevision` | mcp/src/agents_remember/models/lifecycles/operation.py:365-365 |
