...
| --- | --- | --- |
| The module defines `WorkerTerminationEvidence`; `LifecycleCancellationEvidence` as its public seam. | L12-L33; L36-L53 | `mcp/src/agents_remember/models/lifecycles/termination.py` |
