...
| --- | --- | --- |
| The module defines `DirectLandingOperationInput`; `DirectLandingLedgerIntent` as its public seam. | L15-L47; L50-L68 | `mcp/src/agents_remember/models/lifecycles/direct_landing.py` |
