# mcp/src/agents_remember/models/lifecycles/successor.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/models/lifecycles/successor.py` |
...
The public surface is `LifecycleSuccessorPublicationIntent`. This module is strict evidence vocabulary, not an I/O or scheduling owner. Its models keep generation, publication, enclosure, termination, legacy, and direct-landing facts explicit so partial or contradictory state fails validation instead of being inferred from queue rows or task prose.
...
| --- | --- | --- |
| The module defines `LifecycleSuccessorPublicationIntent` as its public seam. | L12-L43 | `mcp/src/agents_remember/models/lifecycles/successor.py` |
