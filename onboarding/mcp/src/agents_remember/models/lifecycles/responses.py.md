...
| The registry maps lifecycle signal tools to their declared response models. | "\"lifecycle_start\": LifecycleStartResponse," | mcp/src/agents_remember/models/tools/tool_registry.py:199-199 |
| The public response-model registry filters internal compatibility tool names from the complete model registry. | "PUBLIC_TOOL_RESPONSE_MODELS: dict[str" | mcp/src/agents_remember/models/tools/tool_registry.py:229-229 |
