...
| --- | --- | --- |
| The schema, renderer, and store owned by this package. | "class TaskDocument(_Doc):"; "def render_markdown(doc: TaskDocument, *, graph_titles:"; "def write_task_docs(" | mcp/src/agents_remember/tasks/document.py:645-645; mcp/src/agents_remember/tasks/render.py:45-45; mcp/src/agents_remember/tasks/store.py:112-112 |
