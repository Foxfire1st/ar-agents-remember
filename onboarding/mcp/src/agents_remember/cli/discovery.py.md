...
| Unit tests: convention/registration hits, precedence, nearest-wins, malformed tolerance, template skip, miss error. | `DiscoverConfigTests`, "test_miss_raises_with_both_patterns_and_the_origin" | mcp/tests/test_cli_discovery.py:42-89 |
