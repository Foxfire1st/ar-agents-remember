...
| Finding | Anchor | Source |
| --- | --- | --- |
| The public facade delegates its module entrypoint to this CLI. | `resolve_coordination_context` | mcp/src/agents_remember/kernel/coordination_context/resolver.py:129-145 |
