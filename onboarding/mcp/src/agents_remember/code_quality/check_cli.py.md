...
| path | `mcp/src/agents_remember/code_quality/check_cli.py` |
...
| --- | --- | --- |
| The parser exposes derived full/targeted policy, memory, CRAP, and diff-floor arguments. | `build_parser` | mcp/src/agents_remember/code_quality/check_cli.py:12-78 |
| Evidence output paths are grouped separately from policy arguments. | `_add_evidence_output_arguments` | mcp/src/agents_remember/code_quality/check_cli.py:81-124 |
