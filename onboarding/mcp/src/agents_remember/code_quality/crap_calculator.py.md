...
| The wrapper runs CRAP from pytest coverage JSON, lists every offender, and declares its two Radon steps reports. | "def derive_scope" | mcp/src/agents_remember/code_quality/check.py:83-83 |
