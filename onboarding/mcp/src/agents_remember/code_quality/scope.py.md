...
| Defines the function `path_is_within` (lines 195-202). | `path_is_within` | mcp/src/agents_remember/code_quality/scope.py:195-202 |
| Defines the function `derive_scope_roots` (lines 205-220) — Roots where an untracked sibling is relevant to an existing quality rail.. | `derive_scope_roots` | mcp/src/agents_remember/code_quality/scope.py:205-220 |
| Defines the function `python_files_under` (lines 223-232) — Python files currently present below configured roots, including untracked ones.. | `python_files_under` | mcp/src/agents_remember/code_quality/scope.py:223-232 |
...
| Defines the function `config_string_array` (lines 281-292). | `config_string_array` | mcp/src/agents_remember/code_quality/scope.py:281-292 |
| Defines the function `dashboard_build_inputs` (lines 295-311). | `dashboard_build_inputs` | mcp/src/agents_remember/code_quality/scope.py:295-311 |
| Defines the function `coverage_json_file_count` (lines 314-322). | `coverage_json_file_count` | mcp/src/agents_remember/code_quality/scope.py:314-322 |
