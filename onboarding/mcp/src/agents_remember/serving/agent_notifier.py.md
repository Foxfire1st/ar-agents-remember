...
| The liveness check the rebind/dead-target and dead-upstream machinery reads (one-hop provenance; no ladder walk remains). | `is_seat_dead` | mcp/src/agents_remember/controlplane/signal_routing.py:198-204 |
