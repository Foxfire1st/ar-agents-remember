...
| Worktree provider readers derive isolated provider container names (`_worktree_providers` → `_worktree_runtime_specs`), inspect Docker (`_inspect_containers`), and convert observed runtime into ready/degraded/failed summaries (`_worktree_runtime_summary`). | `_worktree_providers` | mcp/src/agents_remember/serving/projections/snapshots.py:192-252 |
| `read_providers` always reads workspace providers and filters worktree provider-state files by admitted active groups (`if active_worktree_groups is not None and group not in active_worktree_groups: continue`). | `read_providers` | mcp/src/agents_remember/serving/projections/snapshots.py:157-175 |
...
- 2026-09-17T20:42:17+00:00: Generated citation repair: `read_providers` repointed to mcp/src/agents_remember/serving/projections/snapshots.py:157-175. No content impact: mechanical anchor-range projection bound to citation source snapshot a7178848e5b50ce4b2c04d35c06a10a15d6ed52d29d3880b7d032b23fc57f74b; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-17T20:42:17+00:00: Generated citation repair: `_worktree_providers` repointed to mcp/src/agents_remember/serving/projections/snapshots.py:192-252. No content impact: mechanical anchor-range projection bound to citation source snapshot a7178848e5b50ce4b2c04d35c06a10a15d6ed52d29d3880b7d032b23fc57f74b; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-17T06:49:47+00:00: Generated citation repair: "def read_series_documents(" repointed to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:258-258. No content impact: mechanical anchor-range projection bound to citation source snapshot 3fa9290dfd218ae31f16951129eb57f6acdf1a92ecb95026b64d55227e9f1ad6; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-17T06:49:47+00:00: Generated citation repair: "def _task_doc_node(" repointed to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:569-569. No content impact: mechanical anchor-range projection bound to citation source snapshot 3fa9290dfd218ae31f16951129eb57f6acdf1a92ecb95026b64d55227e9f1ad6; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-17T06:49:47+00:00: Generated citation repair: `_projected_document` repointed to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:78-102. No content impact: mechanical anchor-range projection bound to citation source snapshot 3fa9290dfd218ae31f16951129eb57f6acdf1a92ecb95026b64d55227e9f1ad6; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-17T06:49:47+00:00: Generated citation repair: `read_providers` repointed to mcp/src/agents_remember/serving/projections/snapshots.py:157-175. No content impact: mechanical anchor-range projection bound to citation source snapshot 3fa9290dfd218ae31f16951129eb57f6acdf1a92ecb95026b64d55227e9f1ad6; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-17T06:49:47+00:00: Generated citation repair: `_worktree_providers` repointed to mcp/src/agents_remember/serving/projections/snapshots.py:192-252. No content impact: mechanical anchor-range projection bound to citation source snapshot 3fa9290dfd218ae31f16951129eb57f6acdf1a92ecb95026b64d55227e9f1ad6; claim bytes unchanged; generated by ccr-r10@v1.
- 2026-09-17T03:31:11+02:00 — 260915-KS-L9 curator (re-scoped repair): re-pointed `_series_subtask_nodes` in the row 425 of this card from mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:350-364 to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:302, the extent of the construct the claim is about (the checker named line(s) [302] as its live location); re-pointed `_task_document_lifecycle_maps` in the row 423 of this card from mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:580-657 to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:199, the extent of the construct the claim is about (the checker named line(s) [199] as its live location)
- 2026-09-17T03:31:11+02:00 — 260915-KS-L9 curator (re-scoped repair): re-pointed `_series_subtask_nodes` in the row 425 of this card from mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:338-339 to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:302-303, the extent of the construct the claim is about (the checker named line(s) [302] as its live location); re-pointed `_task_document_lifecycle_maps` in the row 423 of this card from mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:569-575 to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:199-200, the extent of the construct the claim is about (the checker named line(s) [199] as its live location)
- 2026-09-17T03:31:11+02:00 — 260915-KS-L9 curator (re-scoped repair): re-pointed `_series_subtask_created_at` in the row 425 of this card from mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:302-303 to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:338-339, the extent of the construct the claim is about (the checker named line(s) [338] as its live location); re-pointed `_task_doc_node` in the row 423 of this card from mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:199-200 to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:569-575, the extent of the construct the claim is about (the checker named line(s) [569] as its live location)
- 2026-09-17T03:31:11+02:00 — 260915-KS-L9 curator (re-scoped repair): re-pointed `_series_subtask_created_at` in the row 425 of this card from mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:314-333 to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:338-339, the extent of the construct the claim is about (the checker named line(s) [338] as its live location); re-pointed `_series_subtask_nodes` in the row 425 of this card from mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:338-339 to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:302-303, the extent of the construct the claim is about (the checker named line(s) [302] as its live location); re-pointed `_task_doc_node` in the row 423 of this card from mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:208-241 to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:569-575, the extent of the construct the claim is about (the checker named line(s) [569] as its live location); re-pointed `_task_document_lifecycle_maps` in the row 423 of this card from mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:569-575 to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:199-200, the extent of the construct the claim is about (the checker named line(s) [199] as its live location)
- 2026-09-17T03:31:11+02:00 — 260915-KS-L9 curator (re-scoped repair): re-pointed `_task_doc_node` in the row 426 of this card to mcp/src/agents_remember/serving/projections/snapshots_impl/_task_documents.py:569-575, the extent the claim is about (the checker named line(s) [569] as the live location)
...
- 2026-08-01T20:15+02:00 — 260731-EFA-L5 curator (correction): **the central property was stated
  ...
  `AgentNotifierSignalCooldownStore._compact_locked` each rewrite from the list their **tolerant**
...
- 2026-07-31T21:45+02:00 — 260731-EFA-L3 curator, second pass on top of the 20:55 entry below. The
  ...
  *has* a timeout, but not the consequence a later fix had to land. `except OSError` is now
  `except (OSError, subprocess.SubprocessError)` cit:(["def _git_commit_meta("], mcp/src/agents_remember/serving/projections/snapshots_impl/_analytics.py:327-327) — `subprocess.TimeoutExpired` **is** a
...
- 2026-06-15T19:35+02:00 — slice 5e: slice 5e: read_engine_process_facts (contract + status_payload + lifecycle_guidance, status best-effort) + read_start_progress_entries (§5.4).
...
- 2026-06-13T22:34+02:00: Slice 3c commit 2 — added `read_task_documents` (surface 7): reads each `ar-task-document/v1` JSON under `tasks/<repo>/<task>/` keyed by `lifecycleId` into a `TaskDocNode`; the rendered markdown is never parsed. Verification metadata pinned until closeout stamps the 3c commit-2 code commit.
