...
| The runner's own agreement check, which is the product-side second axis of the one-workspace rule. | `parse_runner_config` | mcp/src/agents_remember/serving/harness_control_runner.py:175-177 |
