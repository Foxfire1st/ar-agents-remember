...
| The replay window's own cases cover first-sight versus repeat, oldest-first eviction at the bound, a size-1 window, id-less events, and the non-positive refusal. | `EveReplayWindowTests` | mcp/tests/test_eve_protocol.py:330-430 |
