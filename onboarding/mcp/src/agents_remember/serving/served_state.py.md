...
| One assembly point preserves both omission and null semantics, including the observer-health key's absent-versus-null rule. | `served_state_tail` | mcp/src/agents_remember/serving/served_state.py:81-109 |
