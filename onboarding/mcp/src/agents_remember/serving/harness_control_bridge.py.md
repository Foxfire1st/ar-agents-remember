...
| The validated client drives `interrupt_control`/`read_operation_timeline` with strict response validation against this bridge's stamps. | `interrupt_control`; `read_operation_timeline`; "def _interrupt_result("; "def _operation_timeline(" | mcp/src/agents_remember/serving/_harness_control_parsing.py:248-248; mcp/src/agents_remember/serving/_harness_control_parsing.py:273-273; mcp/src/agents_remember/serving/harness_control_client.py:443-463; mcp/src/agents_remember/serving/harness_control_client.py:466-490 |
