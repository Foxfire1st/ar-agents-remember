...
| Finding | Anchor | Source |
| --- | --- | --- |
| Catalog rows expose `binding_role` and atomically move `leaf_key` plus `seat_role`. | `with_leaf_binding` | mcp/src/agents_remember/serving/terminal_catalog.py:429-432 |
