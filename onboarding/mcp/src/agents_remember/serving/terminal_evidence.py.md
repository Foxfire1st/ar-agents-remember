...
| The catalog cursor fields and liveness failure containment this module feeds. | `terminal_evidence_sequence`; `terminal_native_cursor`; `_terminal_evidence` | mcp/src/agents_remember/models/terminal_catalog.py:178-183; mcp/src/agents_remember/serving/terminal_liveness.py:457-471 |
