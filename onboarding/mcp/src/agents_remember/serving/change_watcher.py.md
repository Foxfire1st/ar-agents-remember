...
| `create_app(heartbeat=, watch_changes=)`: watcher enabled iff `before_tick is None` (sim replay stays time-driven). | L467-L505 | [app.py](agents-remember/mcp/src/agents_remember/serving/app.py) |
