...
+ canonical task-document reference and walks it for Markdown packets with stable
...
| The declared models + shared scoped-read refusal table. | `RequirementRow`; `RequirementsListing`; `RequirementContents`; `SCOPED_READ_RESPONSES` | mcp/src/agents_remember/serving/response_contract.py:764-798; mcp/src/agents_remember/serving/response_contract.py:1062-1068 |
