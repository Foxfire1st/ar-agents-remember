...
| --- | --- | --- |
| Pickup and expectation analytics carry structural references. | `AgentPickupNode` | mcp/src/agents_remember/observer/projection.py:397-434 |
| Task documents remain the real projected hierarchy. | `TaskDocNode` | mcp/src/agents_remember/observer/projection.py:736-801 |
| The leaf-segmented graph projection (lump/segment nodes and sampling endpoints). | `TaskExecutionNode`; `TaskExecutionEndpointNode` | mcp/src/agents_remember/observer/projection.py:666-682; mcp/src/agents_remember/observer/projection.py:644-663 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The served closeout-queue node's member population is unbounded while its problem and reason lists keep their item ceilings. | `CloseoutQueueNode`; `CloseoutCandidateNode` | mcp/src/agents_remember/observer/projection.py:705-716; mcp/src/agents_remember/observer/projection.py:719-733 |
