...
- `_supervisor_banner` (function, lines 22-31) — Return the stale-supervisor banner without blocking a tool response.
...
| --- | --- | --- |
| Defines the function `_supervisor_banner` (lines 22-31) — Return the stale-supervisor banner without blocking a tool response.. | `_supervisor_banner` | mcp/src/agents_remember/application/tool_response.py:22-31 |
