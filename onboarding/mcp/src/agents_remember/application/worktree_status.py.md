...
cit:([`_project_terminal_contract_status`], mcp/src/agents_remember/application/worktree_status.py:377-419) writes a next-move triple into the `worktree_status`
