...
| Worktree summary model constrains the context-facing shape. | "class WorktreeSummary" | mcp/src/agents_remember/models/worktree.py:151-151 |
...
| The summary maps unknown_contract_cells onto unknownContractCells. | `_summary_from_status_payload` | mcp/src/agents_remember/application/worktree_status.py:208-268 |
