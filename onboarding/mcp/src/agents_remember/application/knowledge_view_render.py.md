...
| The pre-classification working type and the ordering pass's outcome, both frozen dataclasses rather than models. | `Candidate`; `OrderedSet` | mcp/src/agents_remember/application/knowledge_view_render.py:174-200; mcp/src/agents_remember/application/knowledge_view_render.py:203-209 |
