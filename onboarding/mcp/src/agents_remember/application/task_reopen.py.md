# mcp/src/agents_remember/application/task_reopen.py

| Field                  | Value                                      |
| ---------------------- | ------------------------------------------ |
| repository             | agents-remember                            |
| path                   | `mcp/src/agents_remember/application/task_reopen.py` |
...
| The facade re-export keeping the old import path working. | `task_reopen_tool` | mcp/src/agents_remember/application/task_doc_tools.py:89-89 |
