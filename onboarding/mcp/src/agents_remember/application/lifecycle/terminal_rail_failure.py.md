...
| `OperationRuntime.fail` routes an unclassified worker failure through the envelope when a durable record exists. | "pending = terminal_worker_failure_result(" | mcp/src/agents_remember/application/lifecycle/lifecycle_operation_worker.py:264-264 |
