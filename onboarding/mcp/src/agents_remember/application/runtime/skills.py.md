...
## Update History
- 2026-09-20T05:40+02:00 — 260915-KS-L41 curator (cross-card pointer repair and a disposition of this card's own projection residue; uncommitted change set on `ar/260915-ks-l41-ar`, code base `756c47b3` before the L39 sync and `f79f4db745ad00b908d6ce4871d0b4ab2320207c` after it): **the claim was re-read at the location it is about, and the mechanically projected range that was the only thing still holding it open was retired.** The row's anchor is the application route overview's own first heading, and the row's words are about that document's layout narrative, so the range is the whole document rather than any construct inside it. The overview has since grown by two sections — 260915-KS-L39's and 260915-KS-L41's — and now stands at 2015 lines, so the cell reads `1-2015`: the heading is at line 1, the range is the document the claim is about, and this is a reading of the merged file rather than an offset from the projected number. The generated history bullet that recorded the earlier `1-1971` projection was removed rather than left standing, because a generated bullet is unverified evidence and this pass is the review that replaces it — nothing else in the history block was touched and no other entry was deleted. `lastVerifiedCommitHash`/`lastVerifiedCommitDate` are retained as recorded and none was advanced or invented; the candidate is uncommitted and the governed closeout owns the real stamp.
- 2026-09-17T20:42:17+00:00: Generated citation repair: `skills_install` repointed to mcp/src/agents_remember/mcp/tools/core.py:154-154. No content impact: mechanical anchor-range projection bound to citation source snapshot a7178848e5b50ce4b2c04d35c06a10a15d6ed52d29d3880b7d032b23fc57f74b; claim bytes unchanged; generated by ccr-r10@v1.
