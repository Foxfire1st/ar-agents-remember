...
| The service layer defines `RuntimeInstallRequest` and performs the actual runtime install. | `RuntimeInstallRequest` | mcp/src/agents_remember/install/runtime.py:137-159 |
