...
| Focused proof refuses two graph documents before publisher/projection mutation and preserves sentinel bytes. | `TaskDocGraphPublicationTests` | mcp/tests/test_task_doc_graph_publication.py:93-160 |
