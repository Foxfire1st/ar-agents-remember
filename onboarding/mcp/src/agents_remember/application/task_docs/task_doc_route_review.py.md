...
| The stamping owner it delegates to; now takes the resolved candidate document. | `build_route_review` | mcp/src/agents_remember/worktrees/route_review.py:294-349 |
| The typed candidate ref derived from the selected path. | `document_ref` | mcp/src/agents_remember/worktrees/route_review.py:447-460 |
