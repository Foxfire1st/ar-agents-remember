...
| The case that executes the no-grant guarantee these builders render. | `test_reading_a_skill_does_not_grant_the_tools_its_frontmatter_names` | mcp/tests/test_capsule_serving.py:811-811 |
| The case that executes the no-body-in-a-listing guarantee these builders render. | `test_the_discovery_registry_is_not_the_model_visible_catalog` | mcp/tests/test_capsule_serving.py:882-882 |
