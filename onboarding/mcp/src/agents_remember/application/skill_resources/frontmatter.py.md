...
| The case that executes the verbatim-frontmatter requirement end to end. | `test_every_sep_2640_entry_is_complete_and_carries_verbatim_frontmatter` | mcp/tests/test_capsule_serving.py:1040-1040 |
