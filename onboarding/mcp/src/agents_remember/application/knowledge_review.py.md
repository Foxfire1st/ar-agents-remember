...
| The case that proves a stale comparison keeps its previous input and disables submission, and the case that proves a current one cannot be built with submission disabled for staleness. | `test_a_stale_comparison_keeps_the_previous_input_and_disables_submission`; `test_a_current_comparison_cannot_be_built_with_submission_disabled_for_staleness` | mcp/tests/test_knowledge_review_surface.py:572-585; mcp/tests/test_knowledge_review_surface.py:586-597 |
