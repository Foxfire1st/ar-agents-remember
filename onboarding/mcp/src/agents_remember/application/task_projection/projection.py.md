...
| The case that proves two leaves never leak each other's private task content. | `test_two_leaves_project_their_own_scope_without_leaking_the_other` | mcp/tests/test_task_projection.py:519-542 |
| The case that proves the three fact planes stay distinguishable. | `test_current_historical_and_proposal_facts_stay_distinguishable` | mcp/tests/test_task_projection.py:772-798 |
