...
| The single origin vocabulary a capsule names its task context by. | `PROJECTION_ORIGIN` | mcp/src/agents_remember/application/task_projection/provider.py:34-34 |
...
| The case that proves the provider serves the compiler protocol and the knowledge seam stays optional. | `test_the_provider_serves_the_compiler_protocol_and_the_knowledge_seam_is_optional` | mcp/tests/test_task_projection.py:853-897 |
