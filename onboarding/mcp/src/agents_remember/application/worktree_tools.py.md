...
| --- | --- | --- |
| Worktree service behavior is owned by the worktree manager and modules. | `start_result`, `finalize_result`, `cleanup_result` | mcp/src/agents_remember/worktrees/git_worktree_manager.py:9-17; mcp/src/agents_remember/worktrees/git_worktree_manager.py:31-37; mcp/src/agents_remember/worktrees/git_worktree_manager.py:98-105 |
