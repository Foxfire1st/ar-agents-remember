# mcp/src/agents_remember/memory_quality/__init__.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/memory_quality/__init__.py` |
...
Marks the Python package described as “Memory layer quality-control checks”.
...
| --- | --- | --- |
| Package description | "Memory layer quality-control checks." | mcp/src/agents_remember/memory_quality/__init__.py:1-1 |
