...
- 2026-09-10T00:00+02:00 — CCR-L42 current-candidate curation: recorded that historical Git-tree members remain in attention/dependency population but are excluded from affected execution units; verification metadata remains closeout-owned.
