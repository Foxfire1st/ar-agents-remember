...
| --- | --- | --- |
| `TaskObservationPair` carries the current contract described above. | "class TaskObservationPair" | mcp/src/agents_remember/memory_quality/incremental_scope/models.py:114-118 |
