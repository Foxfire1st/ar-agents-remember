...
| Finding | Anchor | Source |
| --- | --- | --- |
| The citation source-index lease and schema-9 ready/manifest generations with explicit candidate selection. | `source_index.RepositoryIndex`; `ReadyGeneration`; `Manifest` | mcp/src/agents_remember/memory_quality/style/citations/source_index_state.py:61-152; mcp/src/agents_remember/memory_quality/style/citations/source_index_state.py:253-298; mcp/src/agents_remember/memory_quality/style/citations/source_index.py:156-237; mcp/src/agents_remember/memory_quality/style/citations/source_index.py:134-134; mcp/src/agents_remember/memory_quality/style/citations/source_index.py:133-133 |
...
| Citation claims and entity fingerprint rows come from existing style modules. | `claims_in`; `parse_entity_fingerprint_rows` | mcp/src/agents_remember/memory_quality/integrity/onboarding_drift_check/entities.py:84-113; mcp/src/agents_remember/memory_quality/style/citations/claim_reopen.py:239-253 |
