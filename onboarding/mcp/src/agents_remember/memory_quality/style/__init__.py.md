# mcp/src/agents_remember/memory_quality/style/__init__.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/memory_quality/style/__init__.py` |
...
Marks the Python package described as “Style checks for memory-layer documents”.
...
| --- | --- | --- |
| Package description | "Style checks for memory-layer documents." | mcp/src/agents_remember/memory_quality/style/__init__.py:1-1 |
