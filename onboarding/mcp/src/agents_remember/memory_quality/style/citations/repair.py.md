...
| The code-commit-to-memory-commit ledger mapping the memory leg resolves through. | `memory_commit` | mcp/src/agents_remember/memory_quality/style/citations/provenance.py:126-136 |
