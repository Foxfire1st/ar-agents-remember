...
| Finding | Anchor | Source |
| --- | --- | --- |
| Memory candidate identity excludes consumer cache availability. | n/a | [mcp/src/agents_remember/memory_quality/memory_candidate_pair.py](mcp/src/agents_remember/memory_quality/memory_candidate_pair.py) |
...
| The application surface projects readiness with no affected-closure plan. | "def _attach_final_full_catalog(" | mcp/src/agents_remember/application/memory_quality/controller.py:583-583 |
