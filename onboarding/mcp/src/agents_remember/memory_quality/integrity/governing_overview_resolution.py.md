...
| The consumer: the findings are extended into the gated curator repair set, and the counts are published on the response for the curator's loop. | `_attach_curator_checklist` | mcp/src/agents_remember/application/memory_quality/controller.py:444-470 |
