...
| The quality runner that consumes the packet and reads its status-conditional keys with `.get`. | `run_drift_quality_check` | mcp/src/agents_remember/memory_quality/check.py:216-257 |

## Update History
- 2026-09-17T20:42:17+00:00: Generated citation repair: `run_drift_quality_check` repointed to mcp/src/agents_remember/memory_quality/check.py:216-257. No content impact: mechanical anchor-range projection bound to citation source snapshot a7178848e5b50ce4b2c04d35c06a10a15d6ed52d29d3880b7d032b23fc57f74b; claim bytes unchanged; generated by ccr-r10@v1.
...
- 2026-08-01T00:56+02:00 — 260731-EFA-L4 curator: the card said this module defines "the `DriftRow`
  ...
  new declarations: cit:(["status: DriftStatus"], mcp/src/agents_remember/memory_quality/integrity/onboarding_drift_check/models.py:14-14) and the "class DriftSummaryPacket(TypedDict):" TypedDict: cit:(["class DriftSummaryPacket(TypedDict):"], mcp/src/agents_remember/memory_quality/integrity/onboarding_drift_check/models.py:11-19). Recorded
