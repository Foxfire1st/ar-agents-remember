# mcp/src/agents_remember/memory_quality/future_code_candidate.py

| Field | Value |
| --- | --- |
| repository | agents-remember |
| path | `mcp/src/agents_remember/memory_quality/future_code_candidate.py` |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The frozen strict route model prohibits mutation and undeclared identity fields. | `FutureCodeCandidateIdentity` | mcp/src/agents_remember/memory_quality/future_code_candidate.py:15-22 |
| Capture observes HEAD around the one canonical isolated-index add-all tree calculation. | `capture_future_code_candidate` | mcp/src/agents_remember/memory_quality/future_code_candidate.py:25-52 |
| Reuse requires exact equality of the complete bound route identity. | `require_current_future_code_candidate` | mcp/src/agents_remember/memory_quality/future_code_candidate.py:55-68 |
