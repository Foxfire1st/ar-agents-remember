...
| The start payload forwards task identity, bases and execution configuration to the application owner. | "def worktree_start_payload" | mcp/src/agents_remember/mcp/tools/worktree.py:42-42 |
| The attach payload forwards the requested worktree attachment to the application owner. | "def worktree_attach_payload" | mcp/src/agents_remember/mcp/tools/worktree.py:75-75 |
| The status payload reads status through the application owner. | "def worktree_status_payload" | mcp/src/agents_remember/mcp/tools/worktree.py:87-87 |
| The sync payload forwards the synchronization request to the application owner. | "def worktree_sync_payload" | mcp/src/agents_remember/mcp/tools/worktree.py:55-55 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The current module exposes `register_worktree_tools` at this ownership boundary. | `register_worktree_tools` | mcp/src/agents_remember/mcp/registration/worktrees.py:25-29 |
