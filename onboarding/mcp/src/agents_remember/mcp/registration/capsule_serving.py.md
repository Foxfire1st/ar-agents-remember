...
| Finding | Anchor | Source |
| --- | --- | --- |
| The one entry point the registrar tuple calls, registering both tool families and the resource set. | `register_capsule_and_skill_tools` | mcp/src/agents_remember/mcp/registration/capsule_serving.py:73-78 |
...
| The three response models the payloads are validated against. | `RoleCapsuleResponse`; `SkillCatalogListResponse`; `SkillCatalogReadResponse` | mcp/src/agents_remember/models/tools/tool_registry.py:236-238 |
