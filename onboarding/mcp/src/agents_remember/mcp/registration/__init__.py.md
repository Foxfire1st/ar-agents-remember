...
| The live registered-order comparison that makes a registrar-without-roster-name a surface violation. | `PublicSurfaceInventoryTests` | mcp/tests/test_tools.py:222-283 |
