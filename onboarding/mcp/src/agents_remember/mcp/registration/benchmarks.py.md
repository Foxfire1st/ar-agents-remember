...
| The preview default and sandbox value proved through a live server. | `test_codex_benchmark_run_defaults_to_a_preview_in_codex_own_sandbox` | mcp/tests/test_mcp_registration_wiring_tests_2.py:250-259 |
