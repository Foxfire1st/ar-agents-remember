...
| The shared validation/emission choke point. | `_tool_payload` | mcp/src/agents_remember/mcp/tools/base.py:22-24 |
| The response model the payload validates against. | `TaskDocResponse` | mcp/src/agents_remember/models/task_doc.py:115-196 |
