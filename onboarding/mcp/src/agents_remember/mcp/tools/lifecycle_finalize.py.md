...
| --- | --- | --- |
| Application entry point validates coordination-contained paths, delegates to the worktree finalizer, and then performs configured completion cleanup. | `lifecycle_finalize_task_tool` | mcp/src/agents_remember/application/worktree_tools.py:787-818 |
...
| The response model is registered in the public tool registry. | `lifecycle_finalize_task` | mcp/src/agents_remember/models/tools/tool_registry.py:206-206 |
