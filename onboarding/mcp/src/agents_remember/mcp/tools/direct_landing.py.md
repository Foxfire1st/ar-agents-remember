...
| The standard `_tool_payload` envelope converts one application result into its protocol-ready response. | `_tool_payload` | mcp/src/agents_remember/mcp/tools/base.py:22-24 |
| Registered as a public tool. | `PUBLIC_TOOLS` | mcp/src/agents_remember/models/tools/public_roster.py:22-85 |
