...
| The standard `_tool_payload` envelope converts one application result into its protocol-ready response. | `_tool_payload` | mcp/src/agents_remember/mcp/tools/base.py:79-81 |
