...
| --- | --- | --- |
| The single payload function delegates directly through the common tool envelope. | `closeout_door_payload` | mcp/src/agents_remember/mcp/tools/closeout_door.py:13-17 |
