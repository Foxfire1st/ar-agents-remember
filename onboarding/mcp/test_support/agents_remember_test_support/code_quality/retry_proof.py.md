...
| Compatibility binds tooling, candidate/selection settings, and evidence-lane identity; schema bump 5 adds the selection digest. | `_compatibility_key`; `SCHEMA_VERSION` | mcp/test_support/agents_remember_test_support/code_quality/retry_proof.py:414-439; mcp/test_support/agents_remember_test_support/code_quality/retry_proof.py:57-57 |
