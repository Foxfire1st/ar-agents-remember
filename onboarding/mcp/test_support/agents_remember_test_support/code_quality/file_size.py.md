...
| path                   | `mcp/test_support/agents_remember_test_support/code_quality/file_size.py`                                            |
...
| --- | --- | --- |
| The project-owned wrapper's file-size rail selects enforcing or report-only behavior from explicit configuration. | `_file_size_step` | mcp/test_support/agents_remember_test_support/code_quality/quality_plan.py:290-302 |
| The arming boolean and measured scope. | `file_size_armed`; `size_paths` | mcp/test_support/agents_remember_test_support/code_quality/scope.py:34-34; mcp/test_support/agents_remember_test_support/code_quality/scope.py:192-208 |
