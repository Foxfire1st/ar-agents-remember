...
| The persisted proof binds summary bytes and observed replication reports. | `_write_teardown_proof` | mcp/test_support/agents_remember_test_support/code_quality/profile_rails.py:300-310 |
| Canonical POSIX-string order aligns equivalent populations without deduplicating them. | `_paths` | mcp/test_support/agents_remember_test_support/code_quality/profile_rails.py:124-127 |
