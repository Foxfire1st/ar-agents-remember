...
- The committed source delta `fbfd37ca..77bc6145`.
...
In-scope path rules cover root `AGENTS.md`/`README.md`, `mcp/**`, and `scripts/**`. The source delta
contains 40 modified in-scope files, 24 additions, two behavior-preserving moves, and one deletion.
