# File Card — mcp/src/agents_remember/testing/evidence_lifecycle.py

| Field | Value |
| --- | --- |
| repo | agents-remember |
| sourceFile | `mcp/src/agents_remember/testing/evidence_lifecycle.py` |
| targetOnboardingFile | `mcp/src/agents_remember/testing/evidence_lifecycle.py.md` |
...
| --- | --- | --- | --- |
| Source file | `mcp/src/agents_remember/testing/evidence_lifecycle.py` | yes | concrete current behavior |
| Governing overview | `mcp/src/agents_remember/testing/overview.md` | yes | route authority |
| Target sidecar | `mcp/src/agents_remember/testing/evidence_lifecycle.py.md` | yes | durable one-to-one onboarding |
...
- `mcp/src/agents_remember/testing/evidence_lifecycle.py.md`
