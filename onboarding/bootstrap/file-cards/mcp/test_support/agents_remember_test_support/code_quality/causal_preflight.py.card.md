# File Card — mcp/test_support/agents_remember_test_support/code_quality/causal_preflight.py

| Field | Value |
| --- | --- |
| repo | agents-remember |
| sourceFile | `mcp/test_support/agents_remember_test_support/code_quality/causal_preflight.py` |
| targetOnboardingFile | `mcp/test_support/agents_remember_test_support/code_quality/causal_preflight.py.md` |
...
| --- | --- | --- | --- |
| Source file | `mcp/test_support/agents_remember_test_support/code_quality/causal_preflight.py` | yes | concrete current behavior |
| Governing overview | `mcp/overview.md` | yes | route authority |
| Target sidecar | `mcp/test_support/agents_remember_test_support/code_quality/causal_preflight.py.md` | yes | durable one-to-one onboarding |

## Files The Worker May Read

- `mcp/test_support/agents_remember_test_support/code_quality/causal_preflight.py`
- `mcp/overview.md`
- `mcp/test_support/agents_remember_test_support/code_quality/causal_preflight.py.md`
