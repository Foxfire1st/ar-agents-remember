# File Card — mcp/test_support/agents_remember_test_support/testing/causal_failures.py

| Field | Value |
| --- | --- |
| repo | agents-remember |
| sourceFile | `mcp/test_support/agents_remember_test_support/testing/causal_failures.py` |
| targetOnboardingFile | `mcp/test_support/agents_remember_test_support/testing/causal_failures.py.md` |
...
| --- | --- | --- | --- |
| Source file | `mcp/test_support/agents_remember_test_support/testing/causal_failures.py` | yes | concrete current behavior |
| Governing overview | `mcp/test_support/agents_remember_test_support/testing/overview.md` | yes | route authority |
| Target sidecar | `mcp/test_support/agents_remember_test_support/testing/causal_failures.py.md` | yes | durable one-to-one onboarding |
...
- `mcp/test_support/agents_remember_test_support/testing/causal_failures.py.md`
