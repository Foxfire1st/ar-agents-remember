...
| Finding | Source Path |
| --- | --- |
| The L3 read-only change-set API this screen consumes. | [serving/changeset.py](agents-remember/mcp/src/agents_remember/serving/changeset.py) |
| The same-origin client wrapping that API. | [data/changeset.ts](agents-remember/dashboard/src/data/changeset.ts) |
| The shell that hosts the takeover + restores the rails. | [cockpit/Cockpit.tsx](agents-remember/dashboard/src/cockpit/Cockpit.tsx) |
| The detail panel button + counters that open this screen. | [panels/DetailPanel.tsx](agents-remember/dashboard/src/panels/DetailPanel.tsx) |
| The reused read-only CodeMirror pane + theme + lang map. | [panels/file-viewer/FilePane.tsx](agents-remember/dashboard/src/panels/file-viewer/FilePane.tsx) |
| The markdown renderer the sidecar column + rendered-markdown toggle reuse. | [grammar/Markdown.tsx](agents-remember/dashboard/src/grammar/Markdown.tsx) |
