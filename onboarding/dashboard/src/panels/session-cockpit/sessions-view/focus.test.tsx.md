...
| path                   | `dashboard/src/panels/session-cockpit/sessions-view/focus.test.tsx` |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The focus-model suite. | `describe` | dashboard/src/panels/session-cockpit/sessions-view/focus.test.tsx:30-120 |
...
- 2026-08-07T08:19Z — 260731-EFA-L8 curator: created this sidecar for the focus
