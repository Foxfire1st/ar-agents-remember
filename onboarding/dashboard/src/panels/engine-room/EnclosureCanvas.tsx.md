...
| Projection types `CommitRefNode`/`ProviderBootNode`/`LandingRefNode`, and `ProviderNode`. | `CommitRefNode`; `ProviderBootNode`; `LandingRefNode`; `ProviderNode` | dashboard/src/types/projection.ts:155-163; dashboard/src/types/projection.ts:302-312; dashboard/src/types/projection.ts:442-447; dashboard/src/types/projection.ts:449-460 |
