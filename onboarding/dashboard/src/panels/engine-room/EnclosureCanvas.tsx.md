...
| Projection types `CommitRefNode`/`ProviderBootNode`/`LandingRefNode`, and `ProviderNode`. | `CommitRefNode`; `ProviderBootNode`; `LandingRefNode`; `ProviderNode` | dashboard/src/types/projection.ts:146-154; dashboard/src/types/projection.ts:266-276; dashboard/src/types/projection.ts:371-376; dashboard/src/types/projection.ts:378-389 |
