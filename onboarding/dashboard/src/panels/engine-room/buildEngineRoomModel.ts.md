...
| `EngineProcessNode.worktreeGroup` and `lifecycleId` | `EngineProcessNode` | dashboard/src/types/projection.ts:233-274 |
| `ProviderNode.scope` | `ProviderNode` | dashboard/src/types/projection.ts:513-524 |
...
- 2026-09-05T06:24:16+00:00: Generated citation repair: `ProviderNode` repointed to dashboard/src/types/projection.ts:514-525. No content impact: mechanical anchor-range projection bound to citation source snapshot ad34c1284f637cc2e60117d5a156ddfdd2236402d2c1332758dd691c2cbef881; claim bytes unchanged; generated by ccr-r10@v1.
