...
| Finding | Anchor | Source |
| --- | --- | --- |
| `CockpitShell` is the sole catalog driver/reconciler owner for the shared store. | "Catalog ownership is shell-lifetime and view-independent." | dashboard/src/cockpit/Cockpit.tsx:861-861 |
