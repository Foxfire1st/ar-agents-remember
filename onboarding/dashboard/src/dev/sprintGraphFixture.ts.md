...
| The seeded sprint queue. | `SPRINT_GRAPH_QUEUE` | dashboard/src/dev/sprintGraphFixture.ts:71-89 |
| The page that consumes the fixture. | `SprintGraphPage` | dashboard/src/dev/sprintGraphPage.tsx:16-21 |
| The wire model the fixture shapes. | `TaskExecutionGraphView` | dashboard/src/types/projection.ts:720-722 |
