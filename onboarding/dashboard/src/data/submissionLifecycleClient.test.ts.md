...
| The server authority suite proves the corresponding linearization boundary. | `HarnessSubmissionAuthorityTests` | mcp/tests/test_harness_submission_authority.py:230-397 |
