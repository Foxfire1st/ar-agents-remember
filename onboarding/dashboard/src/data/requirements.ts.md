...
| Finding | Anchor | Source |
| --- | --- | --- |
| The shared JSON transport and query-string helper the client is built on. | `export function getJson`; `export const qs` | dashboard/src/data/files.ts:72-82; dashboard/src/data/files.ts:99-105 |
...
| The client test suite. | `describe('data/requirements client'` | dashboard/src/data/requirements.test.ts:33-49 |
