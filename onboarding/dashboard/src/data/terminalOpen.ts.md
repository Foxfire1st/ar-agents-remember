...
| The session store mutates and broadcasts only after `outcome: opened`. | "sessionStore.getState().upsert(result.session" | dashboard/src/data/sessions.ts:841-841 |
...
## Update History
- 2026-09-11T22:39:01+00:00: Generated citation repair: "sessionStore.getState().upsert(result.session" repointed to dashboard/src/data/sessions.ts:841-841. No content impact: mechanical anchor-range projection bound to citation source snapshot b911c7c4c4eb354cf78d2a53e1538fc36a5f9a5e36a3702e5953739b48812830; claim bytes unchanged; generated by ccr-r10@v1.
