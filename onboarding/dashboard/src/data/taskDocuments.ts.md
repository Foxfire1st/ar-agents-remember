...
| The serving route maps projection readiness and the confined snapshot read to HTTP responses. | "def _task_document_response(runtime: _ServingRuntime" | mcp/src/agents_remember/serving/_app_routes.py:109-109 |
