...
## Update History
- 2026-09-18T13:27+02:00 — 260915-KS-L13 curator (range-closure pass): **one prose citation's range was re-pointed to the lines that actually carry both of its anchors.** The 400-refusal citation carried `:225-251` / `:243-243`, which hold `def _open_terminal_response(` but not the payload literal the claim names; the route answers the refusal at `:257` (`{"status": "launch-selection-invalid", …}`), so the range was replaced by the single extent `:239-257`, which holds the opener, the `resolve_terminal_open_selection` call and the exact literal. The sibling citations on the same line already carried `:239-239` / `:257-257` and were left exactly as they are; no claim was deleted or softened. No verification stamp advanced: the source is uncommitted and the governed closeout owns the real code and memory commits.
- 2026-09-18T10:45:13+00:00: Generated citation repair: "def _open_terminal_response("; "\"status\": \"launch-selection-invalid\"" repointed to mcp/src/agents_remember/serving/_app_terminal_routes.py:239-239; mcp/src/agents_remember/serving/_app_terminal_routes.py:257-257. No content impact: mechanical anchor-range projection bound to citation source snapshot a1ce4e2ec12e0f7b6d953d252db00653f23138548de5122388515485a9e05d23; claim bytes unchanged; generated by ccr-r10@v1.
