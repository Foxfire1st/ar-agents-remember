...
- `agentPickups` is also server-derived. Clients render the projected `waiting-for-agent` or `check-chat`
  state and do not run their own pickup TTL timers.
