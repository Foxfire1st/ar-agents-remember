...
| The optional task-intent reference on the lifecycle operation projection. | "\"taskIntent\": {" | dashboard/src/types/projection.schema.json:2086-2086 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The coherent operation envelope generates optional generation, first-class direct-landing kind, bounded legal-control payloads, and terminal/unreadable/incoherent status variants. | "\"LifecycleOperationProjection\": {" | dashboard/src/types/projection.schema.json:1830-1830 |
| The generated TypeScript mirror requires the legalControls array on its operation observation. | "export interface LifecycleOperationProjection {" | dashboard/src/types/projection.ts:334-334 |
