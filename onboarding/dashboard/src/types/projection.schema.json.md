...
- Under the canonical Python 3.13 runtime, named `Literal` vocabularies appear once in `$defs` and
  their model properties use local `$ref` values. The wire values are unchanged.
