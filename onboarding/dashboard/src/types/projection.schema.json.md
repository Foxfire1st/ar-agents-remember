...
| The generated `task-intent/v1` identity definition with closed schema and digest pattern. | "\"TaskIntentIdentity\": {" | dashboard/src/types/projection.schema.json:4117-4117 |
| The optional task-intent reference on the lifecycle operation projection. | "\"taskIntent\": {" | dashboard/src/types/projection.schema.json:2087-2087 |
| The served closeout-queue node: no `maxItems` on `members`, `maxItems: 256` still on `sourceProblems`. | "\"CloseoutQueueNode\": {"; "\"Members\"" | dashboard/src/types/projection.schema.json:630-692 |
...
| Finding | Anchor | Source |
| --- | --- | --- |
| The coherent operation envelope generates optional generation, first-class direct-landing kind, bounded legal-control payloads, and terminal/unreadable/incoherent status variants. | "\"LifecycleOperationProjection\": {" | dashboard/src/types/projection.schema.json:1831-2118 |
| The generated TypeScript mirror requires the legalControls array on its operation observation. | "export interface LifecycleOperationProjection {" | dashboard/src/types/projection.ts:335-364 |
