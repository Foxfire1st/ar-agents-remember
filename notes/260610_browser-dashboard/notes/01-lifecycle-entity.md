...
### Worktree-only closeouts (original design intent; cleanup landed)
...
without them. Skills, code, and docs were brought in line by the **alignment
task** (Q22; issue #62 / PR #63, merged to main, MCP 2.9.0) — the dashboard
work now stands on the clean worktree-only foundation. (Verified 2026-06-12:
`direct_closeout_*` gone from source, tools 37→36 together with the
`worktree_sync` addition.)

Spawned follow-up — **DONE, merged to main**:
**`tasks/agents-remember/260610_worktree-only-closeout-alignment/task.md`**
(created 2026-06-10) carried the removal plan. Affected surface (historical
reference; canonical sources; the 8 harness starter copies +
